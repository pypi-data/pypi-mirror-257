...
from jammy.utils import has_method
...
class Boto3Backend(BaseStorageBackend):
    ...
    Args:
        ...
        enable_mc (bool, optional): Whether to enable memcached support.
            Defaults to True.
        conf_path (str, optional): Config path of Boto3 client. Default: None.
    ...
    def __init__(
        ...
        self._client = Boto3Client(conf_path=conf_path, enable_mc=enable_mc)
    ...
    def copytree_to_local(
        ...
        for path in self.list_dir_or_file(src, list_dir=False, recursive=True):
            ...
            mkdir_or_exist(osp.dirname(dst_path))
    ...
    def generate_presigned_url(
        ...
        """
        raise NotImplementedError(
            "generate_presigned_url is not supported in Boto3Backend"
        )
