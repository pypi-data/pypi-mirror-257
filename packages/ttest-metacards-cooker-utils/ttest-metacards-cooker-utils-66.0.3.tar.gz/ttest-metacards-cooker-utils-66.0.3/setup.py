...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package ttest-metacards-cooker-utils. Maybe you are using the wrong pypi?")


setup(
    name='ttest-metacards-cooker-utils',
    version='66.0.3',
    author='Yandex',
