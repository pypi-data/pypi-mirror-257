...
def init():
    ...
    # TODO: Add checks to make sure all monitoring settings are configured correctly
...
def run(request: AMLRequest):
    ...
    # TODO: would be nice to run in the init() but I'm not sure the forking done by
    # gunicorn would play nice.
