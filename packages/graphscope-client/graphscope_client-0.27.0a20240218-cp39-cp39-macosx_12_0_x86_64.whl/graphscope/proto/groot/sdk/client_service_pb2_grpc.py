...
class ClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ingestData = channel.unary_unary(
                ...
                request_serializer=groot_dot_sdk_dot_client__service__pb2.IngestDataRequest.SerializeToString,
                response_deserializer=groot_dot_sdk_dot_client__service__pb2.IngestDataResponse.FromString,
                )
        ...
        self.clearIngest = channel.unary_unary(
                ...
                request_serializer=groot_dot_sdk_dot_client__service__pb2.ClearIngestRequest.SerializeToString,
                response_deserializer=groot_dot_sdk_dot_client__service__pb2.ClearIngestResponse.FromString,
                )
...
def add_ClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ingestData': grpc.unary_unary_rpc_method_handler(
                    servicer.ingestData,
                    request_deserializer=groot_dot_sdk_dot_client__service__pb2.IngestDataRequest.FromString,
                    response_serializer=groot_dot_sdk_dot_client__service__pb2.IngestDataResponse.SerializeToString,
            ),
            ...
            'clearIngest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=groot_dot_sdk_dot_client__service__pb2.ClearIngestRequest.FromString,
                    response_serializer=groot_dot_sdk_dot_client__service__pb2.ClearIngestResponse.SerializeToString,
            ),
...
class Client(object):
    ...
    def ingestData(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gs.rpc.groot.Client/ingestData',
            groot_dot_sdk_dot_client__service__pb2.IngestDataRequest.SerializeToString,
            groot_dot_sdk_dot_client__service__pb2.IngestDataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def loadJsonSchema(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gs.rpc.groot.Client/loadJsonSchema',
    ...
    def clearIngest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gs.rpc.groot.Client/clearIngest',
            groot_dot_sdk_dot_client__service__pb2.ClearIngestRequest.SerializeToString,
            groot_dot_sdk_dot_client__service__pb2.ClearIngestResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
