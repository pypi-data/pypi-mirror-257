...
def run_cli(shell_path:str=os.getcwd()):
    ...
    check_inits.check_all_folders_got_init(shell_path)


    # get all packages imported into the folder
    packages_installed = get_installed_packages.get_user_installed_packages(shell_path)
