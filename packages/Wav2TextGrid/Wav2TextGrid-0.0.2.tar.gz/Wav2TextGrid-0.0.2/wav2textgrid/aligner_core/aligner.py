...
from aligner_core.alignermodel import Wav2Vec2ForFrameClassificationSAT
from aligner_core.utils import seq2duration, forced_align, duration2textgrid, word2textgrid
from aligner_core.processors import CharsiuPreprocessor_en
...
class charsiu_aligner:
    ...
    def __init__(self,
        ...
        if processor is not None:
            ...
            self.charsiu_processor = CharsiuPreprocessor_en()
...
class xVecSAT_forced_aligner(charsiu_aligner):
