...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package infradev-django-extensions. Maybe you are using the wrong pypi?")


setup(
    name='infradev-django-extensions',
    version='66.0.3',
    author='Yandex',
