...
import int_connector_lib.proto.grpc_controller_pb2 as grpc__controller__pb2
...
def add_GRPCControllerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("plugin.GRPCController", rpc_method_handlers)
