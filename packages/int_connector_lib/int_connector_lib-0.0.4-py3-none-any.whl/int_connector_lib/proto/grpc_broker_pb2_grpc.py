...
import int_connector_lib.proto.grpc_broker_pb2 as grpc__broker__pb2
...
def add_GRPCBrokerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("plugin.GRPCBroker", rpc_method_handlers)
