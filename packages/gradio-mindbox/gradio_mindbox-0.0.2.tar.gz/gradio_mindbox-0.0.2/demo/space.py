...
<a href="https://pypi.org/project/gradio_mindbox/" target="_blank"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/gradio_mindbox"></a>  
</div>
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["Mindbox"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["Mindbox"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "Mindbox-user-fn"], header_links=True)
