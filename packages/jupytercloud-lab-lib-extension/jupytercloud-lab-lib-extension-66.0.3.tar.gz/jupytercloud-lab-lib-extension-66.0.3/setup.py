...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package jupytercloud-lab-lib-extension. Maybe you are using the wrong pypi?")


setup(
    name='jupytercloud-lab-lib-extension',
    version='66.0.3',
    author='Yandex',
