...
class QueryRecord(NamedTuple):
    """Contains the query information returned from the Trino cluster after the query is run."""
...
class QueryHistory:
    """A context manager that listens to and records SQL queries that are pushed down to the Trino cluster."""
