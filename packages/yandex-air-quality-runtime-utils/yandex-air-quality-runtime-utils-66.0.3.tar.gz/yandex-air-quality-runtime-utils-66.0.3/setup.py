...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-air-quality-runtime-utils. Maybe you are using the wrong pypi?")


setup(
    name='yandex-air-quality-runtime-utils',
    version='66.0.3',
    author='Yandex',
