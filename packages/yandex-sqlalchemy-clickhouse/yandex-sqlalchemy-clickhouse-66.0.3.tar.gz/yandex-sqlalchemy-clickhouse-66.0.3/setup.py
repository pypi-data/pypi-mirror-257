...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-sqlalchemy-clickhouse. Maybe you are using the wrong pypi?")


setup(
    name='yandex-sqlalchemy-clickhouse',
    version='66.0.3',
    author='Yandex',
