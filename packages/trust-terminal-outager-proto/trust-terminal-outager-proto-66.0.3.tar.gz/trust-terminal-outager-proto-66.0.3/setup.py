...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package trust-terminal-outager-proto. Maybe you are using the wrong pypi?")


setup(
    name='trust-terminal-outager-proto',
    version='66.0.3',
    author='Yandex',
