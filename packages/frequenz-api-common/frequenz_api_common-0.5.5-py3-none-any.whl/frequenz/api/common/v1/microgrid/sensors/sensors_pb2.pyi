...
class Sensor(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["category", b"category", "id", b"id", "manufacturer", b"manufacturer", "microgrid_id", b"microgrid_id", "model_name", b"model_name", "name", b"name", "operational_lifetime", b"operational_lifetime"]) -> None: ...
...
class SensorData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["metric_samples", b"metric_samples", "sensor_id", b"sensor_id", "states", b"states"]) -> None: ...
...
class SensorState(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["errors", b"errors", "sampled_at", b"sampled_at", "states", b"states"]) -> None: ...
...
class SensorMetricSample(google.protobuf.message.Message):
    ...
    @property
    def sample(self) -> frequenz.api.common.v1.metrics.metric_sample_pb2.MetricSampleVariant:
    ...
    def __init__(
        ...
        *,
        sampled_at: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        metric: frequenz.api.common.v1.metrics.metric_sample_pb2.Metric.ValueType = ...,
        sample: frequenz.api.common.v1.metrics.metric_sample_pb2.MetricSampleVariant | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["sample", b"sample", "sampled_at", b"sampled_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["metric", b"metric", "sample", b"sample", "sampled_at", b"sampled_at"]) -> None: ...
