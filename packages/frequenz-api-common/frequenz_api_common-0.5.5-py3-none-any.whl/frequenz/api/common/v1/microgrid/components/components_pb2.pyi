...
class ComponentCategoryMetadataVariant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["battery", b"battery", "ev_charger", b"ev_charger", "fuse", b"fuse", "grid", b"grid", "inverter", b"inverter", "metadata", b"metadata", "voltage_transformer", b"voltage_transformer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["battery", b"battery", "ev_charger", b"ev_charger", "fuse", b"fuse", "grid", b"grid", "inverter", b"inverter", "metadata", b"metadata", "voltage_transformer", b"voltage_transformer"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metadata", b"metadata"]) -> typing_extensions.Literal["battery", "ev_charger", "fuse", "grid", "inverter", "voltage_transformer"] | None: ...
...
class Component(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["category_type", b"category_type", "operational_lifetime", b"operational_lifetime"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["category", b"category", "category_type", b"category_type", "id", b"id", "manufacturer", b"manufacturer", "metric_config_bounds", b"metric_config_bounds", "microgrid_id", b"microgrid_id", "model_name", b"model_name", "name", b"name", "operational_lifetime", b"operational_lifetime", "status", b"status"]) -> None: ...
...
class MetricConfigBounds(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["config_bounds", b"config_bounds"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config_bounds", b"config_bounds", "metric", b"metric"]) -> None: ...
...
class ComponentConnection(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["operational_lifetime", b"operational_lifetime"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["destination_component_id", b"destination_component_id", "operational_lifetime", b"operational_lifetime", "source_component_id", b"source_component_id"]) -> None: ...
...
class ComponentData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["component_id", b"component_id", "metric_samples", b"metric_samples", "states", b"states"]) -> None: ...
...
class ComponentState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["sampled_at", b"sampled_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["errors", b"errors", "sampled_at", b"sampled_at", "states", b"states", "warnings", b"warnings"]) -> None: ...
