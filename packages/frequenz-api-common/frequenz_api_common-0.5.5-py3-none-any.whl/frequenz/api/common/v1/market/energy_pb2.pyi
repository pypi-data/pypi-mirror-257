...
class Energy(google.protobuf.message.Message):
    ...
    @property
    def mwh(self) -> google.type.decimal_pb2.Decimal:
        """Represents energy unit in Megawatthours (MWh)."""
    def __init__(
        self,
        *,
        mwh: google.type.decimal_pb2.Decimal | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["mwh", b"mwh"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["mwh", b"mwh"]) -> None: ...
