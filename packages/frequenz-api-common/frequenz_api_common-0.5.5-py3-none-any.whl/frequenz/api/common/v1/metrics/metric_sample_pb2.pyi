...
class _MetricEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Metric.ValueType], builtins.type):
    ...
    METRIC_AC_VOLTAGE_PHASE_1: _Metric.ValueType  # 12
    METRIC_AC_VOLTAGE_PHASE_2: _Metric.ValueType  # 13
    METRIC_AC_VOLTAGE_PHASE_3: _Metric.ValueType  # 14
    METRIC_AC_APPARENT_CURRENT: _Metric.ValueType  # 15
    METRIC_AC_APPARENT_CURRENT_PHASE_1: _Metric.ValueType  # 16
    METRIC_AC_APPARENT_CURRENT_PHASE_2: _Metric.ValueType  # 17
    METRIC_AC_APPARENT_CURRENT_PHASE_3: _Metric.ValueType  # 18
    METRIC_AC_APPARENT_POWER: _Metric.ValueType  # 20
    """AC power metrics"""
    METRIC_AC_APPARENT_POWER_PHASE_1: _Metric.ValueType  # 21
    METRIC_AC_APPARENT_POWER_PHASE_2: _Metric.ValueType  # 22
    METRIC_AC_APPARENT_POWER_PHASE_3: _Metric.ValueType  # 23
    METRIC_AC_ACTIVE_POWER: _Metric.ValueType  # 24
    METRIC_AC_ACTIVE_POWER_PHASE_1: _Metric.ValueType  # 25
    METRIC_AC_ACTIVE_POWER_PHASE_2: _Metric.ValueType  # 26
    METRIC_AC_ACTIVE_POWER_PHASE_3: _Metric.ValueType  # 27
    METRIC_AC_REACTIVE_POWER: _Metric.ValueType  # 28
    METRIC_AC_REACTIVE_POWER_PHASE_1: _Metric.ValueType  # 29
    METRIC_AC_REACTIVE_POWER_PHASE_2: _Metric.ValueType  # 30
    METRIC_AC_REACTIVE_POWER_PHASE_3: _Metric.ValueType  # 31
    ...
    METRIC_AC_THD_CURRENT: _Metric.ValueType  # 80
    """AC harmonics"""
    METRIC_AC_THD_CURRENT_PHASE_1: _Metric.ValueType  # 81
    METRIC_AC_THD_CURRENT_PHASE_2: _Metric.ValueType  # 82
    METRIC_AC_THD_CURRENT_PHASE_3: _Metric.ValueType  # 83
...
METRIC_AC_VOLTAGE_PHASE_1: Metric.ValueType  # 12
METRIC_AC_VOLTAGE_PHASE_2: Metric.ValueType  # 13
METRIC_AC_VOLTAGE_PHASE_3: Metric.ValueType  # 14
METRIC_AC_APPARENT_CURRENT: Metric.ValueType  # 15
METRIC_AC_APPARENT_CURRENT_PHASE_1: Metric.ValueType  # 16
METRIC_AC_APPARENT_CURRENT_PHASE_2: Metric.ValueType  # 17
METRIC_AC_APPARENT_CURRENT_PHASE_3: Metric.ValueType  # 18
METRIC_AC_APPARENT_POWER: Metric.ValueType  # 20
"""AC power metrics"""
METRIC_AC_APPARENT_POWER_PHASE_1: Metric.ValueType  # 21
METRIC_AC_APPARENT_POWER_PHASE_2: Metric.ValueType  # 22
METRIC_AC_APPARENT_POWER_PHASE_3: Metric.ValueType  # 23
METRIC_AC_ACTIVE_POWER: Metric.ValueType  # 24
METRIC_AC_ACTIVE_POWER_PHASE_1: Metric.ValueType  # 25
METRIC_AC_ACTIVE_POWER_PHASE_2: Metric.ValueType  # 26
METRIC_AC_ACTIVE_POWER_PHASE_3: Metric.ValueType  # 27
METRIC_AC_REACTIVE_POWER: Metric.ValueType  # 28
METRIC_AC_REACTIVE_POWER_PHASE_1: Metric.ValueType  # 29
METRIC_AC_REACTIVE_POWER_PHASE_2: Metric.ValueType  # 30
METRIC_AC_REACTIVE_POWER_PHASE_3: Metric.ValueType  # 31
...
METRIC_AC_THD_CURRENT: Metric.ValueType  # 80
"""AC harmonics"""
METRIC_AC_THD_CURRENT_PHASE_1: Metric.ValueType  # 81
METRIC_AC_THD_CURRENT_PHASE_2: Metric.ValueType  # 82
METRIC_AC_THD_CURRENT_PHASE_3: Metric.ValueType  # 83
...
class SimpleMetricSample(google.protobuf.message.Message):
...
global___SimpleMetricSample = SimpleMetricSample

@typing_extensions.final
class AggregatedMetricSample(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_max_value", b"_max_value", "_min_value", b"_min_value", "max_value", b"max_value", "min_value", b"min_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_max_value", b"_max_value", "_min_value", b"_min_value", "avg_value", b"avg_value", "max_value", b"max_value", "min_value", b"min_value", "raw_values", b"raw_values"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_max_value", b"_max_value"]) -> typing_extensions.Literal["max_value"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_min_value", b"_min_value"]) -> typing_extensions.Literal["min_value"] | None: ...

global___AggregatedMetricSample = AggregatedMetricSample

@typing_extensions.final
class MetricSampleVariant(google.protobuf.message.Message):
    ...
    @property
    def simple_metric(self) -> global___SimpleMetricSample: ...
    @property
    def aggregated_metric(self) -> global___AggregatedMetricSample: ...
    def __init__(
        self,
        *,
        simple_metric: global___SimpleMetricSample | None = ...,
        aggregated_metric: global___AggregatedMetricSample | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["aggregated_metric", b"aggregated_metric", "metric_sample_type", b"metric_sample_type", "simple_metric", b"simple_metric"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregated_metric", b"aggregated_metric", "metric_sample_type", b"metric_sample_type", "simple_metric", b"simple_metric"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metric_sample_type", b"metric_sample_type"]) -> typing_extensions.Literal["simple_metric", "aggregated_metric"] | None: ...

global___MetricSampleVariant = MetricSampleVariant
...
class MetricSample(google.protobuf.message.Message):
    ...
    @property
    def sample(self) -> global___MetricSampleVariant:
    ...
    def __init__(
        ...
        *,
        ...
        metric: global___Metric.ValueType = ...,
        sample: global___MetricSampleVariant | None = ...,
        bounds: collections.abc.Iterable[frequenz.api.common.v1.metrics.bounds_pb2.Bounds] | None = ...,
        source: builtins.str | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_source", b"_source", "sample", b"sample", "sampled_at", b"sampled_at", "source", b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_source", b"_source", "bounds", b"bounds", "metric", b"metric", "sample", b"sample", "sampled_at", b"sampled_at", "source", b"source"]) -> None: ...
