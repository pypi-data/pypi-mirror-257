...
setup(
    ...
    name = 'facerec-uccs',
    version = "3.0.1",
    description = 'Source code for running the baseline and evaluation of the UCCS Watchlist Challange: 3rd Open-set Face Detection and Identification',

    url = 'https://github.com/AIML-IfI/uccs-facerec-challenge',
    license = 'BSD',
    author = ['Furkan Kasim','Manuel Gunther'],
