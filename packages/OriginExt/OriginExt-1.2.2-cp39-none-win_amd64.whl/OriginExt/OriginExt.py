...
OPT_IMAGE = _OriginExt.OPT_IMAGE
...
OCD_ENUM_NEXT_KEEP_ZERO_PREFIX = _OriginExt.OCD_ENUM_NEXT_KEEP_ZERO_PREFIX
...
OCD_DEL_FROM_UNDO_STACK = _OriginExt.OCD_DEL_FROM_UNDO_STACK
OCD_CAN_UNDO = _OriginExt.OCD_CAN_UNDO
OCD_DEL_FROM_PE = _OriginExt.OCD_DEL_FROM_PE
...
IMGSETDATAOPTS_FRAMESDIMENSION_IS_LAST = _OriginExt.IMGSETDATAOPTS_FRAMESDIMENSION_IS_LAST
...
class OriginObject(OriginBase):
    ...
    def SetBinaryStorageData(self, Name, binStorageData):
        return _OriginExt.OriginObject_SetBinaryStorageData(self, Name, binStorageData)
    ...
    def DoStrMethod(self, strCmd, strArg=None):
        return _OriginExt.OriginObject_DoStrMethod(self, strCmd, strArg)
...
class ImagePage(Page):
    ...
    def __init__(self):
        _OriginExt.ImagePage_swiginit(self, _OriginExt.new_ImagePage())
    __swig_destroy__ = _OriginExt.delete_ImagePage

    def IsValid(self):
        return _OriginExt.ImagePage_IsValid(self)

    def GetData(self, nFrameIndex=-1):
        return _OriginExt.ImagePage_GetData(self, nFrameIndex)

    def SetData(self, dataImage, options=0, nFrameIndex=-1):
        return _OriginExt.ImagePage_SetData(self, dataImage, options, nFrameIndex)

    def GetLayer(self):
        return _OriginExt.ImagePage_GetLayer(self)

# Register ImagePage in _OriginExt:
_OriginExt.ImagePage_swigregister(ImagePage)
...
class DataRange(OriginObject):
    ...
    def SetData(self, data1, data2, data3):
        return _OriginExt.DataRange_SetData(self, data1, data2, data3)
...
class ColorMap(OriginObject):
    ...
    def SetLevels(self, levels, colors):
        return _OriginExt.ColorMap_SetLevels(self, levels, colors)
...
class OriginCollectionImagePages(OriginCollectionPages):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _OriginExt.OriginCollectionImagePages_swiginit(self, _OriginExt.new_OriginCollectionImagePages())
    __swig_destroy__ = _OriginExt.delete_OriginCollectionImagePages

    def __call__(self, *args):
        return _OriginExt.OriginCollectionImagePages___call__(self, *args)

    def __next__(self):
        return _OriginExt.OriginCollectionImagePages___next__(self)

    def __getitem__(self, *args):
        return _OriginExt.OriginCollectionImagePages___getitem__(self, *args)

    def Add(self, *args):
        return _OriginExt.OriginCollectionImagePages_Add(self, *args)

# Register OriginCollectionImagePages in _OriginExt:
_OriginExt.OriginCollectionImagePages_swigregister(OriginCollectionImagePages)
...
class ApplicationBase(OriginPyObjBase):
    ...
    OPT_IMAGE = _OriginExt.ApplicationBase_OPT_IMAGE
    ...
    def GetImagePages(self):
        return _OriginExt.ApplicationBase_GetImagePages(self)
    ...
    def EvaluateFDF(self, FFName, indepVarValues, parameterValues):
        return _OriginExt.ApplicationBase_EvaluateFDF(self, FFName, indepVarValues, parameterValues)
    ...
    ImagePages = property(GetImagePages)
