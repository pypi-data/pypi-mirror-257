...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package trust-clearing-logic-clearing. Maybe you are using the wrong pypi?")


setup(
    name='trust-clearing-logic-clearing',
    version='66.0.3',
    author='Yandex',
