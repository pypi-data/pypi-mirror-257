...
from ..ecv_serverless.lambda_module import log
...
class CognitoService(AWSService):
    ...
    def create_cognito_user(
        ...
        log("cognito_create_user_response", data=dict(response))
        return response
    ...
    def resend_temporary_password(
        ...
        try:
            ...
            log("cognito_resend_password", data=response)
    ...
    def update_cognito_user_attributes(
        ...
        try:
            ...
            log("cognito_update_response", data=response)
        except Exception as e:
            print(str(e))
            response = None
