...
class InvocationContext(AbstractInvocationContext, AbstractMethodInvocationContext, AbstractInstanceContext):
    ...
    def get_instance_field(self, field_name: str):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/fields-and-properties/getting-values-for-instance-fields-and-properties>`_
        """       
