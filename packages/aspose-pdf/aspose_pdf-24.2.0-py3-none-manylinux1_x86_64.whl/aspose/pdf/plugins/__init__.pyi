...
class PdfExcel:
    '''Represents :class:`PdfExcel` plugin.'''
    ...
    def process(self, options: aspose.pdf.plugins.IPluginOptions) -> aspose.pdf.plugins.ResultContainer:
        ...
        :param options: An options object containing instructions for the :class:`PdfExcel`.
...
class PdfToExcelOptions(aspose.pdf.plugins.PdfConverterOptions):
    '''Represents PDF to XLSX converter options for :class:`PdfExcel` plugin.'''
...
class PdfToWordOptions(aspose.pdf.plugins.PdfConverterOptions):
    '''Represents PDF to DOC converter options for :class:`PdfWord` plugin.'''
    
    @overload
    def __init__(self):
        '''Initializes new instance of the :class:`PdfToWordOptions` object with default options.'''
        ...
    
    @overload
    def __init__(self, format, mode: aspose.pdf.plugins.ConversionMode):
        '''Initializes a new instance of the :class:`PdfToWordOptions` object for the specified format and mode.
        
        :param format: Save format of the :attr:`PdfToWordOptions.save_format` output document.
        :param mode: Conversion mode of the :attr:`PdfToWordOptions.conversion_mode` output document.'''
        ...
...
class PdfWord:
    '''Represents :class:`PdfWord` plugin.'''
    
    def __init__(self):
        ...
    
    def process(self, options: aspose.pdf.plugins.IPluginOptions) -> aspose.pdf.plugins.ResultContainer:
        '''Starts the :class:`PdfWord` processing with the specified parameters.
        
        :param options: An options object containing instructions for the :class:`PdfWord`.
        :returns: An :class:`ResultContainer` object containing the result of the operation.'''
        ...
