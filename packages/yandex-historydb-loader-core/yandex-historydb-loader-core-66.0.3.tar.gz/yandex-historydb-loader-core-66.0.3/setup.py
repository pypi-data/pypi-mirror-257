...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-historydb-loader-core. Maybe you are using the wrong pypi?")


setup(
    name='yandex-historydb-loader-core',
    version='66.0.3',
    author='Yandex',
