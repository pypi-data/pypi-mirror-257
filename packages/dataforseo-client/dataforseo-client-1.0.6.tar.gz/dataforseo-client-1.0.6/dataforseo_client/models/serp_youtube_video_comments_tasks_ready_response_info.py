...
class SerpYoutubeVideoCommentsTasksReadyResponseInfo(BaseModel):
    ...
    tasks: Optional[List[SerpYoutubeVideoCommentsTasksReadyTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [SerpYoutubeVideoCommentsTasksReadyTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
