...
class BusinessDataGoogleHotelInfoTasksReadyResult(BaseModel):
    """
    BusinessDataGoogleHotelInfoTasksReadyResult
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "se", "date_posted", "tag", "endpoint_advanced", "endpoint_html"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoTasksReadyResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoTasksReadyResult from a dict"""
        if obj is None:
            return None
