...
class BusinessDataSocialMediaPinterestLiveResult(BaseModel):
    """
    BusinessDataSocialMediaPinterestLiveResult
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element = ‘social_media_pinterest_item’")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataSocialMediaPinterestLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataSocialMediaPinterestLiveResult from a dict"""
        if obj is None:
            return None
