...
class MerchantAmazonReviewsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asin", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "se_domain", "depth", "sort_by", "reviewer_type", "filter_by_star", "filter_by_keyword", "media_type", "format_type", "tag", "postback_url", "postback_data", "pingback_url", "limit"]
