...
class MerchantAmazonProductsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "url", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "se_domain", "depth", "max_crawl_pages", "search_param", "price_min", "price_max", "sort_by", "tag", "postback_url", "postback_data", "pingback_url", "limit", "department"]
