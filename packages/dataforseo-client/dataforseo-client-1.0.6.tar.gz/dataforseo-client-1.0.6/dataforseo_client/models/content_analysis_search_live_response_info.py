...
class ContentAnalysisSearchLiveResponseInfo(BaseModel):
    ...
    status_code: Optional[StrictInt] = Field(default=None, description="general status code\\nyou can find the full list of the response codes here")
    status_message: Optional[StrictStr] = Field(default=None, description="general informational message\\nyou can find the full list of general informational messages here")
    ...
    tasks: Optional[List[ContentAnalysisSearchLiveTask]] = None
    keyword_fields: Optional[Dict[str, Optional[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["version", "status_code", "status_message", "time", "cost", "tasks_count", "tasks_error", "tasks", "keyword_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [ContentAnalysisSearchLiveTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
