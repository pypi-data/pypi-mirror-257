...
class BacklinksTimeseriesNewLostSummaryLiveItem(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description=" type of element = ‘backlinks_timeseries_new_lost_summary’")
    ...
    new_referring_main_domains: Optional[StrictInt] = None
    lost_referring_main_domains: Optional[StrictInt] = None
