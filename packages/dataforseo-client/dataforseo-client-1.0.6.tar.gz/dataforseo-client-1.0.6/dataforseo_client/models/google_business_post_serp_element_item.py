...
class GoogleBusinessPostSerpElementItem(BaseSerpElementItem):
    """
    GoogleBusinessPostSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "author", "snippet", "post_text", "url", "images_url", "post_date", "timestamp", "links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleBusinessPostSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleBusinessPostSerpElementItem from a dict"""
        if obj is None:
            return None
