...
class TrustpilotSearchOrganicSerpElementItem(BaseSerpElementItem):
    """
    TrustpilotSearchOrganicSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "title", "domain", "url", "reviews_count", "rating"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrustpilotSearchOrganicSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrustpilotSearchOrganicSerpElementItem from a dict"""
        if obj is None:
            return None
