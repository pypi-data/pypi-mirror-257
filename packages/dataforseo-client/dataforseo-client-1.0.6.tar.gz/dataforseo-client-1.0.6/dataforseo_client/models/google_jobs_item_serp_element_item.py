...
class GoogleJobsItemSerpElementItem(BaseSerpElementItem):
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "job_id", "title", "employer_name", "employer_url", "employer_image_url", "location", "source_name", "source_url", "salary", "contract_type", "timestamp", "time_ago", "rectangle"]
