...
class BusinessDataTripadvisorReviewsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url_path", "keyword", "location_name", "location_code", "priority", "language_name", "language_code", "depth", "ratings", "visit_type", "months", "search_reviews_keyword", "sort_by", "tag", "postback_url", "pingback_url", "limit"]
