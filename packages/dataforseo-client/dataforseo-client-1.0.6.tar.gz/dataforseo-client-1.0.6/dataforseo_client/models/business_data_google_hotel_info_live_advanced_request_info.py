...
class BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hotel_identifier", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "check_in", "check_out", "currency", "adults", "children", "tag", "limit"]
