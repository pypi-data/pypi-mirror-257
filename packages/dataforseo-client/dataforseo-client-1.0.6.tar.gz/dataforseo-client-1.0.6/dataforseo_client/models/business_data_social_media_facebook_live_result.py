...
class BusinessDataSocialMediaFacebookLiveResult(BaseModel):
    """
    BusinessDataSocialMediaFacebookLiveResult
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element = ‘social_media_facebook_item’")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataSocialMediaFacebookLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataSocialMediaFacebookLiveResult from a dict"""
        if obj is None:
            return None
