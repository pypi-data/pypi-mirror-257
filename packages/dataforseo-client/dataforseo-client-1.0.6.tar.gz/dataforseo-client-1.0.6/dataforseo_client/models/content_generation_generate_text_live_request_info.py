...
class ContentGenerationGenerateTextLiveRequestInfo(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="meta description of the content to generate optional field can contain from 1 to 200 tokens learn more about this parameter on our help center")
    ...
    __properties: ClassVar[List[str]] = ["topic", "word_count", "sub_topics", "description", "meta_keywords", "creativity_index", "include_conclusion", "supplement_token", "tag", "limit"]
