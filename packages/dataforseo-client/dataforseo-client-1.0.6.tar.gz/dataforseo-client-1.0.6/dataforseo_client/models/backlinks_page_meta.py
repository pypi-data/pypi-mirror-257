...
class BacklinksPageMeta(BaseModel):
    ...
    images_alt: Optional[List[Optional[StrictStr]]] = None
    powered_by: Optional[List[Optional[StrictStr]]] = None
    ...
    platform_type: Optional[List[Optional[StrictStr]]] = None
    technologies: Optional[Dict[str, Optional[StrictStr]]] = None
