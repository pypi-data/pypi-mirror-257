...
class SerpYoutubeVideoInfoTasksReadyTask(BaseModel):
    """
    SerpYoutubeVideoInfoTasksReadyTask
    """ # noqa: E501
    ...
    result: Optional[List[SerpYoutubeVideoInfoTasksReadyResult]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpYoutubeVideoInfoTasksReadyTask from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpYoutubeVideoInfoTasksReadyTask from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpYoutubeVideoInfoTasksReadyResult.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
