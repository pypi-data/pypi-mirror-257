...
class KeywordKpi(BaseModel):
    ...
    KeywordKpi
    """ # noqa: E501
    desktop: Optional[List[OInfo]] = None
    mobile: Optional[List[OInfo]] = None
    tablet: Optional[List[OInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "desktop": [OInfo.from_dict(_item) for _item in obj["desktop"]] if obj.get("desktop") is not None else None,
            "mobile": [OInfo.from_dict(_item) for _item in obj["mobile"]] if obj.get("mobile") is not None else None,
            "tablet": [OInfo.from_dict(_item) for _item in obj["tablet"]] if obj.get("tablet") is not None else None
        })
        return _obj
