...
class ContentGenerationTextSummaryLiveResult(BaseModel):
    """
    ContentGenerationTextSummaryLiveResult
    """ # noqa: E501
    ...
    keyword_density: Optional[Dict[str, Optional[StrictInt]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentGenerationTextSummaryLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentGenerationTextSummaryLiveResult from a dict"""
        if obj is None:
            return None
