...
class GoogleShoppingSerpSerpElementItem(BaseSerpElementItem):
    """
    GoogleShoppingSerpSerpElementItem
    """ # noqa: E501
    ...
    additional_specifications: Optional[Dict[str, Optional[StrictStr]]] = None
    ...
    product_images: Optional[List[Optional[StrictStr]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleShoppingSerpSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleShoppingSerpSerpElementItem from a dict"""
        if obj is None:
            return None
