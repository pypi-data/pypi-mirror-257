...
class AppendixDayStatisticsMoneyData(BaseModel):
    ...
    keywords_data: Optional[AppendixKeywordsDataStatisticsRatesDataInfo] = None
    ...
    merchant: Optional[AppendixMerchantDayStatisticsMoneyData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keywords_data": AppendixKeywordsDataStatisticsRatesDataInfo.from_dict(obj["keywords_data"]) if obj.get("keywords_data") is not None else None,
            ...
            "merchant": AppendixMerchantDayStatisticsMoneyData.from_dict(obj["merchant"]) if obj.get("merchant") is not None else None,
