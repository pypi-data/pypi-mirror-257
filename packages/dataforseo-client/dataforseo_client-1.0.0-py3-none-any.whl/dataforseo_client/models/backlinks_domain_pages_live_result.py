...
class BacklinksDomainPagesLiveResult(BaseModel):
    """
    BacklinksDomainPagesLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[BacklinksDomainPagesLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksDomainPagesLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksDomainPagesLiveResult from a dict"""
        if obj is None:
            return None
