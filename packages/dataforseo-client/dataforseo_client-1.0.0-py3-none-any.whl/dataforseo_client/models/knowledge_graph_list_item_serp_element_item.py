...
class KnowledgeGraphListItemSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[KnowledgeGraphListElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "data_attrid", "link", "items", "rectangle"]
