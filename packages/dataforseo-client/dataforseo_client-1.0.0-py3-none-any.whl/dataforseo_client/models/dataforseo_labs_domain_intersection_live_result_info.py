...
class DataforseoLabsDomainIntersectionLiveResultInfo(BaseModel):
    """
    DataforseoLabsDomainIntersectionLiveResultInfo
    """ # noqa: E501
    ...
    items: Optional[List[DataforseoLabsDomainIntersectionLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsDomainIntersectionLiveResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsDomainIntersectionLiveResultInfo from a dict"""
        if obj is None:
            return None
