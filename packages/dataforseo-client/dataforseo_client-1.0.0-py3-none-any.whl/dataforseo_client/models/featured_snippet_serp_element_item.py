...
class FeaturedSnippetSerpElementItem(BaseSerpElementItem):
    ...
    estimated_paid_traffic_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="estimated cost of converting organic search traffic into paid represents the estimated monthly cost of running ads for all keywords that a domain ranks for the metric is calculated as the product of organic etv and paid cpc values and indicates the cost of driving the estimated volume of monthly organic traffic through PPC advertising in Bing Search learn more about how the metric is calculated in this help center article")
    rank_changes: Optional[RankChanges] = None
    backlinks_info: Optional[AvgBacklinksInfo] = None
    rank_info: Optional[RankInfo] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "domain", "title", "description", "url", "breadcrumb", "position", "xpath", "featured_title", "timestamp", "images", "table", "rectangle", "main_domain", "relative_url", "etv", "estimated_paid_traffic_cost", "rank_changes", "backlinks_info", "rank_info"]
