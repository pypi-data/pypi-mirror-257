...
class BusinessDataBusinessListingsSearchLiveResult(BaseModel):
    """
    BusinessDataBusinessListingsSearchLiveResult
    """ # noqa: E501
    ...
    offset_token: Optional[StrictStr] = None
    items: Optional[List[BusinessDataBusinessListingsSearchLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataBusinessListingsSearchLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataBusinessListingsSearchLiveResult from a dict"""
        if obj is None:
            return None
