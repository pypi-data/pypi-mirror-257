...
class DomainAnalyticsTechnologiesDomainTechnologiesLiveResult(BaseModel):
    """
    DomainAnalyticsTechnologiesDomainTechnologiesLiveResult
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of the item = ‘domain_technology_item’")
    ...
    meta_keywords: Optional[List[Optional[StrictStr]]] = None
    ...
    phone_numbers: Optional[List[Optional[StrictStr]]] = None
    emails: Optional[List[Optional[StrictStr]]] = None
    social_graph_urls: Optional[List[Optional[StrictStr]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainTechnologiesLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainTechnologiesLiveResult from a dict"""
        if obj is None:
            return None
