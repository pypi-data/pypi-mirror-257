...
class AppendixKeywordsDataDayLimitsRatesData(BaseModel):
    """
    AppendixKeywordsDataDayLimitsRatesData
    """ # noqa: E501
    ...
    bing: Optional[AppendixBingKeywordsDataDayLimitsRatesData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppendixKeywordsDataDayLimitsRatesData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppendixKeywordsDataDayLimitsRatesData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bing": AppendixBingKeywordsDataDayLimitsRatesData.from_dict(obj["bing"]) if obj.get("bing") is not None else None,
