...
class ImagesSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[ImagesElement]] = None
    related_image_searches: Optional[List[RelatedImageSearchesElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "url", "items", "related_image_searches", "rectangle"]
