...
class QuestionsAndAnswersSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[QuestionsAndAnswersElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "items", "rectangle"]
