...
class AppendixExploreKeywordsDataLimitsRatesDataInfo(BaseModel):
    """
    AppendixExploreKeywordsDataLimitsRatesDataInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["task_post", "task_get", "live"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppendixExploreKeywordsDataLimitsRatesDataInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppendixExploreKeywordsDataLimitsRatesDataInfo from a dict"""
        if obj is None:
            return None
