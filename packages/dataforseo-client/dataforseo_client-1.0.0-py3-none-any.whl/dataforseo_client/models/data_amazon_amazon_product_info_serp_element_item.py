...
class DataAmazonAmazonProductInfoSerpElementItem(AmazonBaseSerpElementItem):
    """
    ...
    product_asins: Optional[List[Optional[StrictStr]]] = None
    ...
    categories: Optional[List[ProductCategoryInfo]] = None
    product_information: Optional[List[BaseProductInformationItem]] = None
    product_images_list: Optional[List[Optional[StrictStr]]] = None
    product_videos_list: Optional[List[Optional[StrictStr]]] = None
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "details", "image_url", "author", "data_asin", "parent_asin", "product_asins", "price_from", "price_to", "currency", "is_amazon_choice", "rating", "is_newer_model_available", "newer_model", "categories", "product_information", "product_images_list", "product_videos_list", "description", "is_available"]
