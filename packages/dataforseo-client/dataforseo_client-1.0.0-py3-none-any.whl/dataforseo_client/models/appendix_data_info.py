...
class AppendixDataInfo(BaseModel):
    ...
    appendix: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "traffic_analytics": AppendixsMinuteLimitsRatesDataInfo.from_dict(obj["traffic_analytics"]) if obj.get("traffic_analytics") is not None else None,
            "total_reviews": obj.get("total_reviews"),
            "reviews": AppendixsMinuteLimitsRatesDataInfo.from_dict(obj["reviews"]) if obj.get("reviews") is not None else None,
