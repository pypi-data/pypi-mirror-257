...
class ContentAnalysisSummaryLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "keyword_fields", "page_type", "internal_list_limit", "positive_connotation_threshold", "sentiments_connotation_threshold", "initial_dataset_filters", "tag", "limit"]
