...
class KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResult(BaseModel):
    """
    KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResult
    """ # noqa: E501
    ...
    available_locations: Optional[List[AvailableLocations]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResult from a dict"""
        if obj is None:
            return None
