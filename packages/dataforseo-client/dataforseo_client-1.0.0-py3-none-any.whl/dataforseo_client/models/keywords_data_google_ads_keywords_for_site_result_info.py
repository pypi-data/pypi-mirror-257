...
class KeywordsDataGoogleAdsKeywordsForSiteResultInfo(BaseModel):
    """
    KeywordsDataGoogleAdsKeywordsForSiteResultInfo
    """ # noqa: E501
    ...
    monthly_searches: Optional[List[MonthlySearches]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordsDataGoogleAdsKeywordsForSiteResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordsDataGoogleAdsKeywordsForSiteResultInfo from a dict"""
        if obj is None:
            return None
