...
class KeywordsDataGoogleTrendsExploreResultInfo(BaseModel):
    """
    KeywordsDataGoogleTrendsExploreResultInfo
    """ # noqa: E501
    keywords: Optional[List[Optional[StrictStr]]] = None
    ...
    items: Optional[List[BaseGoogleTrendsItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordsDataGoogleTrendsExploreResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordsDataGoogleTrendsExploreResultInfo from a dict"""
        if obj is None:
            return None
