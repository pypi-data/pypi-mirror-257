...
class TopStoriesSerpElementItem(BaseSerpElementItem):
    ...
    """ # noqa: E501
    rank_group: Optional[StrictInt] = None
    rank_absolute: Optional[StrictInt] = None
    position: Optional[StrictStr] = None
    xpath: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    items: Optional[List[TopStoriesElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "items", "rectangle"]
