...
class ContentAnalysisSearchLiveItem(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element = ‘content_analysis_search’")
    ...
    page_category: Optional[List[Optional[StrictInt]]] = None
    page_types: Optional[List[StrictStr]] = Field(default=None, description="page types")
    ratings: Optional[List[RatingInfo]] = None
    social_metrics: Optional[SocialMetricsInfo] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of social_metrics
        if self.social_metrics:
            _dict['social_metrics'] = self.social_metrics.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "social_metrics": SocialMetricsInfo.from_dict(obj["social_metrics"]) if obj.get("social_metrics") is not None else None,
