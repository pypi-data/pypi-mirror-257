...
class DataAmazonAmazonPaidSerpElementItem(AmazonBaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "xpath", "domain", "title", "url", "image_url", "bought_past_month", "price_from", "price_to", "currency", "special_offers", "data_asin", "rating", "is_amazon_choice", "is_best_seller", "delivery_info"]
