...
class FoundOnWebSerpElementItem(BaseSerpElementItem):
    ...
    related_searches: Optional[List[Optional[StrictStr]]] = None
    items: Optional[List[FoundOnWebElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "related_searches", "items", "rectangle"]
