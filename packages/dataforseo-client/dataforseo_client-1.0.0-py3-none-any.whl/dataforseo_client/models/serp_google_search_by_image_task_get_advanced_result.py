...
class SerpGoogleSearchByImageTaskGetAdvancedResult(BaseModel):
    """
    SerpGoogleSearchByImageTaskGetAdvancedResult
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["image_url", "keyword", "type", "se_domain", "location_code", "language_code", "check_url", "datetime", "spell", "item_types", "se_results_count", "items_count", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleSearchByImageTaskGetAdvancedResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleSearchByImageTaskGetAdvancedResult from a dict"""
        if obj is None:
            return None
