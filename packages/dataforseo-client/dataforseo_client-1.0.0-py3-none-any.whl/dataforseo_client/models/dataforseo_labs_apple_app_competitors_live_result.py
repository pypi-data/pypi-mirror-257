...
class DataforseoLabsAppleAppCompetitorsLiveResult(BaseModel):
    """
    DataforseoLabsAppleAppCompetitorsLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[DataforseoLabsAppleAppCompetitorsLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsAppleAppCompetitorsLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsAppleAppCompetitorsLiveResult from a dict"""
        if obj is None:
            return None
