...
class PaidSerpElementItem(BaseSerpElementItem):
    ...
    extra: Optional[Dict[str, Optional[StrictStr]]] = None
    description: Optional[StrictStr] = Field(default=None, description="description of the results element in SERP")
    description_rows: Optional[List[Optional[StrictStr]]] = None
    links: Optional[List[AdLinkElement]] = None
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "domain", "breadcrumb", "is_image", "is_video", "images", "url", "highlighted", "extra", "description", "description_rows", "links", "price", "rectangle", "website_name", "main_domain", "relative_url", "etv", "impressions_etv", "estimated_paid_traffic_cost", "rank_changes", "backlinks_info", "rank_info"]
