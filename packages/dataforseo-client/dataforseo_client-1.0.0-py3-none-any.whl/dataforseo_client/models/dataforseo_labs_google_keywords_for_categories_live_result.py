...
class DataforseoLabsGoogleKeywordsForCategoriesLiveResult(BaseModel):
    """
    DataforseoLabsGoogleKeywordsForCategoriesLiveResult
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    seed_categories: Optional[List[Optional[StrictInt]]] = None
    ...
    items: Optional[List[KeywordDataInfo]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleKeywordsForCategoriesLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleKeywordsForCategoriesLiveResult from a dict"""
        if obj is None:
            return None
