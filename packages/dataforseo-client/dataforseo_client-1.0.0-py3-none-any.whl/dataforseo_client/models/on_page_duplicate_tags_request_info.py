...
class OnPageDuplicateTagsRequestInfo(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="duplicate tags type required field indicates the type of duplicate elements found on the pages. The results will depend on the type you specify possible values: duplicate_title, duplicate_description")
