...
class AppendixContentGenerationLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    generate: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    generate_meta_tags: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    generate_text: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    paraphrase: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    generate_sub_topics: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "generate": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["generate"]) if obj.get("generate") is not None else None,
            "generate_meta_tags": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["generate_meta_tags"]) if obj.get("generate_meta_tags") is not None else None,
            "generate_text": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["generate_text"]) if obj.get("generate_text") is not None else None,
            "paraphrase": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["paraphrase"]) if obj.get("paraphrase") is not None else None,
            ...
            "generate_sub_topics": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["generate_sub_topics"]) if obj.get("generate_sub_topics") is not None else None
        })
        return _obj
