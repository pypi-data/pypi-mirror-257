...
class DataforseoLabsLocationsAndLanguagesResult(BaseModel):
    """
    DataforseoLabsLocationsAndLanguagesResult
    """ # noqa: E501
    ...
    available_languages: Optional[List[AvailableLanguages]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsLocationsAndLanguagesResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsLocationsAndLanguagesResult from a dict"""
        if obj is None:
            return None
