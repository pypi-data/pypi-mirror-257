...
class AppendixDayLimitsRatesData(BaseModel):
    ...
    keywords_data: Optional[AppendixKeywordsDataDayLimitsRatesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keywords_data": AppendixKeywordsDataDayLimitsRatesData.from_dict(obj["keywords_data"]) if obj.get("keywords_data") is not None else None,
