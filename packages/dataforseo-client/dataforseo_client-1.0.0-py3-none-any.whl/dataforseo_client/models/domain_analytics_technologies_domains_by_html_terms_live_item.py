...
class DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem(BaseModel):
    """
    DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem
    """ # noqa: E501
    ...
    social_graph_urls: Optional[Dict[str, Any]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem from a dict"""
        if obj is None:
            return None
