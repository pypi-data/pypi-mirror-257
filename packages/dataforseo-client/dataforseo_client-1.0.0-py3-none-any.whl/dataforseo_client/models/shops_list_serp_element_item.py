...
class ShopsListSerpElementItem(BaseSerpElementItem):
    """
    ShopsListSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "domain", "title", "url", "details", "base_price", "tax", "shipping_price", "total_price", "currency", "seller_name", "rating", "shop_ad_aclk", "product_condition", "product_annotation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShopsListSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShopsListSerpElementItem from a dict"""
        if obj is None:
            return None
