...
class DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem(BaseModel):
    ...
    top_categories: Optional[List[Optional[StrictInt]]] = None
    ...
    metrics_history: Optional[Dict[str, Dict[str, MetricsInfo]]] = None
    metrics_difference: Optional[Dict[str, MetricsInfo]] = None
