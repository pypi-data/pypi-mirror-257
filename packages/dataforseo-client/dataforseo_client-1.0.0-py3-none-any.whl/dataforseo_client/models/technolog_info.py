...
class TechnologInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["domain_rank", "last_visited", "country_iso_code", "language_code", "content_language_code"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TechnologInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TechnologInfo from a dict"""
        if obj is None:
            return None
