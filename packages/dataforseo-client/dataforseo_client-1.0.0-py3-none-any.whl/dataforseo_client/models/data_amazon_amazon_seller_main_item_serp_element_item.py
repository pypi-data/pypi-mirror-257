...
class DataAmazonAmazonSellerMainItemSerpElementItem(AmazonBaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "seller_name", "seller_url", "ships_from", "price", "rating", "condition", "condition_description", "delivery_info"]
