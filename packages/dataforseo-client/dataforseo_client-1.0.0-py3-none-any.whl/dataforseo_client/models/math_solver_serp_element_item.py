...
class MathSolverSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[MathSolverElement]] = None
    links: Optional[List[LinkElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "result", "items", "links", "rectangle"]
