...
class SerpYoutubeVideoInfoAdvancedResultInfo(BaseModel):
    """
    SerpYoutubeVideoInfoAdvancedResultInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["video_id", "se_domain", "location_code", "language_code", "check_url", "datetime", "spell", "item_types", "items_count", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpYoutubeVideoInfoAdvancedResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpYoutubeVideoInfoAdvancedResultInfo from a dict"""
        if obj is None:
            return None
