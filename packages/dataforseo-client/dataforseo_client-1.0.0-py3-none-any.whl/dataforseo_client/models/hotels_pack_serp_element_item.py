...
class HotelsPackSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[HotelsPackElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "date_from", "date_to", "items", "rectangle"]
