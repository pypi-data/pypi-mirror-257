...
class GoogleShoppingSponsoredCarouselSerpElementItem(BaseSerpElementItem):
    """
    ...
    items: Optional[List[GoogleShoppingSponsoredCarouselElement]] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleShoppingSponsoredCarouselSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleShoppingSponsoredCarouselSerpElementItem from a dict"""
        if obj is None:
            return None
