...
class DataforseoLabsGoogleBulkAppMetricsLiveItem(BaseModel):
    """
    DataforseoLabsGoogleBulkAppMetricsLiveItem
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    app_id: Optional[StrictStr] = Field(default=None, description="id of the app in a POST array")
    metrics: Optional[Dict[str, AppMetricsInfo]] = None
    seed_keyword_data: Optional[KeywordData] = None
    __properties: ClassVar[List[str]] = ["se_type", "app_id", "metrics", "seed_keyword_data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleBulkAppMetricsLiveItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleBulkAppMetricsLiveItem from a dict"""
        if obj is None:
            return None
