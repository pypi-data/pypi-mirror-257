...
class ContentAnalysisTrendsLiveResultInfo(BaseModel):
    """
    ContentAnalysisTrendsLiveResultInfo
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element = ‘content_analysis_trends’")
    ...
    top_domains: Optional[List[TopDomainInfo]] = None
    sentiment_connotations: Optional[Dict[str, Optional[StrictInt]]] = None
    connotation_types: Optional[Dict[str, Optional[StrictInt]]] = None
    text_categories: Optional[List[ContentAnalysisCategoriesInfo]] = None
    page_categories: Optional[List[ContentAnalysisCategoriesInfo]] = None
    page_types: Optional[Dict[str, Optional[StrictInt]]] = None
    countries: Optional[Dict[str, Optional[StrictInt]]] = None
    languages: Optional[Dict[str, Optional[StrictInt]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentAnalysisTrendsLiveResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentAnalysisTrendsLiveResultInfo from a dict"""
        if obj is None:
            return None
