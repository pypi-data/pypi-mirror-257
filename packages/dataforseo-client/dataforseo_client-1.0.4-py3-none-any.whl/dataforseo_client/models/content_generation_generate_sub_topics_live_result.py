...
class ContentGenerationGenerateSubTopicsLiveResult(BaseModel):
    """
    ContentGenerationGenerateSubTopicsLiveResult
    """ # noqa: E501
    ...
    sub_topics: Optional[List[Optional[StrictStr]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentGenerationGenerateSubTopicsLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentGenerationGenerateSubTopicsLiveResult from a dict"""
        if obj is None:
            return None
