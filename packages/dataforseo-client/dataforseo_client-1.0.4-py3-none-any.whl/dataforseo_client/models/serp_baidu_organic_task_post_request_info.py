...
class SerpBaiduOrganicTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "depth", "max_crawl_pages", "language_name", "language_code", "location_name", "location_code", "location_coordinate", "device", "os", "get_website_url", "tag", "postback_url", "postback_data", "pingback_url", "limit"]
