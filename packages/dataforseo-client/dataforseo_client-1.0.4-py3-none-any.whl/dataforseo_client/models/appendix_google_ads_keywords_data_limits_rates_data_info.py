...
class AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo(BaseModel):
    ...
    ad_traffic_by_keywords: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ad_traffic_by_keywords": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["ad_traffic_by_keywords"]) if obj.get("ad_traffic_by_keywords") is not None else None
        })
        return _obj
