...
class DomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["technology_paths", "groups", "categories", "technologies", "keywords", "mode", "filters", "internal_list_limit", "tag", "limit"]
