...
class ImagesSearchSerpElementItem(BaseSerpElementItem):
    ...
    subtitle: Optional[StrictStr] = Field(default=None, description="subtitle of the element in SERP")
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "xpath", "title", "subtitle", "alt", "url", "source_url", "encoded_url"]
