...
class BusinessDataYelpLocationsResponseInfo(BaseModel):
    """
    ...
    tasks: Optional[List[BusinessDataYelpLocationsTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [BusinessDataYelpLocationsTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
