...
class SerpGoogleLocalFinderLiveHtmlRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "device", "os", "depth", "min_rating", "time_filter", "tag", "limit"]
