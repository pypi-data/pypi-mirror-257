...
class DataforseoLabsGoogleBulkKeywordDifficultyLiveTask(BaseModel):
    ...
    result: Optional[List[DataforseoLabsBulkKeywordDifficultyLiveResultInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [DataforseoLabsBulkKeywordDifficultyLiveResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
