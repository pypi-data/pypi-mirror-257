...
class TripadvisorSearchOrganicSerpElementItem(BaseSerpElementItem):
    """
    TripadvisorSearchOrganicSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "title", "url_path", "is_sponsored", "reviews_count", "category", "price_rate", "rating"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TripadvisorSearchOrganicSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TripadvisorSearchOrganicSerpElementItem from a dict"""
        if obj is None:
            return None
