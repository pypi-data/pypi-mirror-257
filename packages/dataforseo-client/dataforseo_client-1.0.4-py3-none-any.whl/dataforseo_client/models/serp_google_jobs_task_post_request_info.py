...
class SerpGoogleJobsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_radius", "language_name", "language_code", "depth", "employment_type", "date_posted", "tag", "postback_url", "postback_data", "pingback_url", "limit"]
