...
class OnPagePageScreenshotRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "accept_language", "custom_user_agent", "browser_preset", "browser_screen_width", "browser_screen_height", "browser_screen_scale_factor", "full_page_screenshot", "disable_cookie_popup", "enable_javascript", "custom_js", "ip_pool_for_scan", "limit"]
