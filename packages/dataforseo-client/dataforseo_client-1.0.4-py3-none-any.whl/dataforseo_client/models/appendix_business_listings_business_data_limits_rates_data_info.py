...
class AppendixBusinessListingsBusinessDataLimitsRatesDataInfo(BaseModel):
    ...
    categories_aggregation: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categories_aggregation": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["categories_aggregation"]) if obj.get("categories_aggregation") is not None else None,
