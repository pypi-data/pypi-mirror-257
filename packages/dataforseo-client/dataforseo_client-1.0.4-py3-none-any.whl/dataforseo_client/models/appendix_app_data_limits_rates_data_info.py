...
class AppendixAppDataLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    app_info: Optional[AppendixProductGoogleMerchantDayLimitsRatesDataInfo] = None
    app_list: Optional[AppendixProductGoogleMerchantDayLimitsRatesDataInfo] = None
    app_reviews: Optional[AppendixAppReviewsAppDataLimitsRatesDataInfo] = None
    app_searches: Optional[AppendixProductGoogleMerchantDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "app_info": AppendixProductGoogleMerchantDayLimitsRatesDataInfo.from_dict(obj["app_info"]) if obj.get("app_info") is not None else None,
            "app_list": AppendixProductGoogleMerchantDayLimitsRatesDataInfo.from_dict(obj["app_list"]) if obj.get("app_list") is not None else None,
            "app_reviews": AppendixAppReviewsAppDataLimitsRatesDataInfo.from_dict(obj["app_reviews"]) if obj.get("app_reviews") is not None else None,
            "app_searches": AppendixProductGoogleMerchantDayLimitsRatesDataInfo.from_dict(obj["app_searches"]) if obj.get("app_searches") is not None else None,
