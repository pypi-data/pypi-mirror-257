...
class GoogleShoppingPaidSerpElementItem(BaseSerpElementItem):
    """
    GoogleShoppingPaidSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "domain", "title", "description", "url", "shop_ad_aclk"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleShoppingPaidSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleShoppingPaidSerpElementItem from a dict"""
        if obj is None:
            return None
