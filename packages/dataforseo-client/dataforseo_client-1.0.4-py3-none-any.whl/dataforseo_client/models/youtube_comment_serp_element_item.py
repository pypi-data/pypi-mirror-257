...
class YoutubeCommentSerpElementItem(BaseSerpElementItem):
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "author_name", "author_thumbnail", "author_url", "text", "publication_date", "timestamp", "likes_count", "reply_count"]
