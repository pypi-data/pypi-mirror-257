...
class BusinessDataYelpReviewsTaskGetResult(BaseModel):
    """
    BusinessDataYelpReviewsTaskGetResult
    """ # noqa: E501
    ...
    alias: Optional[StrictStr] = Field(default=None, description="Yelp business identifier ")
    type: Optional[StrictStr] = Field(default=None, description="search engine type in a POST array")
    se_domain: Optional[StrictStr] = Field(default=None, description="search engine domain in a POST array")
    location_code: Optional[StrictStr] = Field(default=None, description="location code in a POST array if location_code was not specified in a POST array, the value equals null")
    language_code: Optional[StrictStr] = Field(default=None, description="language code in a POST array")
    check_url: Optional[StrictStr] = Field(default=None, description="direct URL to Yelp results you can use it to make sure that we provided accurate results")
    ...
    title: Optional[StrictStr] = Field(default=None, description="title of the reviews from Yelp the name of the local establishment for which the reviews are collected")
    ...
    items: Optional[List[BaseSerpElementItem]] = None
    __properties: ClassVar[List[str]] = ["keyword", "alias", "type", "se_domain", "location_code", "language_code", "check_url", "datetime", "title", "rating", "reviews_count", "items_count", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataYelpReviewsTaskGetResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataYelpReviewsTaskGetResult from a dict"""
        if obj is None:
            return None
