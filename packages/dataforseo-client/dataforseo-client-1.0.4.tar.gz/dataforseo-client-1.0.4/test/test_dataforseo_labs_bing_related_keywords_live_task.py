    ...
    def make_instance(self, include_optional) -> DataforseoLabsBingRelatedKeywordsLiveTask:
        ...
        if include_optional:
            return DataforseoLabsBingRelatedKeywordsLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_bing_related_keywords_live_result.DataforseoLabsBingRelatedKeywordsLiveResult(
                        se_type = '', 
                        seed_keyword = '', 
                        ...
                        items_count = 56, 
                        items = [
                            dataforseo_client.models.dataforseo_labs_bing_related_keywords_live_item.DataforseoLabsBingRelatedKeywordsLiveItem(
                                se_type = '', 
