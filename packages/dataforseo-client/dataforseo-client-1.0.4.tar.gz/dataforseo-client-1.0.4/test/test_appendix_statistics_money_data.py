...
class TestAppendixStatisticsMoneyData(unittest.TestCase):
    """AppendixStatisticsMoneyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixStatisticsMoneyData:
        """Test AppendixStatisticsMoneyData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixStatisticsMoneyData`
        """
        model = AppendixStatisticsMoneyData()
        if include_optional:
            return AppendixStatisticsMoneyData(
    ...
    def testAppendixStatisticsMoneyData(self):
        """Test AppendixStatisticsMoneyData"""
