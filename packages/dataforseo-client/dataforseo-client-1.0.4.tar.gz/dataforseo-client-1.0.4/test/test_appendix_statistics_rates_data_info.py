    ...
    def make_instance(self, include_optional) -> AppendixStatisticsRatesDataInfo:
        ...
        if include_optional:
            return AppendixStatisticsRatesDataInfo(
                ...
                total = 1.337,
                total_serp = 1.337,
                keywords_data = dataforseo_client.models.appendix_keywords_data_statistics_rates_data_info.AppendixKeywordsDataStatisticsRatesDataInfo(
                    keywords_for_keywords = dataforseo_client.models.appendixe_keywords_data_day_limits_rates_data_info.AppendixeKeywordsDataDayLimitsRatesDataInfo(
                        task_post = 1.337, 
                        task_get = 1.337, ), 
                    keywords_for_site = dataforseo_client.models.appendixe_keywords_data_day_limits_rates_data_info.AppendixeKeywordsDataDayLimitsRatesDataInfo(
                        task_post = 1.337, 
                        task_get = 1.337, ), 
                    search_volume = , 
                    ...
                    locations = 1.337, 
                    tasks_ready = 1.337, 
                    explore = dataforseo_client.models.appendix_explore_keywords_data_limits_rates_data_info.AppendixExploreKeywordsDataLimitsRatesDataInfo(
                        task_post = 1.337, 
                        task_get = 1.337, 
                        live = 1.337, ), 
                    categories = 1.337, 
                    errors = 1.337, 
                    bing = {
                        'key' : dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                            live = 1.337, )
                        }, 
                ...
                domain_analytics = dataforseo_client.models.appendix_domain_analytics_limits_rates_data_info.AppendixDomainAnalyticsLimitsRatesDataInfo(
                    ...
                    technologies = dataforseo_client.models.appendix_technologies_domain_analytics_limits_rates_data_info.AppendixTechnologiesDomainAnalyticsLimitsRatesDataInfo(
                        domain_technologies = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                            live = 1.337, ), 
                ...
                merchant = dataforseo_client.models.appendix_merchant_limits_rates_data_info.AppendixMerchantLimitsRatesDataInfo(
                    google = dataforseo_client.models.appendix_merchant_google_info.AppendixMerchantGoogleInfo(
                        products = dataforseo_client.models.appendix_product_google_merchant_day_limits_rates_data_info.AppendixProductGoogleMerchantDayLimitsRatesDataInfo(
                            task_post = 1.337, 
                            tasks_ready = 1.337, 
                ...
                business_data = dataforseo_client.models.appendix_business_data_limits_rates_data_info.AppendixBusinessDataLimitsRatesDataInfo(
                    ...
                    business_listings = dataforseo_client.models.appendix_business_listings_business_data_limits_rates_data_info.AppendixBusinessListingsBusinessDataLimitsRatesDataInfo(
                        search = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(), 
                ...
                backlinks = dataforseo_client.models.appendix_backlinks_limits_rates_data_info.AppendixBacklinksLimitsRatesDataInfo(
                    summary = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                        live = 1.337, ), 
                    history = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                        live = 1.337, ), 
                    content_duplicates = , 
                    domain_intersection = , 
                    backlinks = , 
                ...
                app_data = dataforseo_client.models.appendix_app_data_limits_rates_data_info.AppendixAppDataLimitsRatesDataInfo(
                    app_info = dataforseo_client.models.appendix_product_google_merchant_day_limits_rates_data_info.AppendixProductGoogleMerchantDayLimitsRatesDataInfo(
                        task_post = 1.337, 
                        tasks_ready = 1.337, 
                        task_get = dataforseo_client.models.task_get_info.TaskGetInfo(
                            advanced = 1.337, 
                            html = 1.337, ), ), 
                    app_list = dataforseo_client.models.appendix_product_google_merchant_day_limits_rates_data_info.AppendixProductGoogleMerchantDayLimitsRatesDataInfo(
                        task_post = 1.337, 
                        tasks_ready = 1.337, ), 
                    app_reviews = dataforseo_client.models.appendix_app_reviews_app_data_limits_rates_data_info.AppendixAppReviewsAppDataLimitsRatesDataInfo(
                        task_post = 1.337, 
                        tasks_ready = 1.337, ), 
                    app_searches = , 
                    errors = 1.337, 
                ...
                content_generation = dataforseo_client.models.appendix_content_generation_limits_rates_data_info.AppendixContentGenerationLimitsRatesDataInfo(
                    generate = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                        live = 1.337, ), 
                    generate_meta_tags = dataforseo_client.models.appendix_bing_keywords_data_day_limits_rates_data_info.AppendixBingKeywordsDataDayLimitsRatesDataInfo(
                        live = 1.337, ), 
                    generate_text = , 
                    paraphrase = , 
