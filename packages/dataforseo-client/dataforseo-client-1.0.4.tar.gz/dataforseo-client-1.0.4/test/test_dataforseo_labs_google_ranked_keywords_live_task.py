    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRankedKeywordsLiveTask:
        ...
        if include_optional:
            return DataforseoLabsGoogleRankedKeywordsLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_ranked_keywords_live_result_info.DataforseoLabsRankedKeywordsLiveResultInfo(
                        se_type = '', 
                        target = '', 
                        location_code = 56, 
                        language_code = '', 
                        ...
                        items = [
                            dataforseo_client.models.dataforseo_labs_ranked_keywords_live_item.DataforseoLabsRankedKeywordsLiveItem(
                                se_type = '', 
                                ...
                                ranked_serp_element = dataforseo_client.models.ranked_serp_element.RankedSerpElement(
                                    se_type = '', 
                                    serp_item = dataforseo_client.models.base_serp_element_item.BaseSerpElementItem(
                                        se_type = '', ), 
                                    check_url = '', 
                                    se_results_count = '', 
                                    keyword_difficulty = 56, 
