    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo:
        ...
        if include_optional:
            return DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo(
                ...
                tasks_error = 56,
                tasks = [
                    dataforseo_client.models.dataforseo_labs_google_historical_bulk_traffic_estimation_live_task.DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveTask()
                    ]
            )
        else:
            return DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo(
