    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleBulkAppMetricsLiveTask:
        ...
        if include_optional:
            return DataforseoLabsGoogleBulkAppMetricsLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_bulk_app_metrics_live_result.DataforseoLabsGoogleBulkAppMetricsLiveResult(
                        se_type = '', 
                        location_code = 56, 
                        language_code = '', 
                        total_count = 56, 
                        items_count = 56, 
                        items = [
                            dataforseo_client.models.dataforseo_labs_google_bulk_app_metrics_live_item.DataforseoLabsGoogleBulkAppMetricsLiveItem(
                                se_type = '', 
                                app_id = '', 
                                metrics = {
                                ...
                                seed_keyword_data = dataforseo_client.models.keyword_data.KeywordData(
                                    se_type = '', 
                                    keyword = '', 
                                    location_code = 56, 
                                    language_code = '', 
