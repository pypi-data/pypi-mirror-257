...
class TestAppendixUserDataTask(unittest.TestCase):
    """AppendixUserDataTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixUserDataTask:
        """Test AppendixUserDataTask
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixUserDataTask`
        """
        model = AppendixUserDataTask()
        if include_optional:
            return AppendixUserDataTask(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.appendix_user_data_result.AppendixUserDataResult(
                        login = '', 
                        timezone = '', 
    ...
    def testAppendixUserDataTask(self):
        """Test AppendixUserDataTask"""
