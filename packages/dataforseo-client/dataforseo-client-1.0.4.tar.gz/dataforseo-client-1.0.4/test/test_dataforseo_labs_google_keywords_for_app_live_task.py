    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForAppLiveTask:
        ...
        if include_optional:
            return DataforseoLabsGoogleKeywordsForAppLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labsle_keywords_for_app_live_result_info.DataforseoLabsleKeywordsForAppLiveResultInfo(
                        se_type = '', 
                        app_id = '', 
                        location_code = 56, 
                        language_code = '', 
                        ...
                        items = [
                            dataforseo_client.models.dataforseo_labsle_keywords_for_app_live_item.DataforseoLabsleKeywordsForAppLiveItem(
                                ...
                                ranked_serp_element = dataforseo_client.models.app_ranked_serp_element_info.AppRankedSerpElementInfo(
                                    se_type = '', 
                                    serp_item = dataforseo_client.models.app_data_base_serp_element_item.AppDataBaseSerpElementItem(), 
                                    check_url = '', 
                                    se_results_count = '', 
                                    last_updated_time = '', 
                                    previous_updated_time = '', ), )
