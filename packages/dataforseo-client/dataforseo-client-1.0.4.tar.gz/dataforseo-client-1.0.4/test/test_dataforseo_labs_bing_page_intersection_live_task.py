    ...
    def make_instance(self, include_optional) -> DataforseoLabsBingPageIntersectionLiveTask:
        ...
        if include_optional:
            return DataforseoLabsBingPageIntersectionLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_bing_page_intersection_live_result.DataforseoLabsBingPageIntersectionLiveResult(
                        se_type = '', 
                        pages = {
                            'key' : ''
                            }, 
                        exclude_pages = dataforseo_client.models.exclude_pages.exclude_pages(), 
                        location_code = 56, 
                        language_code = '', 
                        total_count = 56, 
                        items_count = 56, 
                        items = [
                            dataforseo_client.models.dataforseo_labs_page_intersection_live_item.DataforseoLabsPageIntersectionLiveItem(
                                se_type = '', 
                                keyword_data = dataforseo_client.models.keyword_data.KeywordData(
                                    ...
                                    search_intent_info = dataforseo_client.models.search_intent_info.SearchIntentInfo(
                                        ...
                                        last_updated_time = '', ), ), 
                                intersection_result = {
                                    'key' : dataforseo_client.models.base_serp_element_item.BaseSerpElementItem(
                                        se_type = '', )
                                    }, )
                            ], )
                    ]
