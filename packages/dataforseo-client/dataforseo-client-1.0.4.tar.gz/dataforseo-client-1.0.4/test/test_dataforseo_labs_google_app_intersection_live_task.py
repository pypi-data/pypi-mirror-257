    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleAppIntersectionLiveTask:
        ...
        if include_optional:
            return DataforseoLabsGoogleAppIntersectionLiveTask(
                ...
                result = [
                    dataforseo_client.models.dataforseo_labsle_app_intersection_live_result_info.DataforseoLabsleAppIntersectionLiveResultInfo(
                        se_type = '', 
                        app_ids = {
                            'key' : ''
                            }, 
                        ...
                        items_count = 56, 
                        items = [
                            dataforseo_client.models.dataforseo_labsle_app_intersection_live_item.DataforseoLabsleAppIntersectionLiveItem(
                                se_type = '', 
                                keyword_data = dataforseo_client.models.keyword_data.KeywordData(
                                    ...
                                    search_intent_info = dataforseo_client.models.search_intent_info.SearchIntentInfo(
                                        ...
                                        last_updated_time = '', ), ), 
                                intersection_result = {
                                    'key' : dataforseo_client.models.app_data_base_serp_element_item.AppDataBaseSerpElementItem()
                                    }, )
                            ], )
                    ]
            )
