...
class BusinessDataYelpReviewsTaskPostRequestInfo(BaseModel):
    """
    BusinessDataYelpReviewsTaskPostRequestInfo
    """ # noqa: E501
    alias: Optional[StrictStr] = Field(default=None, description="unique business identifier required field if you don’t specify keyword if you use this field, you don’t need to specify keyword unique business identifier on Yelp; you can find this identifier in the URL of every business listed on Yelp example: vatos-urban-tacos-singapore https://www.yelp.com/biz/vatos-urban-tacos-singapore?rl=en ")
    ...
    sort_by: Optional[StrictStr] = Field(default=None, description="results sorting parameters optional field you can use this field to sort the results possible types of sorting: newest – sort by newest first highest_rating – sort by highest rating lowest_rating – sort by lowest rating relevant – sort by relevance elites – sort by elite Yelp users first default value: relevant")
    ...
    __properties: ClassVar[List[str]] = ["alias", "keyword", "priority", "location_name", "location_code", "language_name", "language_code", "depth", "sort_by", "tag", "postback_url", "pingback_url", "limit"]
