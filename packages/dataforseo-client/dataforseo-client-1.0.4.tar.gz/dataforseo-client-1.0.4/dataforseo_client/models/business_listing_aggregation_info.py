...
class BusinessListingAggregationInfo(BaseModel):
    ...
    """ # noqa: E501
    top_categories: Optional[Dict[str, Optional[StrictInt]]] = None
    top_countries: Optional[Dict[str, Optional[StrictInt]]] = None
    ...
    top_attributes: Optional[Dict[str, Optional[StrictInt]]] = None
    top_place_topics: Optional[Dict[str, Optional[StrictInt]]] = None
