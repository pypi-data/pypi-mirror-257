...
class SerpGoogleDatasetSearchTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "depth", "language_name", "language_code", "device", "os", "last_updated", "file_formats", "usage_rights", "is_free", "topics", "tag", "postback_url", "postback_data", "pingback_url", "limit"]
