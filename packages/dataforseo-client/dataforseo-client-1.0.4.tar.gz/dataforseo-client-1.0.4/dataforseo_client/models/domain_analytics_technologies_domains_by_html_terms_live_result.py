...
class DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResult(BaseModel):
    """
    DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
