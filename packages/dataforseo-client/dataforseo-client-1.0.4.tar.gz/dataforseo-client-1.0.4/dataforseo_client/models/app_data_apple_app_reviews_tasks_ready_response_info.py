...
class AppDataAppleAppReviewsTasksReadyResponseInfo(BaseModel):
    ...
    tasks: Optional[List[AppDataAppleAppReviewsTasksReadyTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [AppDataAppleAppReviewsTasksReadyTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
