...
class CurrencyBoxSerpElementItem(BaseSerpElementItem):
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "value", "converted_value", "currency", "converted_currency", "timestamp", "table", "graph", "rectangle"]
