...
class DataforseoLabsAppleBulkAppMetricsLiveResult(BaseModel):
    """
    DataforseoLabsAppleBulkAppMetricsLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[DataforseoLabsAppleBulkAppMetricsLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsAppleBulkAppMetricsLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsAppleBulkAppMetricsLiveResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsAppleBulkAppMetricsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
