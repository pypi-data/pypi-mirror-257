...
class KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "search_partners", "date_from", "date_to", "include_adult_keywords", "sort_by", "postback_url", "pingback_url", "tag", "limit", "target"]
