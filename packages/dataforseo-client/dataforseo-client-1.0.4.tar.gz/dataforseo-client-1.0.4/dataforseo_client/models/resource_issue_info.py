...
class ResourceIssueInfo(BaseModel):
    """
    ResourceIssueInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["line", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceIssueInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceIssueInfo from a dict"""
        if obj is None:
            return None
