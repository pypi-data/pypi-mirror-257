...
class ShoppingSpecificationSerpElementItem(BaseSerpElementItem):
    """
    ShoppingSpecificationSerpElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "block_name", "specification_name", "specification_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShoppingSpecificationSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShoppingSpecificationSerpElementItem from a dict"""
        if obj is None:
            return None
