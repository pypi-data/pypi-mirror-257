...
class AppDataTaskRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyword", "location_name", "location_code", "language_name", "language_code", "priority", "depth", "tag", "postback_url", "postback_data", "pingback_url", "limit"]
