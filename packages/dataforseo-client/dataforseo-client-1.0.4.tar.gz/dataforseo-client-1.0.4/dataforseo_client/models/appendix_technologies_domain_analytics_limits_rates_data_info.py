...
class AppendixTechnologiesDomainAnalyticsLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    domain_technologies: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    domains_by_technology: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    aggregation_technologies: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    technologies_summary: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    domains_by_html_terms: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    technology_stats: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domain_technologies": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["domain_technologies"]) if obj.get("domain_technologies") is not None else None,
            "domains_by_technology": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["domains_by_technology"]) if obj.get("domains_by_technology") is not None else None,
            "languages": obj.get("languages"),
            "locations": obj.get("locations"),
            "technologies": obj.get("technologies"),
            "aggregation_technologies": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["aggregation_technologies"]) if obj.get("aggregation_technologies") is not None else None,
            "technologies_summary": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["technologies_summary"]) if obj.get("technologies_summary") is not None else None,
            "domains_by_html_terms": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["domains_by_html_terms"]) if obj.get("domains_by_html_terms") is not None else None,
            "technology_stats": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["technology_stats"]) if obj.get("technology_stats") is not None else None
        })
        return _obj
