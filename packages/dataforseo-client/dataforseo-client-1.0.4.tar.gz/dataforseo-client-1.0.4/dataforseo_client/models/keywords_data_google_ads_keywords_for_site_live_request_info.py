...
class KeywordsDataGoogleAdsKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "target_type", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "search_partners", "date_from", "date_to", "include_adult_keywords", "sort_by", "tag", "limit"]
