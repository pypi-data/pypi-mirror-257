...
class AppDataAppleAppListTaskGetAdvancedResponseInfo(BaseModel):
    ...
    tasks: Optional[List[AppDataAppleAppListTaskGetAdvancedTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [AppDataAppleAppListTaskGetAdvancedTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
