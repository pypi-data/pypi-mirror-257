...
class BusinessDataGoogleReviewsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "tag", "postback_url", "pingback_url", "limit", "cid", "place_id", "depth", "sort_by"]
