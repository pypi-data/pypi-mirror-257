...
class AppendixContentAnalysisLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    search: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    summary: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    sentiment_analysis: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    rating_distribution: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    phrase_trends: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    category_trends: Optional[AppendixBingKeywordsDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "search": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["search"]) if obj.get("search") is not None else None,
            "summary": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "sentiment_analysis": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["sentiment_analysis"]) if obj.get("sentiment_analysis") is not None else None,
            "rating_distribution": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["rating_distribution"]) if obj.get("rating_distribution") is not None else None,
            "phrase_trends": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["phrase_trends"]) if obj.get("phrase_trends") is not None else None,
            "category_trends": AppendixBingKeywordsDataDayLimitsRatesDataInfo.from_dict(obj["category_trends"]) if obj.get("category_trends") is not None else None,
