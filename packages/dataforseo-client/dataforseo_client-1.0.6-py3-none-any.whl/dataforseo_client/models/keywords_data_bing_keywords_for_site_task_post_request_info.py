...
class KeywordsDataBingKeywordsForSiteTaskPostRequestInfo(BaseModel):
    ...
    date_from: Optional[StrictStr] = Field(default=None, description="starting date of the time range optional field if you don’t specify this field, data will be provided for the last 12 months date format: \"yyyy-mm-dd\" example: \"2020-01-01\"")
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "keywords_negative", "device", "sort_by", "date_from", "date_to", "postback_url", "pingback_url", "search_partners", "tag", "limit"]
