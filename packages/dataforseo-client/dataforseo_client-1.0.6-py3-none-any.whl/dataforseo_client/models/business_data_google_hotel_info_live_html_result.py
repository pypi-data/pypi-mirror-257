...
class BusinessDataGoogleHotelInfoLiveHtmlResult(BaseModel):
    """
    BusinessDataGoogleHotelInfoLiveHtmlResult
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="unique hotel identifier specified as \"hotel_id:$\"")
    type: Optional[StrictStr] = Field(default=None, description="type of search results in this case, \"hotel_info\"")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoLiveHtmlResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoLiveHtmlResult from a dict"""
        if obj is None:
            return None
