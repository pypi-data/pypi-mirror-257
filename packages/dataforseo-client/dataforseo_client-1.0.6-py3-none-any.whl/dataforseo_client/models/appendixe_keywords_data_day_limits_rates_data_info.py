...
class AppendixeKeywordsDataDayLimitsRatesDataInfo(BaseModel):
    """
    AppendixeKeywordsDataDayLimitsRatesDataInfo
    """ # noqa: E501
    task_post: Optional[Union[StrictFloat, StrictInt]] = None
    task_get: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["task_post", "task_get"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppendixeKeywordsDataDayLimitsRatesDataInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppendixeKeywordsDataDayLimitsRatesDataInfo from a dict"""
        if obj is None:
            return None
