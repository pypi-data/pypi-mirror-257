...
class MerchantGoogleProductInfoTaskGetAdvancedResult(BaseModel):
    """
    MerchantGoogleProductInfoTaskGetAdvancedResult
    """ # noqa: E501
    ...
    type: Optional[StrictStr] = Field(default=None, description="search engine type in a POST array possible types: shopping_specifications")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MerchantGoogleProductInfoTaskGetAdvancedResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MerchantGoogleProductInfoTaskGetAdvancedResult from a dict"""
        if obj is None:
            return None
