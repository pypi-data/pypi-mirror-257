...
class BacklinksBulkReferringDomainsLiveItem(BaseModel):
    ...
    referring_domains: Optional[StrictInt] = Field(default=None, description="number of referring domains pointing to the target ")
    ...
    referring_main_domains: Optional[StrictInt] = Field(default=None, description="number of referring main domains pointing to the target ")
