...
class ContentAnalysisLocationsResult(BaseModel):
    """
    ContentAnalysisLocationsResult
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentAnalysisLocationsResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentAnalysisLocationsResult from a dict"""
        if obj is None:
            return None
