...
class KeywordsDataGoogleTrendsExploreLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "language_name", "language_code", "type", "category_code", "date_from", "date_to", "time_range", "item_types", "tag", "limit"]
