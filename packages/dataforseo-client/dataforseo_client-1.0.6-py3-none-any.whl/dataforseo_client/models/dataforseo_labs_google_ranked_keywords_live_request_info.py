...
class DataforseoLabsGoogleRankedKeywordsLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "ignore_synonyms", "item_types", "limit", "offset", "load_rank_absolute", "historical_serp_mode", "filters", "order_by", "tag"]
