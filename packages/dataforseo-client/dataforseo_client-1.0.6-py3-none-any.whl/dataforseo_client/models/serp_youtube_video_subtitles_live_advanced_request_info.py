...
class SerpYoutubeVideoSubtitlesLiveAdvancedRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["video_id", "subtitles_language", "subtitles_translate_language", "location_name", "location_code", "language_name", "language_code", "device", "os", "tag", "limit"]
