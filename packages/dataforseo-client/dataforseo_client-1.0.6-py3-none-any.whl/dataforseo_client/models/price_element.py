...
class PriceElement(BaseModel):
    ...
    featured_title: Optional[StrictStr] = None
    snippet: Optional[StrictStr] = None
    table: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "title", "url", "domain", "featured_title", "snippet", "table"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriceElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriceElement from a dict"""
        if obj is None:
            return None
