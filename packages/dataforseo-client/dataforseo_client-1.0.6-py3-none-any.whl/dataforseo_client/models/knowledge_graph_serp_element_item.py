...
class KnowledgeGraphSerpElementItem(BaseSerpElementItem):
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "subtitle", "description", "card_id", "url", "image_url", "logo_url", "cid", "items", "rectangle", "sub_title"]
