...
class BusinessDataYelpReviewsTasksReadyResult(BaseModel):
    """
    BusinessDataYelpReviewsTasksReadyResult
    """ # noqa: E501
    ...
    se: Optional[StrictStr] = Field(default=None, description="search engine specified when setting the task can take the following values: yelp")
    se_type: Optional[StrictStr] = Field(default=None, description="type of search engine can take the following values: reviews")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataYelpReviewsTasksReadyResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataYelpReviewsTasksReadyResult from a dict"""
        if obj is None:
            return None
