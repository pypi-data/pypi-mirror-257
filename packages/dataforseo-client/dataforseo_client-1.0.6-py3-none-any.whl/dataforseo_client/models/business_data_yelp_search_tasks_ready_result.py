...
class BusinessDataYelpSearchTasksReadyResult(BaseModel):
    """
    BusinessDataYelpSearchTasksReadyResult
    """ # noqa: E501
    ...
    se_type: Optional[StrictStr] = Field(default=None, description="type of search engine can take the following values: search")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataYelpSearchTasksReadyResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataYelpSearchTasksReadyResult from a dict"""
        if obj is None:
            return None
