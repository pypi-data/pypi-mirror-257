...
class BusinessDataGoogleHotelInfoTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "tag", "postback_url", "pingback_url", "limit", "hotel_identifier", "check_in", "check_out", "currency", "adults", "children", "postback_data"]
