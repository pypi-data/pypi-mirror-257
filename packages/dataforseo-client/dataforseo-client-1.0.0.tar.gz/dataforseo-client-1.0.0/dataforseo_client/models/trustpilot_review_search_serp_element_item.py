...
class TrustpilotReviewSearchSerpElementItem(BaseSerpElementItem):
    """
    TrustpilotReviewSearchSerpElementItem
    """ # noqa: E501
    ...
    review_images: Optional[List[StrictStr]] = None
    user_profile: Optional[BusinessDataUserProfileInfo] = None
    responses: Optional[List[Responses]] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "url", "rating", "verified", "language", "timestamp", "title", "review_text", "review_images", "user_profile", "responses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrustpilotReviewSearchSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrustpilotReviewSearchSerpElementItem from a dict"""
        if obj is None:
            return None
