...
class BacklinksIndexResult(BaseModel):
    """
    BacklinksIndexResult
    """ # noqa: E501
    ...
    index_history: Optional[List[IndexHistory]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksIndexResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksIndexResult from a dict"""
        if obj is None:
            return None
