...
class AppendixBusinessDataGoogleInfo(BaseModel):
    ...
    my_business_updates: Optional[AppendixsGoogleBusinessDataDayLimitsRatesDataInfo] = None
    hotel_info: Optional[AppendixHotelInfoGoogleBusinessDataLimitsRatesDataInfo] = None
    hotel_searches: Optional[AppendixInfo] = None
    reviews: Optional[AppendixsGoogleBusinessDataDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "my_business_updates": AppendixsGoogleBusinessDataDayLimitsRatesDataInfo.from_dict(obj["my_business_updates"]) if obj.get("my_business_updates") is not None else None,
            "hotel_info": AppendixHotelInfoGoogleBusinessDataLimitsRatesDataInfo.from_dict(obj["hotel_info"]) if obj.get("hotel_info") is not None else None,
            "hotel_searches": AppendixInfo.from_dict(obj["hotel_searches"]) if obj.get("hotel_searches") is not None else None,
            "reviews": AppendixsGoogleBusinessDataDayLimitsRatesDataInfo.from_dict(obj["reviews"]) if obj.get("reviews") is not None else None
        })
        return _obj
