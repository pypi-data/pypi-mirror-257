...
class DataforseoLabsGoogleAppCompetitorsLiveResult(BaseModel):
    """
    DataforseoLabsGoogleAppCompetitorsLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[DataforseoLabsGoogleAppCompetitorsLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleAppCompetitorsLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleAppCompetitorsLiveResult from a dict"""
        if obj is None:
            return None
