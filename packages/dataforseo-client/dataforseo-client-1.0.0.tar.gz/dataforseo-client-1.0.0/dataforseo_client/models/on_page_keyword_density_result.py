...
class OnPageKeywordDensityResult(BaseModel):
    """
    ...
    items: Optional[List[OnPageKeywordDensityItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnPageKeywordDensityResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnPageKeywordDensityResult from a dict"""
        if obj is None:
            return None
