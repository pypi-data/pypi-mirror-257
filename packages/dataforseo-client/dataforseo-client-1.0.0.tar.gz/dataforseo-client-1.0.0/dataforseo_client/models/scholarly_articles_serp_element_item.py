...
class ScholarlyArticlesSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[ScholarlyArticlesElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "url", "items", "rectangle"]
