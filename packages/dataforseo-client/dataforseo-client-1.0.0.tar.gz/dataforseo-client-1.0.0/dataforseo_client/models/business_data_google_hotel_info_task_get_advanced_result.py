...
class BusinessDataGoogleHotelInfoTaskGetAdvancedResult(BaseModel):
    """
    BusinessDataGoogleHotelInfoTaskGetAdvancedResult
    """ # noqa: E501
    ...
    overview_images: Optional[List[Optional[StrictStr]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoTaskGetAdvancedResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleHotelInfoTaskGetAdvancedResult from a dict"""
        if obj is None:
            return None
