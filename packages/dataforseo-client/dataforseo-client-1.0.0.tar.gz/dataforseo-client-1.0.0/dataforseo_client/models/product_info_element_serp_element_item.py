...
class ProductInfoElementSerpElementItem(BaseSerpElementItem):
    """
    ProductInfoElementSerpElementItem
    """ # noqa: E501
    ...
    features: Optional[List[Optional[StrictStr]]] = None
    ...
    sellers: Optional[List[ProductSeller]] = None
    variations: Optional[List[ProductVariation]] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "product_id", "title", "description", "url", "images", "features", "rating", "seller_reviews_count", "sellers", "variations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductInfoElementSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductInfoElementSerpElementItem from a dict"""
        if obj is None:
            return None
