...
class DataAmazonAmazonSerpSerpElementItem(AmazonBaseSerpElementItem):
    """
    ...
    special_offers: Optional[List[Optional[StrictStr]]] = None
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "domain", "title", "url", "description", "asin", "image_url", "price_from", "price_to", "currency", "special_offers", "is_best_seller", "is_amazon_choice", "rating", "delivery_info", "bought_past_month", "data_asin"]
