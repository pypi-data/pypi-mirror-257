...
class SerpAiSummaryRequestInfo(BaseModel):
    ...
    prompt: Optional[StrictStr] = Field(default=None, description="AI prompt optional field additional task for AI summarizer, also referred to as any form of text, question or information that communicates to AI what response you’re looking for; note: your prompt has to be relevant to the keyword specified in the POST request to SERP API ")
    ...
    __properties: ClassVar[List[str]] = ["task_id", "prompt", "support_extra", "fetch_content", "include_links", "limit"]
