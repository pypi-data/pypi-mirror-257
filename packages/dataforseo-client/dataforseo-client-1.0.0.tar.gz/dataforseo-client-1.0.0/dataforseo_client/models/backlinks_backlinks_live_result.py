...
class BacklinksBacklinksLiveResult(BaseModel):
    """
    BacklinksBacklinksLiveResult
    """ # noqa: E501
    ...
    custom_mode: Optional[Dict[str, Optional[Dict[str, Any]]]] = None
    ...
    items: Optional[List[BacklinksBacklinksLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksBacklinksLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksBacklinksLiveResult from a dict"""
        if obj is None:
            return None
