...
class ContentGenerationGenerateLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["text", "max_new_tokens", "max_tokens", "creativity_index", "token_repetition_penalty", "top_k", "top_p", "temperature", "avoid_words", "avoid_starting_words", "stop_words", "supplement_token", "tag", "limit"]
