...
class KnowledgeGraphExpandedItemSerpElementItem(BaseSerpElementItem):
    ...
    expanded_element: Optional[List[KnowledgeGraphExpandedElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "data_attrid", "expanded_element", "rectangle"]
