...
class KeywordsDataBingKeywordsForKeywordsTasksReadyResult(BaseModel):
    """
    KeywordsDataBingKeywordsForKeywordsTasksReadyResult
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "se", "function", "date_posted", "tag", "endpoint", "device"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordsDataBingKeywordsForKeywordsTasksReadyResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordsDataBingKeywordsForKeywordsTasksReadyResult from a dict"""
        if obj is None:
            return None
