...
class ContentAnalysisPhraseTrendsLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "keyword_fields", "page_type", "search_mode", "internal_list_limit", "date_from", "date_to", "date_group", "initial_dataset_filter", "tag", "limit"]
