...
class KeywordsDataGoogleTrendsExploreTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    keywords: Optional[List[StrictStr]] = Field(default=None, description="keywords required field The maximum number of keywords you can specify: 5 Note: comma symbols (,) in the specified keywords will be unset and ignored")
    ...
    type: Optional[StrictStr] = Field(default=None, description="google trends type optional field if you don’t specify this field, the web type will be used by default possible values: web, news, youtube, images, froogle")
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "language_name", "language_code", "type", "category_code", "date_from", "date_to", "time_range", "item_types", "postback_url", "pingback_url", "tag", "limit"]
