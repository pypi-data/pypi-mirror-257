...
class DataforseoLabsAmazonBulkSearchVolumeLiveResult(BaseModel):
    """
    DataforseoLabsAmazonBulkSearchVolumeLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[DataforseoLabsAmazonBulkSearchVolumeLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsAmazonBulkSearchVolumeLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsAmazonBulkSearchVolumeLiveResult from a dict"""
        if obj is None:
            return None
