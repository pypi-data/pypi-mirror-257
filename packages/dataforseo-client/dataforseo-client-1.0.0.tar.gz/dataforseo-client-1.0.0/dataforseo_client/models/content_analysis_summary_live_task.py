...
class ContentAnalysisSummaryLiveTask(BaseModel):
    """
    ContentAnalysisSummaryLiveTask
    """ # noqa: E501
    ...
    result: Optional[List[ContentAnalysisSummaryInfo]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentAnalysisSummaryLiveTask from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentAnalysisSummaryLiveTask from a dict"""
        if obj is None:
            return None
