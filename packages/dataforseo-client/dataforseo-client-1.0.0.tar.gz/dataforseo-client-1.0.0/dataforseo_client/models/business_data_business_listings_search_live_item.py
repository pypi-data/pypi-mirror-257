...
class BusinessDataBusinessListingsSearchLiveItem(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element = ‘business_listing’")
    ...
    category_ids: Optional[List[Optional[StrictStr]]] = None
    additional_categories: Optional[List[Optional[StrictStr]]] = None
    ...
    place_topics: Optional[Dict[str, Optional[StrictInt]]] = None
    ...
    contact_info: Optional[List[BusinessDataContactInfo]] = None
