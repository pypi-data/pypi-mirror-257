...
class DataforseoLabsGooglePageIntersectionLiveResult(BaseModel):
    """
    DataforseoLabsGooglePageIntersectionLiveResult
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    pages: Optional[Dict[str, Optional[StrictStr]]] = None
    exclude_pages: Optional[List[Optional[StrictStr]]] = None
    ...
    items: Optional[List[DataforseoLabsPageIntersectionLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsGooglePageIntersectionLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsGooglePageIntersectionLiveResult from a dict"""
        if obj is None:
            return None
