...
class BacklinksBacklinksLiveItem(BaseModel):
    ...
    domain_from_platform_type: Optional[List[Optional[StrictStr]]] = None
    ...
    attributes: Optional[List[Optional[StrictStr]]] = None
    ...
    indirect_link_path: Optional[List[Redirect]] = None
