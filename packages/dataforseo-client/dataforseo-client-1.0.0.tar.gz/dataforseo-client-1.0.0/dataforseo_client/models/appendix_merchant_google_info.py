...
class AppendixMerchantGoogleInfo(BaseModel):
    ...
    """ # noqa: E501
    products: Optional[AppendixProductGoogleMerchantDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": AppendixProductGoogleMerchantDayLimitsRatesDataInfo.from_dict(obj["products"]) if obj.get("products") is not None else None,
