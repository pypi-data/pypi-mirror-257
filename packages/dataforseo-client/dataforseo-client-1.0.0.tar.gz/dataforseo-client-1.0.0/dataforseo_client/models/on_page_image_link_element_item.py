...
class OnPageImageLinkElementItem(BaseOnPageLinkItemInfo):
    ...
    link_attribute: Optional[List[StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "domain_from", "domain_to", "page_from", "page_to", "link_from", "link_to", "link_attribute", "dofollow", "page_from_scheme", "page_to_scheme", "direction", "is_broken", "text", "image_alt", "image_src", "is_link_relation_conflict", "page_to_status_code", "resource_errors"]
