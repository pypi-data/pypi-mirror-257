...
class BacklinksReferringNetworksLiveResult(BaseModel):
    """
    BacklinksReferringNetworksLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[BacklinksReferringNetworksLiveItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksReferringNetworksLiveResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksReferringNetworksLiveResult from a dict"""
        if obj is None:
            return None
