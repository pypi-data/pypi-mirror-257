...
class OnPageContentParsingLiveResult(BaseModel):
    """
    OnPageContentParsingLiveResult
    """ # noqa: E501
    ...
    items: Optional[List[OnPageContentParsingItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnPageContentParsingLiveResult from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if crawl_status (nullable) is None
        # and model_fields_set contains the field
        if self.crawl_status is None and "crawl_status" in self.model_fields_set:
            _dict['crawl_status'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnPageContentParsingLiveResult from a dict"""
        if obj is None:
            return None
