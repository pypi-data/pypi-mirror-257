...
class YelpReviewsSearchSerpElementItem(BaseSerpElementItem):
    """
    YelpReviewsSearchSerpElementItem
    """ # noqa: E501
    ...
    review_images: Optional[List[Optional[StrictStr]]] = None
    user_profile: Optional[BusinessDataUserProfileInfo] = None
    responses: Optional[List[YelpReviewResponseInfo]] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "review_id", "rating", "timestamp", "review_text", "review_images", "user_profile", "responses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YelpReviewsSearchSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YelpReviewsSearchSerpElementItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "responses": [YelpReviewResponseInfo.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
