...
class EventItemSerpElementItem(BaseSerpElementItem):
    ...
    information_and_tickets: Optional[List[InformationAndTicketsElement]] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "title", "description", "url", "image_url", "event_dates", "location_info", "information_and_tickets"]
