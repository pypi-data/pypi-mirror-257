...
class OnPageHtmlResourceElementItem(BaseOnPageResourceItemInfo):
    ...
    """ # noqa: E501
    status_code: Optional[StrictInt] = Field(default=None, description="general status code you can find the full list of the response codes here Note: we strongly recommend designing a necessary system for handling related exceptional or error conditions")
    ...
    custom_js_response: Optional[Dict[str, Any]] = None
    ...
    checks: Optional[Dict[str, Optional[StrictBool]]] = None
