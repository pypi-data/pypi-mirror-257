...
class PageMetaInfo(BaseModel):
    ...
    htags: Optional[Dict[str, Optional[List[StrictStr]]]] = None
    ...
    deprecated_tags: Optional[List[StrictStr]] = None
    duplicate_meta_tags: Optional[List[Optional[StrictStr]]] = None
    spell: Optional[SpellInfo] = None
    social_media_tags: Optional[Dict[str, Optional[StrictStr]]] = None
