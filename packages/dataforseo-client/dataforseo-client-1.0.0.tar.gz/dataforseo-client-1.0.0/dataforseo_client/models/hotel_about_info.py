...
class HotelAboutInfo(BaseModel):
    ...
    sub_descriptions: Optional[List[Optional[StrictStr]]] = None
    ...
    amenities: Optional[List[HotelAmenityInfo]] = None
    popular_amenities: Optional[List[HotelAmenityItemInfo]] = None
