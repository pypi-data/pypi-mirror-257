...
class DataAmazonAmazonReviewItemSerpElementItem(AmazonBaseSerpElementItem):
    """
    ...
    videos: Optional[List[VideoElement]] = None
    ...
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "verified", "subtitle", "helpful_votes", "images", "videos", "user_profile", "title", "url", "review_text", "publication_date", "rating"]
