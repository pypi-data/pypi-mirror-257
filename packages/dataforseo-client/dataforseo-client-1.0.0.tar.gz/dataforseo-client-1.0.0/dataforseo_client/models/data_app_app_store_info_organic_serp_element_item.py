...
class DataAppAppStoreInfoOrganicSerpElementItem(AppDataBaseSerpElementItem):
    """
    ...
    advisories: Optional[List[Optional[StrictStr]]] = None
    ...
    similar_apps: Optional[List[AppsInfo]] = None
    more_apps_by_developer: Optional[List[AppsInfo]] = None
