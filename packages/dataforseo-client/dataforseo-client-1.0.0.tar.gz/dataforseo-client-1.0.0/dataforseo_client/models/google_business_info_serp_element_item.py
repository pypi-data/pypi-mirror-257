...
class GoogleBusinessInfoSerpElementItem(BaseSerpElementItem):
    """
    GoogleBusinessInfoSerpElementItem
    """ # noqa: E501
    ...
    additional_categories: Optional[List[StrictStr]] = None
    ...
    place_topics: Optional[Dict[str, Optional[StrictStr]]] = None
    ...
    rating_distribution: Optional[Dict[str, Optional[StrictInt]]] = None
    people_also_search: Optional[List[PeopleAlsoSearch]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleBusinessInfoSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleBusinessInfoSerpElementItem from a dict"""
        if obj is None:
            return None
