...
class OnPageMicrodataResult(BaseModel):
    """
    OnPageMicrodataResult
    """ # noqa: E501
    ...
    items: Optional[List[OnPageMicrodataItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnPageMicrodataResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnPageMicrodataResult from a dict"""
        if obj is None:
            return None
