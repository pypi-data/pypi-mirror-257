...
class KnowledgeGraphImagesItemSerpElementItem(BaseSerpElementItem):
    ...
    items: Optional[List[KnowledgeGraphImagesElement]] = None
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "link", "items", "rectangle"]
