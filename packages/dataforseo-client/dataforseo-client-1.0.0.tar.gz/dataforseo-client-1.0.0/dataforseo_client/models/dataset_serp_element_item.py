...
class DatasetSerpElementItem(BaseSerpElementItem):
    ...
    dataset_providers: Optional[List[LicensesElement]] = None
    formats: Optional[List[FormatsElement]] = None
    authors: Optional[List[AuthorsElement]] = None
    licenses: Optional[List[LicensesElement]] = None
    ...
    area_covered: Optional[List[Optional[StrictStr]]] = None
    period_covered: Optional[PeriodCovered] = None
    dataset_description: Optional[DatasetDescription] = None
    __properties: ClassVar[List[str]] = ["se_type", "type", "rank_group", "rank_absolute", "position", "xpath", "dataset_id", "title", "image_url", "scholarly_citations_count", "scholarly_articles_url", "unique_identifier", "related_article", "links", "dataset_providers", "formats", "authors", "licenses", "updated_date", "area_covered", "period_covered", "dataset_description"]
