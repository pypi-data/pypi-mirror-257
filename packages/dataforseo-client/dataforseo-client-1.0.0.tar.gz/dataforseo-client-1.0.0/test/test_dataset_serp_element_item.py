    ...
    def make_instance(self, include_optional) -> DatasetSerpElementItem:
        ...
        if include_optional:
            return DatasetSerpElementItem(
                ...
                dataset_providers = [
                    openapi_client.models.licenses_element.LicensesElement(
                        type = '', 
                        title = '', 
                        url = '', 
                        domain = '', )
                ...
                formats = [
                    openapi_client.models.formats_element.FormatsElement(
                        type = '', 
                        format = '', 
                        size = '', )
                    ],
                authors = [
                    openapi_client.models.authors_element.AuthorsElement(
                        type = '', 
                        name = '', 
                        url = '', 
                        domain = '', )
                ...
                period_covered = openapi_client.models.period_covered.PeriodCovered(
                    start_date = '', 
                    end_date = '', 
                    displayed_date = '', ),
                dataset_description = openapi_client.models.dataset_description.DatasetDescription(
                    text = '', 
                    links = [
                        openapi_client.models.link_element.LinkElement(
                            type = '', 
