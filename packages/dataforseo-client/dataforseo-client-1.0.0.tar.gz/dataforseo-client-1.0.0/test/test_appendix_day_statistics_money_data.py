    ...
    def make_instance(self, include_optional) -> AppendixDayStatisticsMoneyData:
        ...
        if include_optional:
            return AppendixDayStatisticsMoneyData(
                ...
                merchant = openapi_client.models.appendix_merchant_day_statistics_money_data.AppendixMerchantDayStatisticsMoneyData(
                    google = openapi_client.models.appendix_google_merchant_day_statistics_money_data.AppendixGoogleMerchantDayStatisticsMoneyData(
                        products = openapi_client.models.appendix_task_based_money_info.AppendixTaskBasedMoneyInfo(
                            task_post = 1.337, 
                            tasks_ready = 1.337, 
                        ...
                        product_spec = openapi_client.models.appendix_product_google_merchant_day_limits_rates_data_info.AppendixProductGoogleMerchantDayLimitsRatesDataInfo(
                            task_post = 1.337, 
                            tasks_ready = 1.337, ), 
                        product_info = openapi_client.models.appendix_product_google_merchant_day_limits_rates_data_info.AppendixProductGoogleMerchantDayLimitsRatesDataInfo(
                            task_post = 1.337, 
                            tasks_ready = 1.337, ), ), 
                    amazon = {
                        'key' : 
