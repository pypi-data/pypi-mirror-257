    ...
    def make_instance(self, include_optional) -> DataAmazonAmazonProductInfoSerpElementItem:
        ...
        if include_optional:
            return DataAmazonAmazonProductInfoSerpElementItem(
                ...
                newer_model = openapi_client.models.amazon_product_newer_model_info.AmazonProductNewerModelInfo(
                    title = '', 
                    newer_model_asin = '', ),
                categories = [
                    openapi_client.models.product_category_info.ProductCategoryInfo(
                        category = '', 
                        url = '', )
                    ],
                product_information = [
                    openapi_client.models.base_product_information_item.BaseProductInformationItem()
                    ],
                product_images_list = [
                    ''
                    ],
