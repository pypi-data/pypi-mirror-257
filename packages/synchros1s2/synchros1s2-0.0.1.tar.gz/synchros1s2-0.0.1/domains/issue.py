...
class Issue:
    ...
    def synchronisation_summary(self):
        if self.miror:
    ...
    def synchronisation_description(self):
        if self.miror:
    ...
    def synchronisation_summary_from_miror(self):
        self.summary = self.miror.summary
        # Il faut juste qu'il update summary et non pas description aussi et tout !
        self.update()

    def synchronisation_summary_to_miror(self):
        self.miror.summary = self.summary
        self.update()

    def synchronisation_description_from_miror(self):
        self.description = self.miror.description
        self.update()

    def synchronisation_description_to_miror(self):
