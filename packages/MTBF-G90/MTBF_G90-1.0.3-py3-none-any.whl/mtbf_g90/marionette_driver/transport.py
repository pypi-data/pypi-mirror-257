...
class TcpTransport(object):
    ...
    def connect(self):
        ...
        print("applicarion", application_type)
        ...
        print("nw", self.protocol, self.application_type)
...
def wait_for_port(host, port, timeout=60):
    ...
    while datetime.datetime.now() - starttime < datetime.timedelta(seconds=timeout):
        ...
        try:
            ...
            data = sock.recv(16).decode('ISO-8859-1')
            sock.close()
            if ":" in data:
                return True
        except socket.error:
