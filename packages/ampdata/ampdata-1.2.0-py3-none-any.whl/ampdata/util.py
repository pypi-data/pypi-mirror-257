...
class TS(object):
    ...
    def __init__(
        ...
        self.points = points
        #
        # input_dict is the json dict from AmpData
    ...
    def to_pandas(self, name=None):
        """Converting :class:`ampdata.util.TS` object to a pandas.Series object
    ...
    def from_pandas(pd_series):
        # Clean up some of the more common Pandas/AmpData problems
    ...
    def sum(ts_list, name):
        """calculate the sum of a given list of :class:`ampdata.util.TS` objects

        Returns a :class:`~ampdata.util.TS` (:class:`ampdata.util.TS`) object that is
    ...
    def mean(ts_list, name):
        ...
        Returns a TS (:class:`ampdata.util.TS`) object that is
