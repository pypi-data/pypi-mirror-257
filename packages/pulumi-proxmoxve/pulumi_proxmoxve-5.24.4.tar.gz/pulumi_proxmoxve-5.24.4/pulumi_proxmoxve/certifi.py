...
class Certifi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        proxmox_virtual_environment_certificatetls_private_key = tls.index.Tls_private_key("proxmoxVirtualEnvironmentCertificatetls_private_key",
            algorithm=RSA,
            rsa_bits=2048)
        proxmox_virtual_environment_certificatetls_self_signed_cert = tls.index.Tls_self_signed_cert("proxmoxVirtualEnvironmentCertificatetls_self_signed_cert",
            key_algorithm=proxmox_virtual_environment_certificatetls_private_key.algorithm,
            private_key_pem=proxmox_virtual_environment_certificatetls_private_key.private_key_pem,
            subject=[{
        ...
        example = proxmoxve.Certifi("example",
            certificate=proxmox_virtual_environment_certificatetls_self_signed_cert["certPem"],
            node_name="first-node",
            private_key=proxmox_virtual_environment_certificatetls_private_key["privateKeyPem"])
        ```
