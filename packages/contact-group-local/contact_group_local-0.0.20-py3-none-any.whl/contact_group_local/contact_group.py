...
class ContactGroup(GenericMapping):
    ...
    def insert_contact_and_link_to_existing_or_new_group(self, contact_dict: dict, contact_id: int,
                                                         groups: list, mapping_data_json: dict = None,
    ...
    def create_and_link_new_group(self, entity_name: str, contact_id: str, title_lang_code: str, is_interest: bool,
                                  mapping_data_json: dict = None) -> list[tuple]:
    ...
    def add_update_group_and_link_to_contact(self, entity_name: str, contact_id: str,
                                             mapping_data_json: dict = None, title: str = None,
    ...
    # With GroupsLocal
    def insert_link_contact_group_with_groups_local(
            self, contact_dict: dict, contact_id: int,
            groups: list, title_lang_code: str = None, parent_group_id: str = None,
            is_interest: bool = None, image: str = None,
            mapping_data_json: dict = None) -> list[tuple]:
        ...
        for group in groups:
            ...
            if not group_id:
                group_dict = self.__create_group_dict(
                    group_title=group, title_lang_code=title_lang_code,
                    parent_group_id=parent_group_id, is_interest=is_interest, image=image)
                group_id, group_ml_id = self.groups_local.insert(group_dict=group_dict)     # TODO: change to upsert
                mapping_id = self.insert_mapping(entity_name1=self.default_entity_name1,
                                                 entity_name2=self.default_entity_name2,
                                                 entity_id1=contact_id, entity_id2=group_id,
                                                 data_json=mapping_data_json)
            ...
            all_groups_linked.append((group_id, group, mapping_id))

        logger.end(object={"all_groups_linked": all_groups_linked})
        return all_groups_linked

    def __get_group_id_by_title(self, group_title: str) -> int:
        group_dict = self.groups_local.select_one_dict_by_id(
    ...
    def __create_group_dict(self, group_title: str, title_lang_code: str = None, parent_group_id: str = None,
