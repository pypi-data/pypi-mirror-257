...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package skygrid-docker-worker-service. Maybe you are using the wrong pypi?")


setup(
    name='skygrid-docker-worker-service',
    version='66.0.3',
    author='Yandex',
