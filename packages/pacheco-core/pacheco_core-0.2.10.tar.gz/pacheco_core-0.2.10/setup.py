...
config = {
    ...
    "py_modules": ["retico_core/core/abstract",
                   ...
                   "retico_core/huggingface/asr_cat",
                   "retico_core/huggingface/asr_deepspeech",
                   "retico_core/huggingface/asr",
                   "retico_core/psi/common",
                   "retico_core/psi/configFileReader",
                   "retico_core/psi/psiAsrReceiver",
                   "retico_core/rasa/nlu",
                   "retico_core/sds_class/iu",
                   "retico_core/sds_class/TaggerModule",
                   "retico_core/slim/common",
                   "retico_core/slim/wac",
                   "retico_core/slim/words_as_classifiers"],
    "name": "pacheco_core",
    "classifiers": [
        "Development Status :: 2 - Pre-Alpha",
        "Programming Language :: Python :: 3",
