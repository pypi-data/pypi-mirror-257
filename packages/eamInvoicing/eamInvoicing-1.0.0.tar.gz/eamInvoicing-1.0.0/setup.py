...
setup(
    name='eamInvoicing',  # * Your package will have this name
    packages=['eamInvoicing'],  # * Name the package again
    ...
    author='Emmanuel Addai Marful',  # Your name
    author_email='emarful07@gamil.com',  # Your email
    url='https://github.com/emmaMarful',  # Homepage of your library (e.g. github or your website)
