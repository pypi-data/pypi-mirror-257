...
from fastapi_identity.stores import IRoleStore
from fastapi_identity.types import TRole, DependencyCallable
...
class RoleManager(Generic[TRole]):
    ...
    def __init__(
        ...
        from fastapi_identity import RoleValidator, UpperLookupNormalizer
