...
CALL = -1
class EITHER:
    def __init__(self, p_choice_ownership, p_choice_date):
        self.choice_date = p_choice_date
        self.choice_ownership = p_choice_ownership
    def __call__(self, p_choices):
        return CEither(self.choice_ownership, self.choice_date, p_choices)
