...
class AgentExecution(object):
    ...
    def __init__(self, config_data, labid, test_stage=None, cov_report=None, per_test=True,
                 interval=constants.INTERVAL_IN_MILLISECONDS, init_agent=True, test_group_id=""):
        ...
        self.config_data.workspacepath = self.config_data.additionalParams.get("workspacepath",
                                                                               constants.DEFAULT_WORKSPACEPATH)
