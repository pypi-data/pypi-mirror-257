    ...
    *,
    ...
    def {safe_c_name}(self, resolver: T.Optional["{safe_rez_name}"] = None, key: str = "{safe_c_name}") -> "{safe_table_name}Resolver":
        ...
        for link_name, link in computed_links.items():
            ...
            resolver_func_strs.append(
                f"""
    def {link_name}(self, resolver: T.Optional["{target_rez_name}"] = None, key: str = "{link_name}") -> "{safe_table_name}Resolver":
        self.add_child(
            key=key,
...
{resolver_func_str}
    ...
    all_strs = [
        ...
        "from sqlorm.models import Node, Insert, Patch, Resolver, Conflict, ComputedColumn, raw_sql",
