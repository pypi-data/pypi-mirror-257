...
class FLEXL(Bmi):
    ...
    def initialize(self, config_file: str) -> None:
        """"Based on LeakyBucketBMI simple implementation of FLEX-lumped without snow component
            Requires atleast:
            ---------------------
    ...
    def update(self) -> None:
        ...
        ### posibly change to more closely reflect HBV-96 https://doi-org.tudelft.idm.oclc.org/10.1016/S0022-1694(97)00041-3
        ### currently its more https://hess.copernicus.org/articles/18/4839/2014/hess-18-4839-2014.pdf - kinda awkard
        ### https://medium.com/hydroinformatics/hbv-lumped-conceptual-hydrological-model-b0a75b4e61d0 or 
