...
d = {
    ...
    "syms": {
        ...
        "leximpact_aggregates.aggregates_dads": {
            "leximpact_aggregates.aggregates_dads.dads_var_to_dict": (
                "aggregates_from_dads.html#dads_var_to_dict",
                "leximpact_aggregates/aggregates_dads.py",
            )
        },
        "leximpact_aggregates.aggregates_pote": {
            "leximpact_aggregates.aggregates_pote.pote_var_to_dict": (
                "aggregates_from_pote.html#pote_var_to_dict",
                "leximpact_aggregates/aggregates_pote.py",
            )
        },
