...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package hnswlib-prebuilt-sandybridge. Maybe you are using the wrong pypi?")


setup(
    name='hnswlib-prebuilt-sandybridge',
    version='66.0.3',
    author='Yandex',
