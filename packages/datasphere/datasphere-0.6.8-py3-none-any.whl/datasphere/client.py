...
loggers_map = {
    job_service.StdLog.Type.OUT: logger_program_stdout,
    job_service.StdLog.Type.ERR: logger_program_stderr,
}
...
class Client:
    ...
    def read_logs(self, job_id: str, offset: int):
    ...
    @property
    def md(self):
        return get_md(self.oauth_token)
