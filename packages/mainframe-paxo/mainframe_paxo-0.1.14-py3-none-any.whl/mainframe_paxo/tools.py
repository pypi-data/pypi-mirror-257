...
def subst_drive(work_drive=None, force=False, permanent=True):
    ...
    if out.returncode == 0:
        ...
        if permanent:
            register_subst_drive(drive, src)
        return True
