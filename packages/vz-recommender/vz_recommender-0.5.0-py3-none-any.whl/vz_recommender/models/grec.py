...
from .transformer import (ParallelTransformerAEP, SimplifiedTransformerAEP, ParallelTransformerBlock, TransformerAEP, ParallelTransformerAEP2S,
                          ParallelTransformerSingleSeq, ParallelTransformerMultiSeq)
...
class GRecSingleTaskTT(nn.Module):
    def __init__(self, user_deep_dims, user_deep_embed_dims, user_num_wide, user_wad_embed_dim,
                 ...
                 cja_dims, ihq_dim, seq_embed_dim, nlp_encoder_path, nlp_dim, user_ctx_kwargs,
                 sequence_transformer_kwargs, cja_transformer_kwargs, ihq_transformer_kwargs, user_moe_kwargs):
        super().__init__()
        ...
        self.user_context_head = ContextEncoder(
...
#         user_ctx_out = self.user_context_head(deep_in=user_deep_in, wide_in=user_wide_in)
        num_in_0, num_in_2, num_in_sqrt = torch.stack(user_wide_in, dim=1).chunk(3, 1)
        user_ctx_out = self.user_context_head(user_deep_in, num_in_0, num_in_2, num_in_sqrt)
