...
class SurfaceArea:
    ...
    @staticmethod
    def unbound_surface_area_of_protein(protein: Protein,
                                        assign_attribute: bool = False,
                                        key: str = "unbound_surface_area") -> float:
        """
        Calculate the unbound surface area of a protein.

        Args:
            protein (Protein): The protein object for which to calculate the unbound surface area.
            assign_attribute (bool): Whether to assign the unbound surface area to the protein object.
            key (str): The attribute key to use when assigning the unbound surface area to the protein object.

        Returns:
            float: The unbound surface area of the protein.
        """
