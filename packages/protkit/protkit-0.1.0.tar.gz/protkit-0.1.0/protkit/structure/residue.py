...
from protkit.enum.residue_type import ResidueLookup
...
class Residue:
    ...
    def short_code(self) -> str:
        ...
        Raises:
            Exception: If the residue type is not found in ResidueLookup.SHORT_CODE.
        """
        if self._residue_type not in ResidueLookup.SHORT_CODE:
            raise Exception("Residue type {self._residue_type} not found in ResidueLookup.SHORT_CODE.")

        return ResidueLookup.SHORT_CODE[self._residue_type]
    ...
    def missing_heavy_atom_types(self) -> Set[str]:
        ...
        return ResidueLookup.HEAVY_ATOMS[self._residue_type] - heavy_atom_types
    ...
    def extra_heavy_atom_types(self) -> Set[str]:
        ...
        """
        heavy_atom_types = self.heavy_atom_types()
        return heavy_atom_types - ResidueLookup.HEAVY_ATOMS[self._residue_type]
    ...
    def missing_hydrogen_atom_types(self) -> Set[str]:
        ...
        return ResidueLookup.HYDROGEN_ATOMS[self._residue_type] - hydrogen_atom_types
    ...
    def extra_hydrogen_atom_types(self) -> Set[str]:
        ...
        """
        hydrogen_atom_types = self.hydrogen_atom_types()
        return hydrogen_atom_types - ResidueLookup.HYDROGEN_ATOMS[self._residue_type]
