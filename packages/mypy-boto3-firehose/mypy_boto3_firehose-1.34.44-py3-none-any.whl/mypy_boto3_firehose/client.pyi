...
from .type_defs import (
    ...
    TagrisSweepListItemTypeDef,
    TagrisVerifyResourcesExistOutputTypeDef,
    TagTypeDef,
)
...
class Exceptions:
    ...
    InvalidStreamTypeException: Type[BotocoreClientError]
    LimitExceededException: Type[BotocoreClientError]
    ResourceInUseException: Type[BotocoreClientError]
    ResourceNotFoundException: Type[BotocoreClientError]
    ServiceUnavailableException: Type[BotocoreClientError]
    TagrisAccessDeniedException: Type[BotocoreClientError]
    TagrisInternalServiceException: Type[BotocoreClientError]
    TagrisInvalidArnException: Type[BotocoreClientError]
    TagrisInvalidParameterException: Type[BotocoreClientError]
    TagrisPartialResourcesExistResultsException: Type[BotocoreClientError]
    TagrisThrottledException: Type[BotocoreClientError]
...
class FirehoseClient(BaseClient):
    ...
    def get_kinesis_stream(self, *, DeliveryStreamARN: str) -> GetKinesisStreamOutputTypeDef:
        """
        See also: [AWS API
        Documentation](https://docs.aws.amazon.com/goto/WebAPI/firehose-2015-08-04/GetKinesisStream).

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/firehose.html#Firehose.Client.get_kinesis_stream)
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_firehose/client/#get_kinesis_stream)
        """
    ...
    def verify_resources_exist_for_tagris(
        self, *, TagrisSweepList: Sequence[TagrisSweepListItemTypeDef]
    ) -> TagrisVerifyResourcesExistOutputTypeDef:
        """
        See also: [AWS API
        Documentation](https://docs.aws.amazon.com/goto/WebAPI/firehose-2015-08-04/VerifyResourcesExistForTagris).

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/firehose.html#Firehose.Client.verify_resources_exist_for_tagris)
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_firehose/client/#verify_resources_exist_for_tagris)
        """
