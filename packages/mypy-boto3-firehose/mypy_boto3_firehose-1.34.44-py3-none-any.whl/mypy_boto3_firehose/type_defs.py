...
__all__ = (
    ...
    "GetKinesisStreamInputRequestTypeDef",
    ...
    "TagrisVerifyResourcesExistInputRequestTypeDef",
...
GetKinesisStreamInputRequestTypeDef = TypedDict(
    "GetKinesisStreamInputRequestTypeDef",
    {
...
TagrisSweepListItemTypeDef = TypedDict(
    "TagrisSweepListItemTypeDef",
    {
        "TagrisAccountId": NotRequired[str],
        "TagrisAmazonResourceName": NotRequired[str],
        "TagrisInternalId": NotRequired[str],
        "TagrisVersion": NotRequired[int],
    },
)
...
TagrisVerifyResourcesExistOutputTypeDef = TypedDict(
    "TagrisVerifyResourcesExistOutputTypeDef",
    {
        "TagrisSweepListResult": Dict[str, TagrisStatusType],
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
...
GetKinesisStreamOutputTypeDef = TypedDict(
    "GetKinesisStreamOutputTypeDef",
    {
        "KinesisStreamARN": str,
        "CredentialsForReadingKinesisStream": SessionCredentialsTypeDef,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
...
TagrisVerifyResourcesExistInputRequestTypeDef = TypedDict(
    "TagrisVerifyResourcesExistInputRequestTypeDef",
    {
        "TagrisSweepList": Sequence[TagrisSweepListItemTypeDef],
    },
)
...
ExtendedS3DestinationConfigurationTypeDef = TypedDict(
    "ExtendedS3DestinationConfigurationTypeDef",
    {
        ...
        "S3BackupConfiguration": NotRequired[S3DestinationConfigurationTypeDef],
        "DataFormatConversionConfiguration": NotRequired[DataFormatConversionConfigurationTypeDef],
