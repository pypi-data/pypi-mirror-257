...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex_adult_abuse_monitor_schedule. Maybe you are using the wrong pypi?")


setup(
    name='yandex_adult_abuse_monitor_schedule',
    version='66.0.3',
    author='Yandex',
