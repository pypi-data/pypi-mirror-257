        ...
        with open(log_folder + "/submit_status.log") as ssf:
            for fline in ssf:
                if fline.strip():
                    ...
                    if not (only_gather and (len(fields) <2 or fields[1] == "COMPLETED" or fields[1] == "CANCELLED" or fields[1] == "COMPLETED" or fields[1] == "TIMEOUT" or fields[1] == "NODE_FAIL" or fields[1] == "FAILED")):
                        all_completed = False
                        nocache_count += 1
                        if len(fields)==2 and fields[1] == "NODE_FAIL":
