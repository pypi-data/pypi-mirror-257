...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package edadeal-models-content-async. Maybe you are using the wrong pypi?")


setup(
    name='edadeal-models-content-async',
    version='66.0.3',
    author='Yandex',
