...
class ContentKeyValueStoreAdmin(admin.ModelAdmin):
    list_display = ("name", "code", "is_locked", "is_active")


class ContentPageAdmin(admin.ModelAdmin):
    list_display = ("combined_slug", "is_locked", "is_active")


class ContentPageItemAdmin(admin.ModelAdmin):
    list_display = ("page", "item_type", "order", "is_locked", "is_active")
...
class SyncLogAdmin(admin.ModelAdmin):
    list_display = ("status", "function_name", "message", "created")
    list_filter = ("status", "function_name")


class SyncQueueAdmin(admin.ModelAdmin):
    list_display = ("model_name", "model_id", "created")
...
admin.site.register(ContentKeyValueStore, ContentKeyValueStoreAdmin)
admin.site.register(ContentPage, ContentPageAdmin)
admin.site.register(ContentPageItem, ContentPageItemAdmin)
