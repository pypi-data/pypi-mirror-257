...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pylogram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pylogram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pylogram.raw.base.payments.ValidatedRequestedInfo>`
    """
