...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pylogram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pylogram.raw.base.ThemeSettings>`, *optional*):
            N/A
