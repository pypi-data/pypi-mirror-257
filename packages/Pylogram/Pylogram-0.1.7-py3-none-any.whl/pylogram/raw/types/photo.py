...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pylogram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pylogram.raw.base.VideoSize>`, *optional*):
            N/A
