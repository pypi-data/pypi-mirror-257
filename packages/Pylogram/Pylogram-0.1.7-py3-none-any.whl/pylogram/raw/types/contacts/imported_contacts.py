...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pylogram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pylogram.raw.base.PopularContact>`):
            N/A
