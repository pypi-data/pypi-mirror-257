...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pylogram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pylogram.raw.base.auth.CodeType>`, *optional*):
            N/A
