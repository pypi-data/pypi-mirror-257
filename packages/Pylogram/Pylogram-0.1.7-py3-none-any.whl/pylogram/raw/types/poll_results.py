...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pylogram.raw.base.PollAnswerVoters>`, *optional*):
            N/A

        total_voters (``int`` ``32-bit``, *optional*):
            N/A

        recent_voters (List of :obj:`Peer <pylogram.raw.base.Peer>`, *optional*):
            N/A

        solution (``str``, *optional*):
            N/A

        solution_entities (List of :obj:`MessageEntity <pylogram.raw.base.MessageEntity>`, *optional*):
            N/A
