...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <pylogram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
