...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pylogram.raw.base.SearchResultsPosition>`):
            N/A
