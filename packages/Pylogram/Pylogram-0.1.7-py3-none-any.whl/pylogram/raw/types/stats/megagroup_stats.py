...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <pylogram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <pylogram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <pylogram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <pylogram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <pylogram.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <pylogram.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <pylogram.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <pylogram.raw.base.StatsGroupTopInviter>`):
            N/A
