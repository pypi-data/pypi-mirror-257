...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <pylogram.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <pylogram.raw.base.InputPeer>`, *optional*):
            N/A
