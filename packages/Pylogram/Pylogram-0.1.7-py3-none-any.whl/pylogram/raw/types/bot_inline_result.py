...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pylogram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pylogram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pylogram.raw.base.WebDocument>`, *optional*):
            N/A
