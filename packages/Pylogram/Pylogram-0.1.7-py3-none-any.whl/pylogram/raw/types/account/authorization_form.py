...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pylogram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pylogram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pylogram.raw.base.SecureValueError>`):
            N/A
