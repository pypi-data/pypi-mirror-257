...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pylogram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pylogram.raw.base.Reaction>`, *optional*):
            N/A
