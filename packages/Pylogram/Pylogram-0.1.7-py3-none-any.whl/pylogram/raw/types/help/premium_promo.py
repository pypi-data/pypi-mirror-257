...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pylogram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pylogram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pylogram.raw.base.PremiumSubscriptionOption>`):
            N/A
