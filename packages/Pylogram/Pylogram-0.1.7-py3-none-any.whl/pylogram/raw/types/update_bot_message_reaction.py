...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <pylogram.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <pylogram.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <pylogram.raw.base.Reaction>`):
            N/A
