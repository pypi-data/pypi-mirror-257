...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pylogram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pylogram.raw.base.Peer>`):
            N/A
