...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <pylogram.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <pylogram.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
