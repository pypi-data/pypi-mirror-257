...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Parameters:
        new_messages (List of :obj:`Message <pylogram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pylogram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pylogram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pylogram.raw.base.updates.State>`):
            N/A
