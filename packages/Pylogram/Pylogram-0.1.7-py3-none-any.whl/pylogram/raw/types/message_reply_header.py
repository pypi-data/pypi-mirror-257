...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.MessageReplyHeader`.
    ...
    Parameters:
        ...
        reply_to_peer_id (:obj:`Peer <pylogram.raw.base.Peer>`, *optional*):
            N/A

        reply_from (:obj:`MessageFwdHeader <pylogram.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <pylogram.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <pylogram.raw.base.MessageEntity>`, *optional*):
            N/A
