...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pylogram.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pylogram.raw.base.ChannelParticipant>`):
            N/A
