...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <pylogram.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <pylogram.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
