...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-pydivkit-patched-mosaic. Maybe you are using the wrong pypi?")


setup(
    name='yandex-pydivkit-patched-mosaic',
    version='66.0.3',
    author='Yandex',
