...
class AAZCommandCtx:
    ...
    def get_http_client(self, client_type):
        ...
        if client_type not in self._clients:
            ...
            from foundationallm.cli.core.commands.client_factory import _prepare_client_kwargs_track2
            assert client_type
...
def get_subscription_locations(ctx: AAZCommandCtx):
    from foundationallm.cli.core.commands.parameters import get_subscription_locations as _get_subscription_locations
    return _get_subscription_locations(ctx.cli_ctx)


def get_resource_group_location(ctx: AAZCommandCtx, rg_name: str):
    from foundationallm.cli.core.commands.client_factory import get_mgmt_service_client
    from foundationallm.cli.core.profiles import ResourceType
    from foundationallm.core.exceptions import ResourceNotFoundError
