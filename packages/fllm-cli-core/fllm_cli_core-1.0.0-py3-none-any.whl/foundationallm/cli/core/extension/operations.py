...
from foundationallm.cli.core import CommandIndex
from foundationallm.cli.core.util import CLIError, reload_module, rmtree_with_retry
from foundationallm.cli.core.extension import (extension_exists, build_extension_path, get_extensions, get_extension_modname,
...
from foundationallm.cli.core.telemetry import set_extension_management_detail
...
LIST_FILE_PATH = os.path.join(os.sep, 'etc', 'apt', 'sources.list.d', 'fllm-cli.list')
...
def _whl_download_from_url(url_parse_result, ext_file):
    import requests
    from foundationallm.cli.core.util import should_disable_connection_verify
...
def _install_deps_for_psycopg2():  # pylint: disable=too-many-statements
    ...
    import platform
    import subprocess
    from foundationallm.cli.core.util import get_linux_distro
