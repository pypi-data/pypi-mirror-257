...
def save(config_dir, payload):
    from foundationallm.cli.telemetry.components.telemetry_client import CliTelemetryClient
    from foundationallm.cli.telemetry.components.telemetry_logging import get_logger
...
def main():
    from foundationallm.cli.telemetry.components.telemetry_note import TelemetryNote
    from foundationallm.cli.telemetry.components.records_collection import RecordsCollection
    from foundationallm.cli.telemetry.components.telemetry_client import CliTelemetryClient
    from foundationallm.cli.telemetry.components.telemetry_logging import config_logging_for_upload, get_logger
