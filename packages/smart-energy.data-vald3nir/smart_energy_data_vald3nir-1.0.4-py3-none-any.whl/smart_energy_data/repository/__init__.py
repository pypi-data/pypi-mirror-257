...
from keys.smart_energy_secrets import DatabaseEnv
from src.smart_energy_data import mongodb_address
...
class BaseDAO(MongoDAO):
    ...
    def __init__(self, collection: str, database: str = DatabaseEnv.DATABASE_NAME.value) -> None:
        super().__init__(
