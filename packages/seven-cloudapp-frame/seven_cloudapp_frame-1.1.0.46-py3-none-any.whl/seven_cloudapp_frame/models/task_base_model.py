...
@LastEditTime: 2024-01-25 19:42:06
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_task_info_dict_list(self, app_id, act_id, module_id, is_release, is_cache=True, source_object_id='', is_del=-1):
        """
        :description: 获取任务列表
        :param app_id: 应用标识
        :param act_id: 活动标识
    ...
    def get_client_task_list(self, app_id, act_id, module_id, user_id, task_types="", app_key="", app_secret="", is_log=False, daily_repeat_browse=False, mix_nick=""):
        ...
        :last_editors: HuangJianYi
        """
        task_info_list = self.get_task_info_dict_list(app_id, act_id, module_id, 1, True, source_object_id='', is_del=0)
        task_count_model = TaskCountModel(context=self.context).set_sub_table(app_id)
                ...
                if task_invoke_result_data.success == True:
                    ...
                    if acquire_lock_status == False:
                        ...
                        if reward_value <= 0 or task_count.now_count <= 0:
                            ...
                            cur_complete_count = cur_complete_count = limit_num - task_count.complete_count if task_count.complete_count + int(task_count.now_count/satisfy_num) > limit_num else int(task_count.now_count / satisfy_num)
