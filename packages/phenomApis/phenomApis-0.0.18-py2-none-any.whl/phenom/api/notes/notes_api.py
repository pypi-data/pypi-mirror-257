...
class NotesApi(object):
    ...
    def add_notes(self, body, candidate_id, **kwargs):  # noqa: E501
        ...
        :param AddNotes body: add notes to multiple candidates (required)
    ...
    def delete_notes(self, candidate_id, note_id, x_ph_userid, **kwargs):  # noqa: E501
        ...
        :param str note_id: noteId (required)
    ...
    def get_notes(self, x_ph_user_id, candidate_id, **kwargs):  # noqa: E501
        ...
        :param str recruiter_email: recruiterEmail
        :param str include_private_notes: includePrivateNotes
