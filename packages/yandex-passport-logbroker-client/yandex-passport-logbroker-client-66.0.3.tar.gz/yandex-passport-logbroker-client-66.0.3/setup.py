...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-passport-logbroker-client. Maybe you are using the wrong pypi?")


setup(
    name='yandex-passport-logbroker-client',
    version='66.0.3',
    author='Yandex',
