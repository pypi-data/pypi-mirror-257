...
class MSData:
    ...
    def output_single_file(self):
        ...
        path = os.path.join(self.params.project_dir, "single_file_output")
        if not os.path.exists(path):
            os.makedirs(path)
        path = os.path.join(self.params.project_dir, "single_file_output", self.file_name + ".csv")
    ...
    def plot_eic(self, target_mz, target_rt=None, mz_tol=0.005, rt_tol=0.3, output=False):
        """
