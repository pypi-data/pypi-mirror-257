from util.string_util import any_match, any_match_bool, extract_digit, transfer_hump_to_database_name, find_all, \
    remove_special_symbols, has_chinese, is_chinese, split_text, handle_short_sentence
...
class TestStringUtil:
    ...
    def test_transfer_hump_to_database_name(self):
        result = transfer_hump_to_database_name("absoluteGoodLeader")
        assert result == "absolute_good_leader"
