...
from cringe_lord.app.src_directory.ast_visitor.get_cringe_setting_call import (
...
cringe_lord.get_cringe_setting("setting_name")
""").body[0].value
NAMED_CALL = ast.parse("""
cringe_lord.get_cringe_setting(variable_name)
""").body[0].value
