...
from cringe_lord import api
from cringe_lord.app.exceptions import MissingConfigValueError
...
class TestAPI:
    ...
    class TestLoad:
        @patch("cringe_lord.app.app.load_from_app_dir")
    ...
    class TestLoadAll:
        @patch("cringe_lord.app.app.load_all")
        def test_paths(self, mock_app):
            environment_name = "environment_name"
