...
class GroupsLocal(GenericCRUDML):
    ...
    def insert(self, group_dict: Dict[str, any], ignore_duplicate: bool = False) -> tuple[int, int]:
        """
    ...
    def get_group_dict_by_group_id(self, group_id: int, group_ml_id: int = None) -> Dict[str, any]:
        ...
        group_ml_dict = {}
        if group_ml_id:
            group_ml_dict = self.select_one_dict_by_id(view_table_name="group_ml_also_not_approved_view", id_column_value=group_ml_id,
                                                       id_column_name="group_ml_id")
