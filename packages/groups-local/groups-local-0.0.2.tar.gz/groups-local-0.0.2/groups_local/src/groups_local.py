...
class GroupsLocal(GenericCRUDML):
    ...
    def insert(self, group_dict: Dict[str, any]) -> tuple[int, int]:
        ...
        group_data_json = {
            ...
            "is_approved": group_dict.get('is_approved', False),
        ...
        # is named "is_main_title" and not "is_main_title"
        group_id = GenericCRUDML.insert(self, data_json=group_data_json)

        lang_code = group_dict.get('lang_code') or user_context.get_effective_profile_preferred_lang_code_string()
        group_ml_data_json = {
            "number": number,
            "identifier": identifier,
            "group_id": group_id,
            ...
            "created_user_id": group_dict.get('created_user_id', 0),
            "is_title_approved": group_dict.get('is_title_approved', False),
            "is_description_approved": group_dict.get('is_description_approved', False)
        }
    ...
    def update(self, group_id: int, group_dict: Dict[str, any]) -> None:
        ...
        group_ml_data_json = {
            "group_id": group_id,
            "lang_code": group_dict.get('lang_code'),
            "title": group_dict.get('title'),
    ...
    def get_groups_by_group_title(self, group_title: str) -> list:
        ...
        group_ids_dicts_list = self.select_multi_dict_by_id(
            view_table_name="group_ml_view", id_column_value=group_title, id_column_name="title",
