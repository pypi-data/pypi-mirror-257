...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-taxi-dmp-callcenter-etl. Maybe you are using the wrong pypi?")


setup(
    name='yandex-taxi-dmp-callcenter-etl',
    version='66.0.3',
    author='Yandex',
