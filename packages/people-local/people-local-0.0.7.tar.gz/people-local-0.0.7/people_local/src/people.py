...
from groups_local.groups_local_constants import GroupsLocalConstants
load_dotenv()
...
class PeopleLocal():
    def __init__(self, first_name: str = None, last_names: list = None, original_organization_names: list = None,
                 short_organization_names: list = None, email_addresses: list = None, urls: list = None):
        logger.start(
            object={
                'first_name': first_name, 'last_names': last_names,
    ...
    def _process_first_name_str(self, add_people_to_a_group_function, **kwargs) -> str:
        ...
        try:
            ...
            logger.error("error processing first name", object={
                         'self.first_name': self.first_name, 'error': exception})
            raise exception
    ...
    def normalize_names(self):
        logger.start()
        if self.first_name:
            self.normalized_first_name = remove_digits(self.first_name)
