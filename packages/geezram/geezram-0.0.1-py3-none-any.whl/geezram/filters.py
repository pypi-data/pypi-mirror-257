...
from geezram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "geezram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~geezram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~geezram.handlers.MessageHandler` the *update* argument will be a :obj:`~geezram.types.Message`; in a :obj:`~geezram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~geezram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~geezram.filters.command` or :meth:`~geezram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~geezram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~geezram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~geezram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~geezram.types.Message`.
    ...
    async def func(flt, client: geezram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~geezram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~geezram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~geezram.types.InlineQuery`: The filter will match ``query``.
