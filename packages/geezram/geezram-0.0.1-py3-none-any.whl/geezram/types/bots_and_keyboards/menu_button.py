...
class MenuButton(Object):
    ...
    - :obj:`~geezram.types.MenuButtonCommands`
    - :obj:`~geezram.types.MenuButtonWebApp`
    - :obj:`~geezram.types.MenuButtonDefault`

    If a menu button other than :obj:`~geezram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "geezram.Client") -> "raw.base.BotMenuButton":
