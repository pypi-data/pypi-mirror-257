...
class BotCommandScope(Object):
    ...
    - :obj:`~geezram.types.BotCommandScopeDefault`
    - :obj:`~geezram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~geezram.types.BotCommandScopeAllGroupChats`
    - :obj:`~geezram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~geezram.types.BotCommandScopeChat`
    - :obj:`~geezram.types.BotCommandScopeChatAdministrators`
    - :obj:`~geezram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "geezram.Client") -> "raw.base.BotCommandScope":
