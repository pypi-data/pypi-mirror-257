...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~geezram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~geezram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~geezram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~geezram.types.CallbackGame`, *optional*):
