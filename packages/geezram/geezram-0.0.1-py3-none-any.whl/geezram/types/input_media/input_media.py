...
class InputMedia(Object):
    ...
    - :obj:`~geezram.types.InputMediaAnimation`
    - :obj:`~geezram.types.InputMediaDocument`
    - :obj:`~geezram.types.InputMediaAudio`
    - :obj:`~geezram.types.InputMediaPhoto`
    - :obj:`~geezram.types.InputMediaVideo`
    """
