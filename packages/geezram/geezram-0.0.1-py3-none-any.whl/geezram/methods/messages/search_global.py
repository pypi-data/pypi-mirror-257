...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~geezram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~geezram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~geezram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "geezram". Get the first 50 results
                async for message in app.search_global("geezram", limit=50):
                    print(message.text)
