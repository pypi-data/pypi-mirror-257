...
from geezram.errors import AuthBytesInvalid
from geezram.session import Session
from geezram.session.auth import Auth


async def get_session(client: "geezram.Client", dc_id: int):
