...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~geezram.types.InputMediaPhoto`, :obj:`~geezram.types.InputMediaVideo`, :obj:`~geezram.types.InputMediaAudio` and :obj:`~geezram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~geezram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from geezram.types import InputMediaPhoto, InputMediaVideo
