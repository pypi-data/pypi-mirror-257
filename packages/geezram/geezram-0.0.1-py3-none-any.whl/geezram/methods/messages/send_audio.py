...
import geezram
from geezram import StopTransmission, enums
from geezram import raw
from geezram import types
from geezram import utils
from geezram.errors import FilePartMissing
from geezram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~geezram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~geezram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~geezram.Client.stop_transmission`, None is returned.
