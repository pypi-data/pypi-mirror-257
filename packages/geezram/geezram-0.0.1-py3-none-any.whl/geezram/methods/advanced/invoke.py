...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <geezram.api.functions>` package and may accept compound
        data types from :obj:`types <geezram.api.types>` as well as bare types such as ``int``, ``str``, etc...
