...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~geezram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.DeletedMessagesHandler(func, self),
