...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~geezram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~geezram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.ChosenInlineResultHandler(func, self),
