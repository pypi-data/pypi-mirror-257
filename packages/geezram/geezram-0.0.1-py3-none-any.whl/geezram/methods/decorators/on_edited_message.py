...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~geezram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.EditedMessageHandler(func, self),
