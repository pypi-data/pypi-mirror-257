...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~geezram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.ChatMemberUpdatedHandler(func, self),
