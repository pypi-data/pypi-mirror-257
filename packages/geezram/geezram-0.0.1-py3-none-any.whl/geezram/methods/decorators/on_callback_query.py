...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~geezram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.CallbackQueryHandler(func, self),
