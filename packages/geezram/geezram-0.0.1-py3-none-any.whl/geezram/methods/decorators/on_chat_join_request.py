...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~geezram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.ChatJoinRequestHandler(func, self),
