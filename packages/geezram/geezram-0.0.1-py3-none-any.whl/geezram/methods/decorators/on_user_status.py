...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~geezram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.UserStatusHandler(func, self),
