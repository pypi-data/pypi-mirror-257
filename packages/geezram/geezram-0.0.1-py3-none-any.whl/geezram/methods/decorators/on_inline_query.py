...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~geezram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezram.Client):
                self.add_handler(geezram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezram.handlers.InlineQueryHandler(func, self),
