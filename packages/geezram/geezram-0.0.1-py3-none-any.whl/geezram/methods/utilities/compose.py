...
async def compose(
    clients: List["geezram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``geezram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~geezram.Client.run`.

    Parameters:
        clients (List of :obj:`~geezram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from geezram import Client, compose
