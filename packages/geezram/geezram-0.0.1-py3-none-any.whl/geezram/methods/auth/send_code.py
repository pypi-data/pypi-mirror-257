...
from geezram.errors import PhoneMigrate, NetworkMigrate
from geezram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~geezram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
