...
from geezram.crypto import aes, rsa, prime
from geezram.errors import SecurityCheckMismatch
from geezram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "geezram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
