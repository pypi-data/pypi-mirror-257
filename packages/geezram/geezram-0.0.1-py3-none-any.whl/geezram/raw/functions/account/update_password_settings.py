...
class UpdatePasswordSettings(TLObject):  # type: ignore
    ...
    Parameters:
        password (:obj:`InputCheckPasswordSRP <geezram.raw.base.InputCheckPasswordSRP>`):
            N/A

        new_settings (:obj:`account.PasswordInputSettings <geezram.raw.base.account.PasswordInputSettings>`):
            N/A
