...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        theme (:obj:`InputTheme <geezram.raw.base.InputTheme>`):
            N/A
        ...
        document (:obj:`InputDocument <geezram.raw.base.InputDocument>`, *optional*):
            N/A

        settings (List of :obj:`InputThemeSettings <geezram.raw.base.InputThemeSettings>`, *optional*):
            N/A

    Returns:
        :obj:`Theme <geezram.raw.base.Theme>`
    """
