...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <geezram.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <geezram.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <geezram.raw.base.phone.GroupParticipants>`
    """
