...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        user_id (:obj:`InputUser <geezram.raw.base.InputUser>`):
            N/A
        ...
        stickers (List of :obj:`InputStickerSetItem <geezram.raw.base.InputStickerSetItem>`):
            N/A
        ...
        thumb (:obj:`InputDocument <geezram.raw.base.InputDocument>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.StickerSet <geezram.raw.base.messages.StickerSet>`
    """
