...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <geezram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <geezram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <geezram.raw.base.payments.ValidatedRequestedInfo>`
    """
