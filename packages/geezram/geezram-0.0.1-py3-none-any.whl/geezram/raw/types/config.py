...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <geezram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <geezram.raw.base.Reaction>`, *optional*):
            N/A
