...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <geezram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <geezram.raw.base.GroupCallParticipant>`):
            N/A
