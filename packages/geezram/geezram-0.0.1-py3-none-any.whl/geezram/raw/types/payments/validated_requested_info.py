...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        ...
        shipping_options (List of :obj:`ShippingOption <geezram.raw.base.ShippingOption>`, *optional*):
            N/A
