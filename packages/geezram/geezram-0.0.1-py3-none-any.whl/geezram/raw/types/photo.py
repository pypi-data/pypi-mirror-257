...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <geezram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <geezram.raw.base.VideoSize>`, *optional*):
            N/A
