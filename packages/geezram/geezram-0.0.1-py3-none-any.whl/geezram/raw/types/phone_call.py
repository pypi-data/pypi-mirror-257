...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <geezram.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <geezram.raw.base.PhoneConnection>`):
            N/A
