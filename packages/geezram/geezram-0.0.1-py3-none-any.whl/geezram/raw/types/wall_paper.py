...
class WallPaper(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        document (:obj:`Document <geezram.raw.base.Document>`):
            N/A
        ...
        settings (:obj:`WallPaperSettings <geezram.raw.base.WallPaperSettings>`, *optional*):
            N/A
