...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <geezram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
