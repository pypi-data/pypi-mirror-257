...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <geezram.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <geezram.raw.base.Message>`):
            N/A
