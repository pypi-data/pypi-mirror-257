...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.InputBotInlineMessage`.
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <geezram.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <geezram.raw.base.InputWebDocument>`, *optional*):
            N/A
