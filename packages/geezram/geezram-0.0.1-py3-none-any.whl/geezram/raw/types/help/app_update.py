...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <geezram.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <geezram.raw.base.Document>`, *optional*):
            N/A
