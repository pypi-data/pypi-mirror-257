...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <geezram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <geezram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <geezram.raw.base.PremiumSubscriptionOption>`):
            N/A
