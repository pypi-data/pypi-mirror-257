...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <geezram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <geezram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
