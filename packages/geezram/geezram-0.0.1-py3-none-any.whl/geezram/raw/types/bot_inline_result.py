...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <geezram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <geezram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <geezram.raw.base.WebDocument>`, *optional*):
            N/A
