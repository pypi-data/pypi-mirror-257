...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <geezram.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <geezram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
