...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <geezram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <geezram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <geezram.raw.base.SecureValueError>`):
            N/A
