...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <geezram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <geezram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <geezram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <geezram.raw.base.updates.State>`):
            N/A
