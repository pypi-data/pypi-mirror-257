...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <geezram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <geezram.raw.base.PopularContact>`):
            N/A
