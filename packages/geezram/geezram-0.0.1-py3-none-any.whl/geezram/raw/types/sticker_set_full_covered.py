...
class StickerSetFullCovered(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.StickerSetCovered`.
    ...
    Parameters:
        set (:obj:`StickerSet <geezram.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <geezram.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <geezram.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <geezram.raw.base.Document>`):
            N/A
