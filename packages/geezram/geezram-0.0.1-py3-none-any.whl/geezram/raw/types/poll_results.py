...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <geezram.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <geezram.raw.base.MessageEntity>`, *optional*):
            N/A
