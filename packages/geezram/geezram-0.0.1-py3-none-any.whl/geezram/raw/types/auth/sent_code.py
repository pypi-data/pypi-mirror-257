...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <geezram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <geezram.raw.base.auth.CodeType>`, *optional*):
            N/A
