...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <geezram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <geezram.raw.base.InputFile>`, *optional*):
            N/A
