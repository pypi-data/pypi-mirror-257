...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <geezram.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <geezram.raw.base.AttachMenuBotIcon>`):
            N/A
