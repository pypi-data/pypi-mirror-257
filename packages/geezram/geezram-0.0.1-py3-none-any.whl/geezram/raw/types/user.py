...
class User(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.User`.
    ...
    Parameters:
        ...
        photo (:obj:`UserProfilePhoto <geezram.raw.base.UserProfilePhoto>`, *optional*):
            N/A

        status (:obj:`UserStatus <geezram.raw.base.UserStatus>`, *optional*):
            N/A
        ...
        emoji_status (:obj:`EmojiStatus <geezram.raw.base.EmojiStatus>`, *optional*):
            N/A
