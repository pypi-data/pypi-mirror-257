...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <geezram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <geezram.raw.base.ThemeSettings>`, *optional*):
            N/A
