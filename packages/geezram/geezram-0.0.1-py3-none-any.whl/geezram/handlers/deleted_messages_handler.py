...
import geezram
from geezram.filters import Filter
from geezram.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~geezram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~geezram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~geezram.types.Message`):
    ...
    async def check(self, client: "geezram.Client", messages: List[Message]):
