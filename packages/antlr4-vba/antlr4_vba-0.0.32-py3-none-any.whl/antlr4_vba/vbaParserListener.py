...
class vbaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by vbaParser#attributeName.
    def enterAttributeName(self, ctx:vbaParser.AttributeNameContext):
        pass

    # Exit a parse tree produced by vbaParser#attributeName.
    def exitAttributeName(self, ctx:vbaParser.AttributeNameContext):
        pass
