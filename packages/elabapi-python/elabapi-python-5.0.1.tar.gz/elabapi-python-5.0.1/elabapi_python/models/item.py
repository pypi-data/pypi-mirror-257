...
class Item(Entity):
    ...
    def __init__(self, is_bookable=None, canbook=None, book_max_minutes=None, book_max_slots=None, book_can_overlap=None, book_is_cancellable=None, book_cancel_minutes=None, *args, **kwargs):  # noqa: E501
