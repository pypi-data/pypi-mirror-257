...
class Users(object):
    ...
    def __init__(self, userid=None, firstname=None, lastname=None, email=None, validated=None, valid_until=None, archived=None, last_login=None, fullname=None, orcid=None, orgid=None, auth_service=None, is_sysadmin=None, entrypoint=None, teams=None):  # noqa: E501
