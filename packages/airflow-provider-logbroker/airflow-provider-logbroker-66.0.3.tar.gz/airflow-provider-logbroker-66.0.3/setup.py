...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package airflow-provider-logbroker. Maybe you are using the wrong pypi?")


setup(
    name='airflow-provider-logbroker',
    version='66.0.3',
    author='Yandex',
