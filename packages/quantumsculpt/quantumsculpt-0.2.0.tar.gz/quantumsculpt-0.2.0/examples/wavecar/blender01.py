...
filename = os.path.join(ROOT, '..', '..', 'samples', 'carbonmonoxide_gasphase', 'pbe-manybands', 'WAVECAR')
contcar = os.path.join(ROOT, '..', '..', 'samples', 'carbonmonoxide_gasphase', 'pbe-manybands', 'CONTCAR')
...
# render all MOs
br.render_kohn_sham_state(wf=wf, outpath=output, mo_indices=np.arange(0,10),
