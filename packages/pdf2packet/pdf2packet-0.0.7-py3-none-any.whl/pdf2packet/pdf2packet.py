...
parser = argparse.ArgumentParser(description='Split PDF files into separate files based on a separator barcode and then combine them into a result packet')
