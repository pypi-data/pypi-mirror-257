...
class WorkspaceJob(Job):
    ...
    """
    def __init__(self, job_name, namespace='default', workspace_path="/workspace/", output_path=None, workspace_size="1", output_size="1", shared_claim_name=None, backoff_limit=0, shared_tier='enterprise-rwx', emptydir_claim_name=None):
        ...
        self.emptydir_claim_name = emptydir_claim_name
    ...
    def _add_volumes(self):
        ...
        if not self.shared_claim_name and not self.emptydir_claim_name:
        ...
        elif self.emptydir_claim_name:
            self.workspace_vc = VolumeClaim(self.emptydir_claim_name, self.workspace_size, self.namespace, shared=True)
            self.add_volume(
                name="workspace",
                empty_dir=client.V1EmptyDirVolumeSource(size_limit=str(self.workspace_size)+'Gi')
            )
