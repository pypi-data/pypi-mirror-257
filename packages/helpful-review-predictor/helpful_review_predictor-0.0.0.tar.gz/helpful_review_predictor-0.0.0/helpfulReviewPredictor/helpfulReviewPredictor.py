...
def predict_helpfulness(string):    
    loaded_model = joblib.load('./helpfulReviewPredictor/best_model.pkl')
    ...
    vectorizer_file_path = './helpfulReviewPredictor/vectorizer.pkl'
