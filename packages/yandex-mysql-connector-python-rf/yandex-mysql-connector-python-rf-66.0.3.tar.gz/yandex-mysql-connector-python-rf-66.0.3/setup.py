...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-mysql-connector-python-rf. Maybe you are using the wrong pypi?")


setup(
    name='yandex-mysql-connector-python-rf',
    version='66.0.3',
    author='Yandex',
