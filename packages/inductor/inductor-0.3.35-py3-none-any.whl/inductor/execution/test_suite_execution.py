...
def _configure_for_test(hparams: Dict[str, Any]):
    ...
    `execution.logger_decorator_enabled` to False and set the
    `execution.hparams` to the given hyperparameters. On exit, restore
    the original value of `execution.logger_decorator_enabled` and set
    `execution.hparams` to an empty dictionary.
