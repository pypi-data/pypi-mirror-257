...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package traffic-team-python3-modules. Maybe you are using the wrong pypi?")


setup(
    name='traffic-team-python3-modules',
    version='66.0.3',
    author='Yandex',
