...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package ferroalloy_optimize_package. Maybe you are using the wrong pypi?")


setup(
    name='ferroalloy_optimize_package',
    version='66.0.3',
    author='Yandex',
