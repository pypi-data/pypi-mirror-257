...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-passport-ch-stat-loader. Maybe you are using the wrong pypi?")


setup(
    name='yandex-passport-ch-stat-loader',
    version='66.0.3',
    author='Yandex',
