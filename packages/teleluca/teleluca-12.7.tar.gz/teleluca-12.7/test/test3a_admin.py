...
import teleluca.aio
from teleluca.aio.routing import by_content_type, make_content_type_routing_table
from teleluca.exception import NotEnoughRightsError

class AdminBot(teleluca.aio.Bot):
    async def on_chat_message(self, msg):
        ...
        if 'edit_date' not in msg:
            ...
            r = teleluca.aio.helper.Router(by_content_type(), make_content_type_routing_table(self))
    ...
    async def on_new_chat_member(self, msg, new_chat_member):
        ...
        print(r)
        print(teleluca.namedtuple.ChatMemberArray(r))
