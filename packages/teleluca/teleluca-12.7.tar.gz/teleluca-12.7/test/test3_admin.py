...
from teleluca.routing import by_content_type, make_content_type_routing_table
from teleluca.exception import NotEnoughRightsError

class AdminBot(teleluca.Bot):
    def on_chat_message(self, msg):
        ...
        if 'edit_date' not in msg:
            ...
            r = teleluca.helper.Router(by_content_type(), make_content_type_routing_table(self))
