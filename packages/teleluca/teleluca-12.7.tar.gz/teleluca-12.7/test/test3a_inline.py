...
def on_inline_query(msg):
    ...
    query_id, from_id, query = teleluca.glance(msg, flavor='inline_query')
...
def on_chosen_inline_result(msg):
    result_id, from_id, query = teleluca.glance(msg, flavor='chosen_inline_result')
...
answerer = teleluca.aio.helper.Answerer(bot)
