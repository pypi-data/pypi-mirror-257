...
class telelucaException(Exception):
    """ Base class of following exceptions. """
    pass

class BadFlavor(telelucaException):
...
class BadHTTPResponse(telelucaException):
    """
...
class EventNotFound(telelucaException):
...
class WaitTooLong(telelucaException):
...
class StopListening(telelucaException):
    pass

class TelegramError(telelucaException):
    """
    ...
    be raised. Before raising a generic ``TelegramError``, teleluca looks for
