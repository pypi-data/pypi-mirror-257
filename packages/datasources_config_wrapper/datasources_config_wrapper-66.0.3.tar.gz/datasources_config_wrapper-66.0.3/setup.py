...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package datasources_config_wrapper. Maybe you are using the wrong pypi?")


setup(
    name='datasources_config_wrapper',
    version='66.0.3',
    author='Yandex',
