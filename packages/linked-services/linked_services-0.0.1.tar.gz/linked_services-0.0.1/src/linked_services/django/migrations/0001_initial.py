# Generated by Django 5.0.2 on 2024-02-17 05:53
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="legacy_key", to="django.app"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("app", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="django.app")),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to="django.scope"),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "app",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="m2m_required_scopes", to="django.app"
                    ),
                ),
                (
                    "scope",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "app",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="m2m_optional_scopes", to="django.app"
                    ),
                ),
                (
                    "scope",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="app_optional_scopes", through="django.AppOptionalScope", to="django.scope"
            ),
        ),
        migrations.AddField(
            model_name="app",
            ...
            field=models.ManyToManyField(
                blank=True, related_name="app_required_scopes", through="django.AppRequiredScope", to="django.scope"
            ),
        ),
    ]
