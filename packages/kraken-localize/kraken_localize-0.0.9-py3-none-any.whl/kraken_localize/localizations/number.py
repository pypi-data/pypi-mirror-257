...
"""
    ...
    return _get_number(code, locale, digits, unitCode)

@functools.lru_cache(maxsize=128)
def _get_number(code, locale='en_US', digits=None, unitCode=None):
    """
    """
...
def _get_unitCode(code, locale='en_US', digits=None, unitCode=None):
