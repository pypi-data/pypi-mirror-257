...
def test_get_corrected_time():
    assert projected.get_corrected_time(3.11) == 3.1


def test_get_corrrected_times():
    assert projected.get_corrected_times([3.11, 3.21]) == [3.1, 3.2]
