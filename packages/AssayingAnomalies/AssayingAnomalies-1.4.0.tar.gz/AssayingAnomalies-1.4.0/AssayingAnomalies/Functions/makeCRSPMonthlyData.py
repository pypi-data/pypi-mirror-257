...
def makeCRSPMonthlyData(params):
    ...
    if not params.remote_or_not:
        ...
        def process_and_save_var(crsp_folder, var, permno_list, dates_list):
            """
        ...
        with ThreadPoolExecutor(max_workers=params.num_cpus) as executor:
            ...
            futures = [executor.submit(process_and_save_var, crsp_folder, var, permno, dates) for var in varNames_crsp_msf]
