...
lang_code_cache = {}
JSON_VERSION = "240216"  # TODO: make it generic
            ...
            for message_channel, template_header in channels_mapping.items():
                for part in ("body", "subject"):
                    ...
                    block = {
                        ...
                        "schema": message_template_textblock_and_attributes.get("schema"),
                        "uiSchema": message_template_textblock_and_attributes.get("uiSchema"),
                        # from question_view:
