    ...
    def handle(self, *args, **options):
        ...
        while quantity:
            ...
            if created:
                ...
                entry.datetime_added = datetime.datetime.now(timezone.utc) - datetime.timedelta(randint(1, 10))
                entry.last_seen = entry.datetime_added + datetime.timedelta(days=randint(1, entry.cooldown - 1))
                entry.save()
                quantity -= 1
