...
`,_t=(0,r.t)("Datasets can be created from database tables or SQL queries. Select a database table to the left or "),St=(0,r.t)("create dataset from SQL query"),kt=(0,r.t)(" to open SQL Lab. From there you can save the query as a dataset."),Tt=(0,r.t)("Select dataset source"),Ct=(0,r.t)("No table columns"),Et=(0,r.t)("This database table does not contain any data. Please select a different table."),It=(0,r.t)("An Error Occurred"),Pt=(0,r.t)("Unable to load columns for the selected table. Please select a different table."),Kt=t=>{const{hasError:e,tableName:n,hasColumns:l}=t;let i="empty-dataset.svg",r=Tt,o=(0,v.tZ)(a.Fragment,null,_t,(0,v.tZ)("span",{role:"button",onClick:()=>{window.location.href="/superset/sqllab"},tabIndex:0},St),kt);return e?(r=It,o=(0,v.tZ)(a.Fragment,null,Pt),i=void 0):n&&!l&&(i="no-columns.svg",r=Ct,o=(0,v.tZ)(a.Fragment,null,Et)),(0,v.tZ)(Ut,null,(0,v.tZ)(zt,{image:i,title:r,description:o}))};var Dt;!function(t){t.ABSOLUTE="absolute",t.RELATIVE="relative"}(Dt||(Dt={}));const Nt=b.iK.div`
