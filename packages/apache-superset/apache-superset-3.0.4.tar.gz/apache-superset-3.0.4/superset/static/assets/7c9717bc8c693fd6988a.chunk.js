...
`,ua=e=>{var t;let{dashboardId:a,slice:n,actions:i,formData:s,ownState:c,chart:d,user:u,canOverwrite:h,canDownload:p,isStarred:m,sliceName:g,saveDisabled:f,metadata:v}=e;const b=(0,o.I0)(),{latestQueryFormData:y,sliceFormData:_}=d,[S,w]=(0,r.useState)(!1);(0,r.useEffect)((()=>{a&&(async()=>{const{dashboards:e}=v||{},t=a&&e&&e.find((e=>e.id===a));if(t)try{var r;const e=await ue.Z.get({endpoint:`/api/v1/dashboard/${t.id}`}),a=null==e||null==(r=e.json)?void 0:r.result,o=JSON.parse(a.json_metadata),n=o.shared_label_colors||{},i=o.label_colors||{},s={...n,...i},l=Ft.getNamespace();Object.keys(s).forEach((e=>{l.setColor(e,s[e],o.color_scheme)}))}catch(e){O.Z.info((0,l.t)("Unable to retrieve dashboard colors"))}})()}),[]);const x=(0,r.useCallback)((()=>{b((0,re.setSaveChartModalVisibility)(!0))}),[b]),Z=(0,r.useCallback)((e=>{b((0,ae.sliceUpdated)(e))}),[b]),[C,T,k]=(0,sa.gT)(y,p,n,i.redirectSQLLab,(()=>{w(!0)}),c,null==v?void 0:v.dashboards),N=(0,r.useMemo)((()=>{if(!v)return null;const e=[];return e.push({type:ia.pG.DASHBOARDS,title:v.dashboards.length>0?(0,l.tn)("Added to 1 dashboard","Added to %s dashboards",v.dashboards.length,v.dashboards.length):(0,l.t)("Not added to any dashboard"),description:v.dashboards.length>0?(0,l.t)("You can preview the list of dashboards in the chart settings dropdown."):void 0}),e.push({type:ia.pG.LAST_MODIFIED,value:v.changed_on_humanized,modifiedBy:v.changed_by||(0,l.t)("Not available")}),e.push({type:ia.pG.OWNER,createdBy:v.created_by||(0,l.t)("Not available"),owners:v.owners.length>0?v.owners:(0,l.t)("None"),createdOn:v.created_on_humanized}),null!=n&&n.description&&e.push({type:ia.pG.DESCRIPTION,value:null==n?void 0:n.description}),(0,$.tZ)(ia.ZP,{items:e,tooltipPlacement:"bottom"})}),[v,null==n?void 0:n.description]),A=null==n?void 0:n.slice_name;return(0,$.tZ)(r.Fragment,null,(0,$.tZ)(na.u,{editableTitleProps:{title:g,canEdit:!n||h||E()(t=(null==n?void 0:n.owners)||[]).call(t,null==u?void 0:u.userId),onSave:i.updateChartTitle,placeholder:(0,l.t)("Add the name of the chart"),label:(0,l.t)("Chart title")},showTitlePanelItems:!!n,certificatiedBadgeProps:{certifiedBy:null==n?void 0:n.certified_by,details:null==n?void 0:n.certification_details},showFaveStar:!(null==u||!u.userId),faveStarProps:{itemId:null==n?void 0:n.slice_id,fetchFaveStar:i.fetchFaveStar,saveFaveStar:i.saveFaveStar,isStarred:m,showTooltip:!0},titlePanelAdditionalItems:(0,$.tZ)("div",{css:da},_?(0,$.tZ)(ra,{className:"altered",origFormData:{..._,chartTitle:A},currentFormData:{...s,chartTitle:g}}):null,N),rightPanelAdditionalItems:(0,$.tZ)(j.u,{title:f?(0,l.t)("Add required control values to save chart"):null},(0,$.tZ)("div",null,(0,$.tZ)(Ne.Z,{buttonStyle:"secondary",onClick:x,disabled:f,css:ca},(0,$.tZ)(q.Z.SaveOutlined,{iconSize:"l"}),(0,l.t)("Save")))),additionalActionsMenu:C,menuDropdownProps:{visible:T,onVisibleChange:k}}),S&&(0,$.tZ)(oa.Z,{show:S,onHide:()=>{w(!1)},onSave:Z,slice:n}))};ua.propTypes=la;const ha=ua,pa={...Pe.propTypes,actions:A().object.isRequired,datasource_type:A().string.isRequired,dashboardId:A().number,isDatasourceMetaLoading:A().bool.isRequired,chart:Y.$6.isRequired,slice:A().object,sliceName:A().string,controls:A().object.isRequired,forcedHeight:A().string,form_data:A().object.isRequired,standalone:A().bool.isRequired,force:A().bool,timeout:A().number,impressionId:A().string,vizType:A().string,saveAction:A().string,isSaveModalVisible:A().bool},ma=R.iK.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  min-height: 0;
