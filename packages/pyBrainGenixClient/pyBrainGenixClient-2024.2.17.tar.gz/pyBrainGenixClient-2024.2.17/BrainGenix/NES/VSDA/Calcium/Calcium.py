...
class Calcium:
    ...
    # Note that this can be called in a way where you provide a GetRenderStatus
    # function, e.g. see how this is done in VBP/BG_API.py.
    def WaitForRender(self, StatusFunc=self.GetRenderStatus):

        # Setup Status Information
        StatusInfo:dict = StatusFunc() #self.GetRenderStatus()
