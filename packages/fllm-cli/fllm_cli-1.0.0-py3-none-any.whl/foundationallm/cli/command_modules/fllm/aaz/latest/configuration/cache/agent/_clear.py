...
@register_command(
    "configuration cache agent clear",
)
class Clear(AAZCommand):
    ...
    _aaz_info = {
        "version": "1.0",
        "resources": [
            ["mgmt-plane", "/instances/{}/providersx/foundationallm.configuration/caches/agent/clear", "1.0"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ClearAgentCache(ctx=self.ctx)()
    ...
    class ClearAgentCache(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/instances/{instanceId}/providersX/FoundationaLLM.Configuration/caches/agent/clear",
                **self.url_parameters
            )
