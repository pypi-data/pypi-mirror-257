...
helps['cloud'] = """
type: group
short-summary: Manage registered clouds.
"""
...
examples:
  - name: Register a cloud with a config file
    text: |
        fllm cloud register -n MyCloud --cloud-config @"cloud.json"
        ("cloud.json" supports all the endpoint and suffix options in camel case or the JSON output format from `fllm cloud show`. See the example content below.)
        {
...
examples:
  - name: Set the active cloud. (autogenerated)
    text: |
        fllm cloud set --name MyRegisteredCloud
    crafted: true
"""
...
examples:
  - name: Unregister a cloud. (autogenerated)
    text: |
        fllm cloud unregister --name MyRegisteredCloud
    crafted: true
"""
...
examples:
  - name: Update the configuration of a cloud. (autogenerated)
    text: |
        fllm cloud update --profile latest
    crafted: true
"""
