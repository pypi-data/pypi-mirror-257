...
def login(cmd, username=None, password=None, service_principal=None, tenant=None, allow_no_subscriptions=False,
          identity=False, use_device_code=False, use_cert_sn_issuer=None, scopes=None, client_assertion=None, resource=None, client_id=None):
    ...
    if service_principal:
        from foundationallm.cli.core.auth.identity import ServicePrincipalAuth
...
def check_cli(cmd):
    from foundationallm.cli.core.file_util import (
