...
from foundationallm.cli.core.util import shell_safe_json_parse
from foundationallm.cli.core.profiles import API_PROFILES
from foundationallm.cli.core.commands import CliCommandType

from foundationallm.cli.command_modules.cloud._completers import (
    get_cloud_name_completion_list, get_custom_cloud_name_completion_list)
import foundationallm.cli.command_modules.cloud._help  # pylint: disable=unused-import
...
class CloudCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        cloud_custom = CliCommandType(operations_tmpl='foundationallm.cli.command_modules.cloud.custom#{}')
