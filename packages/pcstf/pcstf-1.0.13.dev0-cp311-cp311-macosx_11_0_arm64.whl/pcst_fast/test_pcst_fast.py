...
def test_simple1():
  ...
  costs = [0.8, 1.8, 2.8]
  result_nodes, result_edges = pcstf.pcst_fast(edges, prizes, costs, -1, 1, 'strong', 0)
  #print(result_nodes)
  #print("--------")
  #print(result_edges)
...
def test_simple2():
  ...
  prizes = [0.0, 5.0, 6.0]
  costs = [3.0, 4.0]
  result_nodes, result_edges = pcstf.pcst_fast(edges, prizes, costs, 0, 1, 'none', 0)
...
def test_num_clusters():
  ...
  result_nodes, result_edges = pcstf.pcst_fast(edges, prizes, costs, -1, 2, 'strong' , 0)
