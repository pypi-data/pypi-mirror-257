...
def taxonomysearch(taxon, species_list):
    ...
    if species_set:
        ...
        print("\nNo species data retrieved. Check taxon name is correct\n")
        sys.exit()
...
def getspecies(common_name, latin_name, taxon):
    if common_name:
        ...
        if species_list:
            ...
            print("No species data retrieved.")
    print("")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="List species names from Ensembl by common name, bionomial latin name, or taxon.")
