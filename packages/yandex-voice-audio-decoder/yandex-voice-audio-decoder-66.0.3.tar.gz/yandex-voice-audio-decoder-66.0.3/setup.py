...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-voice-audio-decoder. Maybe you are using the wrong pypi?")


setup(
    name='yandex-voice-audio-decoder',
    version='66.0.3',
    author='Yandex',
