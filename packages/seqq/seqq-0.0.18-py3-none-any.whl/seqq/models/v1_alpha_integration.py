...
T = TypeVar("T", bound="V1AlphaIntegration")


@_attrs_define
class V1AlphaIntegration:
    """Integrations instruct seqq to import Sequences from external sources.

    Attributes:
        collection (str): The name of the Collection that the Integration imports Sequences to. Format is
            `collections/{collection_id}`.
        name (Union[Unset, str]): A globally unique name of the Integration. Format is
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_alpha_integration.additional_properties = d
        return v1_alpha_integration
