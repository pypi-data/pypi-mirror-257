...
class GetChat:
    async def get_chat(
        self: "team.Client", chat_id: Union[int, str]
        ...
        Returns:
            :obj:`~team.types.Chat` | :obj:`~team.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
