...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~team.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~team.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~team.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "team". Get the first 50 results
                async for message in app.search_global("team", limit=50):
                    print(message.text)
