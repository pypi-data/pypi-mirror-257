...
import team
from team import enums, raw, types, utils
from team.errors import MessageIdsEmpty, PeerIdInvalid
from team.parser import Parser
from team.parser import utils as parser_utils
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~team.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~team.types.Chat`, *optional*):
        ...
        chat (:obj:`~team.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~team.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~team.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~team.types.Message`, *optional*):
        ...
        service (:obj:`~team.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~team.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~team.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~team.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~team.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~team.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~team.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~team.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~team.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~team.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~team.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~team.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~team.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~team.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~team.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~team.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~team.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~team.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~team.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~team.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~team.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~team.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~team.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~team.types.GameHighScore`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <team.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~team.filters.command`.

        video_chat_scheduled (:obj:`~team.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~team.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~team.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~team.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~team.types.WebAppData`, *optional*):
            Service message: web app data sent to the bot.

        reply_markup (:obj:`~team.types.InlineKeyboardMarkup` | :obj:`~team.types.ReplyKeyboardMarkup` | :obj:`~team.types.ReplyKeyboardRemove` | :obj:`~team.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~team.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~team.types.Message`.
        ...
        Returns:
            List of :obj:`~team.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~team.types.Message`.
        ...
        Parameters:
            ...
            parse_mode (:obj:`~team.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            entities (List of :obj:`~team.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~team.types.Message`.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~team.types.MessageEntity`):
        ...
        Returns:
            On success, the sent :obj:`~team.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~team.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~team.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~team.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~team.types.Message`.

        Use as a shortcut for:

        .. code-block:: python

            from team import enums
        ...
        Parameters:
            action (:obj:`~team.enums.ChatAction`):
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~team.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~team.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~team.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~team.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~team.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~team.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~team.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~team.types.InputMediaPhoto` or
                :obj:`~team.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~team.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~team.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~team.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~team.enums.PollType`, *optional*):
                Poll type, :obj:`~team.enums.PollType.QUIZ` or :obj:`~team.enums.PollType.REGULAR`.
                Defaults to :obj:`~team.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~team.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~team.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~team.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~team.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~team.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~team.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~team.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~team.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~team.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~team.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~team.types.Message`.
        ...
        Parameters:
            media (:obj:`~team.types.InputMedia`):
    ...
    async def edit_reply_markup(
        ...
        """Bound method *edit_reply_markup* of :obj:`~team.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~team.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~team.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~team.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~team.types.Message`.
        ...
        Returns:
            :obj:`~team.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~team.types.Message`.
    ...
    async def click(
        ...
        """Bound method *click* of :obj:`~team.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~team.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~team.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~team.types.Message`.
        ...
        Returns:
            :obj:`~team.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~team.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~team.types.Message`.
        ...
        Returns:
            :obj:`~team.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(
        ...
        """Bound method *pin* of :obj:`~team.types.Message`.
        ...
        Returns:
            :obj:`~team.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~team.types.Message`.
