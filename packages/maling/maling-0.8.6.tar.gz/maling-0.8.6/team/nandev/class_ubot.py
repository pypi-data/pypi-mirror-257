...
from .class_emoji import Emojii
...
class Userbot(Client):
    ...
    def pong(self):
        ...
        return pong
    def proses(self):
        proses = self.emo.proses
        return proses
    def sukses(self):
        sukses = self.emo.sukses
        return sukses
    def gagal(self):
        gagal = self.emo.gagal
        return gagal
    def profil(self):
        profil = self.emo.profil
        return profil
    def alive(self):
        alive = self.emo.alive
        return alive
    def warn(self):
        warn = self.emo.warn
        return warn
    def block(self):
        block = self.emo.block
        return block
