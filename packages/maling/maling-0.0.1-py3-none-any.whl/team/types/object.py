...
class Object:
    def __init__(self, client: "team.Client" = None):
        self._client = client

    def bind(self, client: "team.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~team.types.Client`):
