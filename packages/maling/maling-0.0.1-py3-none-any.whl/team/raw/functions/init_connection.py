...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~team.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <team.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <team.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~team.raw.types`
    """
