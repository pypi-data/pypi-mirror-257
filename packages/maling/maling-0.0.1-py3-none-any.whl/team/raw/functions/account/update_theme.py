...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        theme (:obj:`InputTheme <team.raw.base.InputTheme>`):
            N/A
        ...
        document (:obj:`InputDocument <team.raw.base.InputDocument>`, *optional*):
            N/A

        settings (List of :obj:`InputThemeSettings <team.raw.base.InputThemeSettings>`, *optional*):
            N/A

    Returns:
        :obj:`Theme <team.raw.base.Theme>`
    """
