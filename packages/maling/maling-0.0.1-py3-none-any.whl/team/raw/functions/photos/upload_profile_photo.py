...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <team.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <team.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <team.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <team.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <team.raw.base.photos.Photo>`
    """
