...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Parameters:
        file (:obj:`InputFile <team.raw.base.InputFile>`):
            N/A
        ...
        thumb (:obj:`InputFile <team.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <team.raw.base.InputDocument>`, *optional*):
            N/A
