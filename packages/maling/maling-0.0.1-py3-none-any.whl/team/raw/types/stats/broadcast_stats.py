...
class BroadcastStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.stats.BroadcastStats`.
    ...
    Parameters:
        ...
        followers (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_post (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_post (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        enabled_notifications (:obj:`StatsPercentValue <team.raw.base.StatsPercentValue>`):
            N/A

        growth_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        followers_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        mute_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        interactions_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        iv_interactions_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        views_by_source_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        new_followers_by_source_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        recent_message_interactions (List of :obj:`MessageInteractionCounters <team.raw.base.MessageInteractionCounters>`):
            N/A
