...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <team.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <team.raw.base.Reaction>`, *optional*):
            N/A
