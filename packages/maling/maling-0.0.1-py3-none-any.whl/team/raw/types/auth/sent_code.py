...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <team.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <team.raw.base.auth.CodeType>`, *optional*):
            N/A
