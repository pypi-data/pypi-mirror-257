...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <team.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <team.raw.base.InputWebDocument>`, *optional*):
            N/A

        start_param (``str``, *optional*):
            N/A

        extended_media (:obj:`InputMedia <team.raw.base.InputMedia>`, *optional*):
            N/A
