...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <team.raw.base.SearchResultsCalendarPeriod>`):
            N/A
