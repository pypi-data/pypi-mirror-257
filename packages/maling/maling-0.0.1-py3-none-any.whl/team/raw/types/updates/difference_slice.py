...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <team.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <team.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <team.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <team.raw.base.updates.State>`):
            N/A
