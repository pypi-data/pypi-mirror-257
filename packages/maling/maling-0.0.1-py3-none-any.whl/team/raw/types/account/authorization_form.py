...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <team.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <team.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <team.raw.base.SecureValueError>`):
            N/A
