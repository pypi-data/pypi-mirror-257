...
from team.types import (CallbackQuery, InlineKeyboardMarkup, InlineQuery,
                        Message, ReplyKeyboardMarkup, Update)


class Filter:
    async def __call__(self, client: "team.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~team.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~team.handlers.MessageHandler` the *update* argument will be a :obj:`~team.types.Message`; in a :obj:`~team.handlers.CallbackQueryHandler` the *update* will be a :obj:`~team.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~team.filters.command` or :meth:`~team.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~team.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~team.types.Document` objects."""
...
"""Filter messages that contain :obj:`~team.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~team.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~team.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~team.types.Game` objects."""
...
"""Filter messages that contain :obj:`~team.types.Video` objects."""
...
"""Filter messages that contain :obj:`~team.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~team.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~team.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~team.types.Location` objects."""
...
"""Filter messages that contain :obj:`~team.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~team.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~team.types.Dice` objects."""
...
def command(
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~team.types.Message`.
    ...
    async def func(flt, client: team.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~team.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~team.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~team.types.InlineQuery`: The filter will match ``query``.
