...
class Chat(Object):
    ...
    Parameters:
        ...
        bio (``str``, *optional*):
            ...
            Returned only in :meth:`~team.Client.get_chat`.
        ...
        permissions (:obj:`~team.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~team.Client.get_nearby_chats`.

        linked_chat (:obj:`~team.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~team.Client.get_chat`.

        send_as_chat (:obj:`~team.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~team.Client.get_chat`.

        available_reactions (:obj:`~team.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~team.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~team.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~team.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~team.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~team.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~team.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~team.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~team.types.Chat`.
        ...
        Returns:
            :obj:`~team.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(self, user_id: Union[int, str]) -> bool:
        """Bound method *unban_member* of :obj:`~team.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~team.types.ChatPermissions`):
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~team.types.Chat`.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~team.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~team.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~team.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~team.types.Chat`.
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~team.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~team.enums.ChatMembersFilter.SEARCH`,
                :obj:`~team.enums.ChatMembersFilter.BANNED` and :obj:`~team.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~team.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~team.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~team.types.Chat`.
    ...
    async def mark_unread(
        ...
        """Bound method *mark_unread* of :obj:`~team.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~team.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~team.types.Chat`.
