...
import team
from team.methods.utilities.idle import idle


class Run:
    def run(self: "team.Client", coroutine=None):
        """Start the client, idle the main script and finally stop the client.

        When calling this method without any argument it acts as a convenience method that calls
        :meth:`~team.Client.start`, :meth:`~team.idle` and :meth:`~team.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`team.compose`.
