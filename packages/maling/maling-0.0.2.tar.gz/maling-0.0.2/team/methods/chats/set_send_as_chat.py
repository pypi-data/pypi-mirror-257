...
class SetSendAsChat:
    async def set_send_as_chat(
        self: "team.Client", chat_id: Union[int, str], send_as_chat_id: Union[int, str]
    ) -> bool:
        """Set the default "send_as" chat for a chat.

        Use :meth:`~team.Client.get_send_as_chats` to get all the "send_as" chats available for use.
