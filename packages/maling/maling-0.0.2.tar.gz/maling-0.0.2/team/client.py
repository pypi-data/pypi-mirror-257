...
import team
from team import __license__, __version__, enums, raw, utils
from team.crypto import aes
from team.errors import (BadRequest, CDNFileHashMismatch, ChannelPrivate,
                         SessionPasswordNeeded, VolumeLocNotFound)
from team.handlers.handler import Handler
from team.methods import Methods
from team.session import Auth, Session
from team.storage import FileStorage, MemoryStorage
from team.types import TermsOfService, User
from team.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~team.Client.export_session_string` before stopping the client to get a session string you can
    ...
    APP_VERSION = f"Mix-Userbot {__version__}"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~team.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError(
                    ...
                    "More info: https://docs.team.org/start/auth"
                )
