...
from team.crypto import aes, prime, rsa
from team.errors import SecurityCheckMismatch
from team.raw.core import Int, Long, TLObject
...
class Auth:
    ...
    def __init__(self, client: "team.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
