...
class Emojii:
    def initialize(self):
        self.ping_var = (
            udB.get_var(self, "emo_ping") or "5269563867305879894"
        )
        self.emo_ping = (
        ...
        self.pong_var = (
            udB.get_var(self, "emo_pong") or "6183961455436498818"
        )
        self.emo_pong = (
        ...
        self.proses_var = (
            udB.get_var(self, "emo_proses") or "5974326532670230199"
        )
        self.emo_proses = (
            self.proses_var
        ...
        self.sukses_var = (
            udB.get_var(self, "emo_sukses") or "5021905410089550576"
        )
        self.emo_sukses = (
            self.sukses_var
        ...
        self.gagal_var = (
            udB.get_var(self, "emo_gagal") or "5019523782004441717"
        )
        self.emo_gagal = (
        ...
        self.profil_var = (
            udB.get_var(self, "emo_profil") or "5373012449597335010"
        )
        self.emo_profil = (
            self.profil_var
        ...
        self.alive_var = (
            udB.get_var(self, "emo_alive") or "4934091419288601395"
        )
        self.emo_alive = (
            self.alive_var if isinstance(self.alive_var, int) else str(self.alive_var)
        )
        self.warn_var = (
            udB.get_var(self, "emo_warn") or "6172475875368373616"
        )
        self.emo_warn = (
            self.warn_var if isinstance(self.warn_var, int) else str(self.warn_var)
        )
        self.block_var = (
            udB.get_var(self, "emo_block") or "5240241223632954241"
        )
        self.emo_block = (
