...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~team.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~team.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~team.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~team.types.CallbackGame`, *optional*):
