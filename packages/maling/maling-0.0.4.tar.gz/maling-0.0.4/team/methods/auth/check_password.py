...
from team.utils import compute_password_check

log = logging.getLogger(__name__)


class CheckPassword:
    async def check_password(self: "team.Client", password: str) -> "types.User":
        ...
        Returns:
            :obj:`~team.types.User`: On success, the authorized user is returned.
