...
class Emojii:
    ...
    def initialize(self):
        self.ping_var = udB.get_var(self.user_id, "emo_ping") or "5269563867305879894"
        self.emo_ping = (
            self.ping_var if isinstance(self.ping_var, int) else str(self.ping_var)
        )

        self.pong_var = udB.get_var(self.user_id, "emo_pong") or "6183961455436498818"
        self.emo_pong = (
        ...
        self.gagal_var = udB.get_var(self.user_id, "emo_gagal") or "5019523782004441717"
        self.emo_gagal = (
        ...
        self.alive_var = udB.get_var(self.user_id, "emo_alive") or "4934091419288601395"
        self.emo_alive = (
