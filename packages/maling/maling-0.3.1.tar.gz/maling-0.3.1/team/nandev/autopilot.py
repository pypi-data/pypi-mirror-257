...
async def autobot():
    ...
    if token:
        ...
        #with open(".env", "r") as f:
            #for toket in f:
                #if toket.startswith("bot_token="):
                    #adaga = True
                    #continue
                #newtoket.append(toket)
        #newtoket.append(f"bot_token={token}\n")
        #with open(".env", "w") as f:
            #f.writelines(newtoket)
