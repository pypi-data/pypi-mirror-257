...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~team.types.Message`: On success, the sent text message is returned.
        ...
        Example:
            .. code-block:: python
                ...
                await app.send_message("me", "https://docs.team.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.team.org")]
                        ]))
        """
