...
class AnswerWebAppQuery:
    async def answer_web_app_query(
        self: "team.Client", web_app_query_id: str, result: "types.InlineQueryResult"
        ...
        Parameters:
            ...
            result (:obj:`~team.types.InlineQueryResult`):
                A list of results for the inline query.

        Returns:
            :obj:`~team.types.SentWebAppMessage`: On success the sent web app message is returned.
        """
