...
class Restart:
    async def restart(self: "team.Client", block: bool = True):
        """Restart the Client.

        This method will first call :meth:`~team.Client.stop` and then :meth:`~team.Client.start` in a row in
        ...
        Returns:
            :obj:`~team.Client`: The restarted client itself.
