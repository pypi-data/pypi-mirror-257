...
class OnChosenInlineResult:
    def on_chosen_inline_result(self=None, filters=None, group: int = 0) -> Callable:
        ...
        :obj:`~team.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~team.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, team.Client):
                self.add_handler(
                    team.handlers.ChosenInlineResultHandler(func, filters), group
                )
                ...
                func.handlers.append(
                    (
                        team.handlers.ChosenInlineResultHandler(func, self),
