...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <team.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <team.raw.base.ThemeSettings>`, *optional*):
            N/A
