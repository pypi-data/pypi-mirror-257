...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <team.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <team.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <team.raw.base.InlineBotWebView>`, *optional*):
            N/A
