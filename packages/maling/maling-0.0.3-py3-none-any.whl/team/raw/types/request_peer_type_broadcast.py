...
class RequestPeerTypeBroadcast(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.RequestPeerType`.
    ...
    Parameters:
        ...
        user_admin_rights (:obj:`ChatAdminRights <team.raw.base.ChatAdminRights>`, *optional*):
            N/A

        bot_admin_rights (:obj:`ChatAdminRights <team.raw.base.ChatAdminRights>`, *optional*):
            N/A
