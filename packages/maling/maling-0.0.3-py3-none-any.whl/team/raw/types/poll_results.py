...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <team.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <team.raw.base.MessageEntity>`, *optional*):
            N/A
