...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <team.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <team.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <team.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <team.raw.base.AutoSaveException>`):
            N/A
