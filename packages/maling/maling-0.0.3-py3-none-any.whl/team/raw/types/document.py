...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.Document`.
    ...
    Parameters:
        ...
        attributes (List of :obj:`DocumentAttribute <team.raw.base.DocumentAttribute>`):
            N/A

        thumbs (List of :obj:`PhotoSize <team.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <team.raw.base.VideoSize>`, *optional*):
            N/A
