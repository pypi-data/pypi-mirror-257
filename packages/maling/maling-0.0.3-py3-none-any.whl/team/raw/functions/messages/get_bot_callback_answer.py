...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        password (:obj:`InputCheckPasswordSRP <team.raw.base.InputCheckPasswordSRP>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotCallbackAnswer <team.raw.base.messages.BotCallbackAnswer>`
    """
