...
class Userbot(Client):
    ...
    def ping(self):
        ping = self.emojii["ping"]()
        return ping
    def pong(self):
        pong = self.emojii["pong"]()
        return pong
    def proses(self):
        proses = self.emojii["proses"]()
        return proses
    def sukses(self):
        sukses = self.emojii["sukses"]()
        return sukses
    def gagal(self):
        gagal = self.emojii["sukses"]()
        return gagal
    def profil(self):
        profil = self.emojii["profil"]()
        return profil
    def alive(self):
        alive = self.emojii["alive"]()
        return alive
    def warn(self):
        warn = self.emojii["warn"]()
        return warn
    def block(self):
        block = self.emojii["block"]()
        return block
