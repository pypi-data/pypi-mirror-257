...
class GetChatInviteLinkJoiners:
    async def get_chat_invite_link_joiners(
        self: "team.Client", chat_id: Union[int, str], invite_link: str, limit: int = 0
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~team.types.ChatJoiner` objects.

        Yields:
            :obj:`~team.types.ChatJoiner` objects.
        """
        current = 0
