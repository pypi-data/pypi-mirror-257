...
class SetChatUsername:
    async def set_chat_username(
        self: "team.Client", chat_id: Union[int, str], username: Optional[str]
    ) -> bool:
        """Set a channel or a supergroup username.

        To set your own username (for users only, not bots) you can use :meth:`~team.Client.set_username`.
