...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        value_hashes (List of :obj:`SecureValueHash <team.raw.base.SecureValueHash>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <team.raw.base.SecureCredentialsEncrypted>`):
            N/A
