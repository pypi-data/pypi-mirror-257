...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <team.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <team.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <team.raw.base.payments.ValidatedRequestedInfo>`
    """
