...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <team.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <team.raw.base.MessagePeerReaction>`, *optional*):
            N/A
