...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <team.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <team.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <team.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <team.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <team.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <team.raw.base.StatsGroupTopInviter>`):
            N/A
