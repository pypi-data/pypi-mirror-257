...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <team.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <team.raw.base.VideoSize>`, *optional*):
            N/A
