...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <team.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <team.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <team.raw.base.InputPeer>`):
            N/A
