...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <team.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <team.raw.base.PhoneConnection>`):
            N/A
