...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <team.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <team.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <team.raw.base.PremiumSubscriptionOption>`):
            N/A
