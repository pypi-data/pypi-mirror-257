...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <team.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <team.raw.base.AttachMenuBotIcon>`):
            N/A
