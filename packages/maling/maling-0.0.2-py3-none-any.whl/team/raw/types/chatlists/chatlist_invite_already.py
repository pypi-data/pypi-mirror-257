...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~team.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <team.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <team.raw.base.Peer>`):
            N/A
