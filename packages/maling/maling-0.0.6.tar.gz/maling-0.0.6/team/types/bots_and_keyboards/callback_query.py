...
import team
from team import enums, raw, types
...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~team.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <team.Filters.regex>`.
    """
    ...
    @staticmethod
    async def _parse(client: "team.Client", callback_query, users) -> "CallbackQuery":
        message = None
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~team.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~team.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~team.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~team.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~team.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~team.types.CallbackQuery`.
