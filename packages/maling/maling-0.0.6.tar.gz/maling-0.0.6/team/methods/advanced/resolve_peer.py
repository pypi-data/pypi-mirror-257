...
from team.errors import PeerIdInvalid
...
class ResolvePeer:
    async def resolve_peer(
        self: "team.Client", peer_id: Union[int, str]
        ...
        .. note::
            ...
            :obj:`functions <team.api.functions>` (i.e: a Telegram API method you wish to use which is not
