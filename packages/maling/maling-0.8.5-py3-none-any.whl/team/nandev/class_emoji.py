...
async def load_emo(c):
    ...
    a = udB.get_var(c, "emo_ping")
    b = udB.get_var(c, "emo_pong")
    c = udB.get_var(c, "emo_proses")
    d = udB.get_var(c, "emo_gagal")
    e = udB.get_var(c, "emo_sukses")
    f = udB.get_var(c, "emo_profil")
    g = udB.get_var(c, "emo_alive")
    h = udB.get_var(c, "emo_warn")
    i = udB.get_var(c, "emo_block")
    uprem = user.me.is_premium
    if uprem == True:
        if (a, b, c, d, e, f, g, h, i) is not None:
            return
        else:
            udB.set_var(c, "emo_ping", ping_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_pong", pong_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_proses", proses_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_gagal", gagal_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_sukses", sukses_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_profil", profil_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_alive", alive_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_warn", warn_id)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_block", block_id)
    elif uprem == False:
        if (a, b, c, d, e, f, g, h, i) is not None:
            return
        else:
            udB.set_var(c, "emo_ping", eping)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_pong", epong)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_proses", eproses)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_gagal", egagal)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_sukses", esukses)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_profil", eprofil)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_alive", ealive)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_warn", ewarn)
            await asyncio.sleep(0.5)
            udB.set_var(c, "emo_block", eblock)
