...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~team.types.InputMediaPhoto`, :obj:`~team.types.InputMediaVideo`, :obj:`~team.types.InputMediaAudio` and :obj:`~team.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~team.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from team.types import InputMediaPhoto, InputMediaVideo
