...
import team
from team import StopTransmission, enums, raw, types, utils
from team.errors import FilePartMissing
from team.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~team.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~team.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~team.Client.stop_transmission`, None is returned.
