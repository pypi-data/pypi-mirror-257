...
def compile_Kernels(thr):
    ...
    program = thr.compile(open(path/"GPU_Kernels/SubMeanNormalize.cl").read())
    GPU.SubMeanNormalize = program.SubMeanNormalize
...
def processing(img1_name, img2_name, thr):
    ...
    for i in range(0,Parameters.no_iter_1):
        ...
        # Normalize
        GPU.SubMeanNormalize(GPU.subImg1_1, GPU.data1,
                local_size = None, global_size = N_boxes_1)
        GPU.SubMeanNormalize(GPU.subImg1_2, GPU.data1,
                local_size = None, global_size = N_boxes_1)
    ...
    for i in range(0,Parameters.no_iter_2):
        ...
        # Normalize
        GPU.SubMeanNormalize(GPU.subImg2_1, GPU.data2,
               local_size = None, global_size = N_boxes_2)
        GPU.SubMeanNormalize(GPU.subImg2_2, GPU.data2,
                local_size = None, global_size = N_boxes_2)
