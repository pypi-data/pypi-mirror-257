...
class CogFramework:
    ...
    def __init__(self):
        ...
        """
        kfp.dsl._container_op.Container.AddModelAccess=AddModelAccess
        kfp.dsl._container_op.ContainerOp.AddModelAccess=AddModelAccess
        kfp.dsl.structures.TaskSpec.AddModelAccess=AddModelAccess
    ...
    def Serve_Model(model_uri:str,name:str):
        """
