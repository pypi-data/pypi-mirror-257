...
class Client(Client):
    ...
    remarks2 = models.TextField(_("Remarks (Social Office)"),
                                blank=True,
                                editable=False)
    ...
    health_insurance = dd.ForeignKey('contacts.Company',
                                     blank=True,
                                     null=True,
                                     verbose_name=_("Health insurance"),
                                     related_name='health_insurance_for')
    pharmacy = dd.ForeignKey('contacts.Company',
                             blank=True,
                             null=True,
    ...
    income_rente = models.BooleanField(_("retirement pension"),
                                       default=False)  # Rente
    # Andere Einkommen
    income_misc = models.BooleanField(_("other incomes"), default=False)

    job_agents = models.CharField(
        max_length=100,
    ...
    def on_analyze(cls, site):
        ...
        cls.declare_imported_fields('''remarks2
