...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package conductor_client.nbryskin. Maybe you are using the wrong pypi?")


setup(
    name='conductor_client.nbryskin',
    version='66.0.3',
    author='Yandex',
