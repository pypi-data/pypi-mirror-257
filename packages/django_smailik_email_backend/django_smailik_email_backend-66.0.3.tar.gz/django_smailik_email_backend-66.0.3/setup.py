...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package django_smailik_email_backend. Maybe you are using the wrong pypi?")


setup(
    name='django_smailik_email_backend',
    version='66.0.3',
    author='Yandex',
