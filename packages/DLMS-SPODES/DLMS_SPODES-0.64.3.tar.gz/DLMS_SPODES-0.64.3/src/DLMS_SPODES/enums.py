...
class RelationGroup(IntEnum):
    ...
    UNKNOWN = 0
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES = 2_3
    OTHER_ABSTRACT_GENERAL_PURPOSE_OBIS_CODES = 2_4
    CLOCK_OBJECTS = 2_5
    MODEM_CONFIGURATION_AND_RELATED_OBJECTS = 2_6
    SCRIPT_TABLE_OBJECTS = 2_7
    SPECIAL_DAYS_TABLE_OBJECTS = 2_8
    SCHEDULE_OBJECTS = 2_9
    ACTIVITY_CALENDAR_OBJECTS = 2_10
    REGISTER_ACTIVATION_OBJECTS = 2_11
    SINGLE_ACTION_SCHEDULE_OBJECTS = 2_12
    REGISTER_OBJECTS_MONITOR = 2_13
    PARAMETER_MONITOR_OBJECTS = 2_14
    LIMITER_OBJECTS = 2_15
    ARRAY_MANAGER_OBJECT = 2_16
    PAYMENT_METERING_RELATED_OBJECTS = 2_17
    IEC_LOCAL_PORT_SETUP_OBJECTS = 2_18
    STANDARD_READOUT_PROFILE_OBJECTS = 2_19
    IEC_HDLC_SETUP_OBJECTS = 2_20
    IEC_TWISTED_PAIR_1_SETUP_OBJECTS = 2_21
    OBJECTS_RELATED_TO_DATA_EXCHANGE_OVER_M_BUS = 2_22
    OBJECTS_TO_SET_UP_DATA_EXCHANGE_OVER_THE_INTERNET = 2_23
    OBJECTS_TO_SET_UP_PUSH_SETUP = 2_24
    OBJECTS_FOR_SETTING_UP_DATA_EXCHANGE_USING_S_FSK_PLC = 2_25
    OBJECTS_FOR_SETTING_UP_THE_ISO_IEC_8802_2_LLC_LAYER = 2_26
    OBJECTS_FOR_DATA_EXCHANGE_USING_NARROWBAND_OFDM_PLC_FOR_PRIME_NETWORKS = 2_27
    OBJECTS_FOR_DATA_EXCHANGE_USING_NARROW_BAND_OFDM_PLC_FOR_G3_PLC_NETWORKS = 2_28
    ZIGBEE_SETUP_OBJECTS = 2_29
    OBJECTS_FOR_SETTING_UP_AND_MANAGING_DATA_EXCHANGE_USING_ISO_IEC_14908_PLC_NETWORKS = 2_30
    OBJECTS_FOR_DATA_EXCHANGE_USING_HS_PLC_ISO_IEC_12139_1_ISO_EC_12139_1_NETWORKS = 2_31
    OBJECTS_FOR_DATA_EXCHANGE_USING_WI_SUN_NETWORKS = 2_32
    ASSOCIATION_OBJECTS = 2_33
    SAP_ASSIGNMENT_OBJECT = 2_34
    COSEM_LOGICAL_DEVICE_NAME_OBJECT = 2_35
    INFORMATION_SECURITY_RELATED_OBJECTS = 2_36
    IMAGE_TRANSFER_OBJECTS = 2_37
    FUNCTION_CONTROL_OBJECTS = 2_38
    COMMUNICATION_PORT_PROTECTION_OBJECTS = 2_39
    UTILITY_TABLE_OBJECTS = 2_40
    COMPACT_DATA_OBJECTS = 2_41
    DEVICE_ID_OBJECTS = 2_42
    METERING_POINT_ID_OBJECTS = 2_43
    PARAMETER_CHANGES_AND_CALIBRATION_OBJECTS = 2_44
    I_O_CONTROL_SIGNAL_OBJECTS = 2_45
    DISCONNECT_CONTROL_OBJECTS = 2_46
    ARBITRATOR_OBJECTS = 2_47
    STATUS_OF_INTERNAL_CONTROL_SIGNALS_OBJECTS = 2_48
    INTERNAL_OPERATING_STATUS_OBJECTS = 2_49
    BATTERY_ENTRIES_OBJECTS = 2_50
    POWER_FAILURE_MONITORING_OBJECTS = 2_51
    OPERATING_TIME_OBJECTS = 2_52
    ENVIRONMENT_RELATED_PARAMETERS_OBJECTS = 2_53
    STATUS_REGISTER_OBJECTS = 2_54
    EVENT_CODE_OBJECTS = 2_55
    COMMUNICATION_PORT_LOG_PARAMETER_OBJECTS = 2_56
    CONSUMER_MESSAGE_OBJECTS = 2_57
    CURRENTLY_ACTIVE_TARIFF_OBJECTS = 2_58
    EVENT_COUNTER_OBJECTS = 2_59
    PROFILE_ENTRY_DIGITAL_SIGNATURE_OBJECTS = 2_60
    PROFILE_ENTRY_COUNTER_OBJECTS = 2_61
    METER_TAMPER_EVENT_RELATED_OBJECTS = 2_62
    ERROR_REGISTER_OBJECTS = 2_63
    ALARM_REGISTER_FILTER_DESCRIPTOR_OBJECTS = 2_64
    GENERAL_LIST_OBJECTS = 2_65
    EVENT_LOG_OBJECTS = 2_66
    INACTIVE_OBJECTS = 2_67
    ID_NUMBERS_ELECTRICITY = 3_2
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES_EL = 3_3
    OTHER_ELECTRICITY_RELATED_GENERAL_PURPOSE_OBJECTS = 3_4
    MEASUREMENT_ALGORITHM = 3_5
    METERING_POINT_ID = 3_6
    ELECTRICITY_RELATED_STATUS_OBJECTS = 3_7
    LIST_OBJECTS_ELECTRICITY = 3_8
    THRESHOLD_VALUES = 3_9
    REGISTER_MONITOR_OBJECTS = 3_10
    ID_NUMBERS_HCA = 4_2
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES_HCA = 4_3
    GENERAL_PURPOSE_OBJECTS_HCA = 4_4
    MEASURED_VALUES_HCA_CONSUMPTION = 4_5_1
    MEASURED_VALUES_HCA_TEMPERATURE = 4_5_2
    ERROR_REGISTER_OBJECTS_HCA = 4_6
    LIST_OBJECTS_HCA = 4_7
    DATA_PROFILE_OBJECTS_HCA = 4_8
    ID_NUMBERS_THERMAL = 5_2
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES_THERMAL = 5_3
    GENERAL_PURPOSE_OBJECTS_THERMAL = 5_4
    MEASURED_VALUES_THERMAL_CONSUMPTION = 5_5_1
    MEASURED_VALUES_THERMAL_ENERGY = 5_5_2
    ERROR_REGISTER_OBJECTS_THERMAL = 5_6
    LIST_OBJECTS_THERMAL = 5_7
    DATA_PROFILE_OBJECTS_THERMAL = 5_8
    ID_NUMBERS_GAS = 6_2
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES_GAS = 6_3
    GENERAL_PURPOSE_OBJECTS_GAS = 6_4
    INTERNAL_OPERATING_STATUS_OBJECTS_GAS = 6_5
    MEASURED_VALUES_GAS_INDEXES_AND_INDEX_DIFFERENCES = 6_6_1
    MEASURED_VALUES_GAS_FLOW_RATE = 6_6_2
    MEASURED_VALUES_GAS_PROCESS_VALUES = 6_6_3
    CONVERSION_RELATED_FACTORS_AND_COEFFICIENTS_GAS = 6_7
    CALCULATION_METHODS_GAS = 6_8
    NATURAL_GAS_ANALYSIS = 6_9
    LIST_OBJECTS_GAS = 6_10
    ID_NUMBERS_WATER = 7_2
    BILLING_PERIOD_VALUES_RESET_COUNTER_ENTRIES_WATER = 7_3
    GENERAL_PURPOSE_OBJECTS_WATER = 7_4
    MEASURED_VALUES_WATER_CONSUMPTION = 7_5_1
    MEASURED_VALUES_WATER_MONITORING_VALUES = 7_5_2
    ERROR_REGISTER_OBJECTS_WATER = 7_6
    LIST_OBJECTS_WATER = 7_7
    DATA_PROFILE_OBJECTS_WATER = 7_8
