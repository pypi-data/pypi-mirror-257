import argparse
from mupy.mutation.finders.arith_op_finders import find_arithmetic_operators
from mupy.mutation.finders.bool_op_finders import find_bool_operators
from mupy.mutation.finders.comp_op_finders import find_comparison_operators
from mupy.mutation.finders.const_finders import find_constants
...
from mupy.mutation.finders import *
...
def main():
    ...
    is_server_mode = (not args.program_path) or (args.program_path.lower() == 'web')
