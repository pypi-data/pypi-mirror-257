...
from bluecat_libraries.address_manager import version as _ver
...
class Client:
    ...
    @property
    def bam_version(self) -> Optional[_ver.Version]:
        """
        ...
        :return: A version or ``None`` if the client is not authenticated yet.
        """
        if self.system_version:
            return _ver.parse_version(self.system_version)
        return None
