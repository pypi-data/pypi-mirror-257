...
__all__ = ['T', 'G', 'D', 'P', 'adata', 'adatas', 'array', 'artist', 'augmenter', 'bool01', 'boolic', 'boolindex', 'bools',
           ...
           'vidcap', 'ziplong', 'Bool01', 'BoolFunc', 'BoolCall', 'BoolCalls', 'BoolFuncQ', 'BoolCallQ', 'Numeric',
           'Numbers', 'NumStr', 'EmptyString', 'NotEmptyEmptyString', 'StrTmpl', 'StrLike', 'Pttn', 'PttnDict',
           'StrBytes', 'NotStrBytes', 'DocGen', 'PathType', 'PathLike', 'DirPath', 'DirNames', 'FileNames', 'WalkTuple',
           'WalkParts', 'EnumAuto', 'EnumDict', 'EnumMember', 'Intum', 'Strum', 'Inhum', 'ByteLike', 'Literals',
           'TypingLike', 'GuardLike', 'Module', 'Loader', 'ModuleSpec', 'Sig', 'Param', 'Logger', 'ArgsType',
           'SysExcInfoType', 'FormatStyle', 'ClsInt', 'ClsSet', 'ClsStr', 'ClsObj', 'ClsBool', 'ClsBoolish', 'ClsCall',
           'ClsType', 'ClsList', 'ClsFloat', 'ClsNumber', 'ClsComplex', 'TypeLike', 'GuardFunc', 'TypeDesc', 'StrGuard',
           'IterStr', 'IterNum', 'IterBool', 'ListStr', 'ListNum', 'ListBool', 'Strs', 'Nums', 'Bools', 'SetStr',
           'SetNum', 'SetBool', 'SliceSpec', 'SliceSpecs', 'Slc', 'Slcs', 'RichTree', 'RichText', 'RichCons',
           'RichProg', 'RichTask', 'TQDM', 'Axes', 'ColorMap', 'CBarPos', 'Grid', 'TyperApp', 'Adata', 'Adatas',
           'AnnData', 'AnnDatas', 'Size', 'DType', 'TType', 'TrcType', 'TorchType', 'TorchDType', 'DataType', 'Tens',
           'Tensor', 'TrcTensor', 'NanTensor', 'IntTens', 'BoolTens', 'FloatTens', 'IntTensor', 'BoolTensor',
           'FloatTensor', 'Device', 'TorchLayer', 'TorchModule', 'Dataset', 'DataLoader', 'DataModule', 'PILImage',
           'Img', 'Image', 'ImageLike', 'ImageSize', 'ImgSize', 'CV2VidCap', 'Video', 'VideoCapture', 'VidCap',
           'VideoSize', 'VidSize', 'Coordinate', 'Coord', 'Point', 'XYPos', 'Width', 'Height', 'Rect', 'BBox',
...
from ltyp import (
    itertype,
    npbool, boolic, bool01, iterbool, bools, 
    intq, ints, floatq, floats, real, realq, reals, num, numq, nums, iternum, numstr,
    none, pynan, pdna, npnan, nan, nanq, nans, 
...
# %% ../nbs/00_inst.ipynb 37
Module: TypeAlias = moduletype

# %% ../nbs/00_inst.ipynb 39
Loader: TypeAlias = moduleloader
ModuleSpec: TypeAlias = modulespec

# %% ../nbs/00_inst.ipynb 41
Sig:   TypeAlias = sig
Param: TypeAlias = param

# %% ../nbs/00_inst.ipynb 43
Logger: TypeAlias = logger
...
# %% ../nbs/00_inst.ipynb 49
IterStr: TypeAlias = iterstr
IterNum: TypeAlias = iternum
IterBool: TypeAlias = bools

# %% ../nbs/00_inst.ipynb 51
...
# %% ../nbs/00_inst.ipynb 59
TQDM: TypeAlias = tqdmauto

# %% ../nbs/00_inst.ipynb 61
...
# %% ../nbs/00_inst.ipynb 63
TyperApp: TypeAlias = typerapp

# %% ../nbs/00_inst.ipynb 65
Adata: TypeAlias = adata
Adatas: TypeAlias = adatas
