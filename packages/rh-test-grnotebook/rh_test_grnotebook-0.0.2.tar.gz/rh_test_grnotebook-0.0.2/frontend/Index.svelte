<script lang="ts">
  ...
  export let space: string | null | undefined;
  export let gradio_space: string | null | undefined;
  export let root_url: null | string;

  console.log('gradio.space: ', gradio.space);
  console.log('space: ', space);
  console.log('gradio_space: ', gradio_space);
  ...
  async function handleShare() {
    ...
    // parent.window.location.href is not accessible because it is cross-origin; docuent.referrer
    // is huggingface.co/ and not the space URL.
