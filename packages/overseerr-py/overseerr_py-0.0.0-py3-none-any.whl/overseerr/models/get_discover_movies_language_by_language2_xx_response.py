...
class GetDiscoverMoviesLanguageByLanguage2XXResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["page", "totalPages", "totalResults", "language", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "language": SpokenLanguage.from_dict(obj["language"]) if obj.get("language") is not None else None,
            "results": [MovieResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
