...
class GetStatus2XXResponse(BaseModel):
    """
    ...
    restart_required: Optional[StrictBool] = Field(default=None, alias="restartRequired")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["version", "commitTag", "updateAvailable", "commitsBehind", "restartRequired"]
