...
class UpdateRequestRequest(BaseModel):
    ...
    seasons: Optional[List[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]]] = None
    ...
    __properties: ClassVar[List[str]] = ["mediaType", "seasons", "is4k", "serverId", "profileId", "rootFolder", "languageProfileId", "userId"]
