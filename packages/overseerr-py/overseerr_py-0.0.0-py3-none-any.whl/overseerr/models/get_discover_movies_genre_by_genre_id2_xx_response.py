...
class GetDiscoverMoviesGenreByGenreId2XXResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["page", "totalPages", "totalResults", "genre", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genre": Genre.from_dict(obj["genre"]) if obj.get("genre") is not None else None,
