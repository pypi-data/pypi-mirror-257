...
class SonarrSeriesAddOptionsInner(BaseModel):
    ...
    search_for_missing_episodes: Optional[StrictBool] = Field(default=None, alias="searchForMissingEpisodes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ignoreEpisodesWithFiles", "ignoreEpisodesWithoutFiles", "searchForMissingEpisodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.ignore_episodes_with_files is None and "ignore_episodes_with_files" in self.model_fields_set:
            _dict['ignoreEpisodesWithFiles'] = None

        # set to None if ignore_episodes_without_files (nullable) is None
        # and model_fields_set contains the field
        if self.ignore_episodes_without_files is None and "ignore_episodes_without_files" in self.model_fields_set:
            _dict['ignoreEpisodesWithoutFiles'] = None

        # set to None if search_for_missing_episodes (nullable) is None
        # and model_fields_set contains the field
        if self.search_for_missing_episodes is None and "search_for_missing_episodes" in self.model_fields_set:
