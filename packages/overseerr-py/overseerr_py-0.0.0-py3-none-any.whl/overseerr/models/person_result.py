...
class PersonResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "profilePath", "adult", "mediaType", "knownFor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adult": obj.get("adult"),
            "mediaType": obj.get("mediaType") if obj.get("mediaType") is not None else 'person',
            "knownFor": [PersonResultKnownForInner.from_dict(_item) for _item in obj["knownFor"]] if obj.get("knownFor") is not None else None
        })
