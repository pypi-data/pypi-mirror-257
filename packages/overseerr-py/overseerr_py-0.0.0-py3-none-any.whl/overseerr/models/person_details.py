...
class PersonDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "deathday", "knownForDepartment", "alsoKnownAs", "gender", "biography", "popularity", "placeOfBirth", "profilePath", "adult", "imdbId", "homepage"]
