...
class GetMediaWatchData2XXResponse(BaseModel):
    """
    GetMediaWatchData2XXResponse
    """ # noqa: E501
    data: Optional[GetMediaWatchData2XXResponseData] = None
    data4k: Optional[GetMediaWatchData2XXResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetMediaWatchData2XXResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "data4k": GetMediaWatchData2XXResponseData.from_dict(obj["data4k"]) if obj.get("data4k") is not None else None
        })
