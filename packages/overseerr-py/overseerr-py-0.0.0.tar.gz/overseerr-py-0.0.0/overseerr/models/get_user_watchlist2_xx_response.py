...
class GetUserWatchlist2XXResponse(BaseModel):
    """
    ...
    results: Optional[List[GetUserWatchlist2XXResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GetUserWatchlist2XXResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
