...
class GetUserQuota2XXResponse(BaseModel):
    """
    GetUserQuota2XXResponse
    """ # noqa: E501
    movie: Optional[GetUserQuota2XXResponseMovie] = None
    tv: Optional[GetUserQuota2XXResponseMovie] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "movie": GetUserQuota2XXResponseMovie.from_dict(obj["movie"]) if obj.get("movie") is not None else None,
            "tv": GetUserQuota2XXResponseMovie.from_dict(obj["tv"]) if obj.get("tv") is not None else None
        })
