...
class MediaInfo(BaseModel):
    ...
    status: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Availability of the media. 1 = `UNKNOWN`, 2 = `PENDING`, 3 = `PROCESSING`, 4 = `PARTIALLY_AVAILABLE`, 5 = `AVAILABLE`")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [MediaRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None,
