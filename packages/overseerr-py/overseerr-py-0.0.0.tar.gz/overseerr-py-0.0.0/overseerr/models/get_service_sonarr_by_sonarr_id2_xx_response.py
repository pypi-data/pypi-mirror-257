...
class GetServiceSonarrBySonarrId2XXResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "server": SonarrSettings.from_dict(obj["server"]) if obj.get("server") is not None else None,
            "profiles": ServiceProfile.from_dict(obj["profiles"]) if obj.get("profiles") is not None else None
        })
