...
class GetCache2XXResponseImageCache(BaseModel):
    """
    GetCache2XXResponseImageCache
    """ # noqa: E501
    tmdb: Optional[GetCache2XXResponseImageCacheTmdb] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tmdb": GetCache2XXResponseImageCacheTmdb.from_dict(obj["tmdb"]) if obj.get("tmdb") is not None else None
        })
