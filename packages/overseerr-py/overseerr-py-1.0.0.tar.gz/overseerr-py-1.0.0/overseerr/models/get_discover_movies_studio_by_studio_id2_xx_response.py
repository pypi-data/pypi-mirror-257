...
class GetDiscoverMoviesStudioByStudioId2XXResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["page", "totalPages", "totalResults", "studio", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "studio": ProductionCompany.from_dict(obj["studio"]) if obj.get("studio") is not None else None,
