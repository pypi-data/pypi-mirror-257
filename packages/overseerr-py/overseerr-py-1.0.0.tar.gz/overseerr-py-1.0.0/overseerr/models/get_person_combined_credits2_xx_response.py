...
class GetPersonCombinedCredits2XXResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cast": [CreditCast.from_dict(_item) for _item in obj["cast"]] if obj.get("cast") is not None else None,
            "crew": [CreditCrew.from_dict(_item) for _item in obj["crew"]] if obj.get("crew") is not None else None,
            "id": obj.get("id")
        })
