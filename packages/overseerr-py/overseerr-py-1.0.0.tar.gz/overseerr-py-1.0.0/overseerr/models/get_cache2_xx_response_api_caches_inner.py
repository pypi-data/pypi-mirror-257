...
class GetCache2XXResponseApiCachesInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "stats": GetCache2XXResponseApiCachesInnerStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
