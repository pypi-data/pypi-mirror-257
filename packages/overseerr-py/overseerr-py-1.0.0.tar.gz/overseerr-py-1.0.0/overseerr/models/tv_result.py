...
class TvResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "mediaType", "popularity", "posterPath", "backdropPath", "voteCount", "voteAverage", "genreIds", "overview", "originalLanguage", "name", "originalName", "originCountry", "firstAirDate", "mediaInfo"]
