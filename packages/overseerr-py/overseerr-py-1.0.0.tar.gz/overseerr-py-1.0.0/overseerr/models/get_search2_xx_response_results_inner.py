...
GETSEARCH2XXRESPONSERESULTSINNER_ANY_OF_SCHEMAS = ["MovieResult", "PersonResult", "TvResult"]

class GetSearch2XXResponseResultsInner(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GetSearch2XXResponseResultsInner.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetSearch2XXResponseResultsInner with anyOf schemas: MovieResult, PersonResult, TvResult. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetSearch2XXResponseResultsInner with anyOf schemas: MovieResult, PersonResult, TvResult. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MovieResult, PersonResult, TvResult]]:
