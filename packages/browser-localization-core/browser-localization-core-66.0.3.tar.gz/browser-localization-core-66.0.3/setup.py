...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package browser-localization-core. Maybe you are using the wrong pypi?")


setup(
    name='browser-localization-core',
    version='66.0.3',
    author='Yandex',
