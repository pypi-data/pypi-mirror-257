...
from typing_validation.validation import _pseudotypes, _pseudotypes_dict, _is_typed_dict
...
_collection_cases: typing.Tuple[typing.Tuple[typing.Any, typing.List[typing.Any]], ...] = (
    ...
    ([0, 1, 2], [list, typing.List, typing.List[int],
                 ...
                 typing.Iterable, typing.Iterable[int], typing.Sized, typing.Container]),
    ((0, 1, 2), [tuple, typing.Tuple, typing.Tuple[int, int, int], typing.Tuple[int, ...],
                 typing.Collection, typing.Collection[int],
                 typing.Sequence, typing.Sequence[int],
                 typing.Iterable, typing.Iterable[int], typing.Sized, typing.Hashable, typing.Container]),
    ...
    (frozenset({0, 1, 2}), [frozenset, typing.FrozenSet, typing.FrozenSet[int],
                            typing.Collection, typing.Collection[int],
                            typing.AbstractSet, typing.AbstractSet[int],
                            typing.Iterable, typing.Iterable[int], typing.Sized, typing.Hashable,
                            typing.Container]),
...
_mapping_cases = (
    ({"a": 0, "b": 1}, [dict, typing.Collection, typing.Collection[str],
                        ...
                        typing.Iterable, typing.Iterable[str], typing.Sized, typing.Container]),
