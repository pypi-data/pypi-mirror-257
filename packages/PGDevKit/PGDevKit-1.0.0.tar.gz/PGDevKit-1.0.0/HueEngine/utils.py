...
from HueEngine.core import pg,re,Vector2,math
...
class DebugInterface:
    def __init__(self, displaySurface:pg.Surface, position:Vector2, gameClock:pg.time.Clock, interfaceSize:Vector2=(180,80), fontSize:int=24) -> None:
        self.scope = []
