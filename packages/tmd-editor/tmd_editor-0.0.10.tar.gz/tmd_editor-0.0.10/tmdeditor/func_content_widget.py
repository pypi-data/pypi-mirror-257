...
class AllContentWidgetFunctions(QWidget, Serializable):
    ...
    for other widgets inside of a :py:class:`~tmdeditor.node_node.Node`"""
    def __init__(self, node:'Node', parent:QWidget=None):
        """
        :param node: reference to the :py:class:`~tmdeditor.node_node.Node`
        :type node: :py:class:`~tmdeditor.func_node.Node`
        :param parent: parent widget
        :type parent: QWidget

        :Instance Attributes:
            - **node** - reference to the :class:`~tmdeditor.node_node.Node`
    ...
    def createContentWidget(self):
        """Sets up layouts and widgets to be rendered in :py:class:`~tmdeditor.node_graphics_node.QDMGraphicsNode` class.
        """
        ...
        self.layout.addWidget(TextSpaceEditing("foo"))
    ...
    def setEditingFlag(self, value:bool):
        ...
        Helper function which sets editingFlag inside :py:class:`~tmdeditor.node_graphics_view.QDMGraphicsView` class.
