...
from tmdeditor.graphical_socket import DrawGraphicalSocket
...
RIGHT_CENTER = 5    #:
RIGHT_BOTTOM = 6    #:
TOP_CENTER = 7  # or any other appropriate value
BOTTOM_RIGHT_CENTER = 8
BOTTOM_LEFT_CENTER = 9
...
class AllSocketFunctions(Serializable):
    getGrSocketsClass = DrawGraphicalSocket
    ...
    def __init__(self, node: 'Node', index: int=0, position: int=LEFT_TOP, socket_type: int=1, multi_edges: bool=True,
        ...
        """
        :param node: reference to the :class:`~tmdeditor.node_node.Node` containing this `Socket`
        ...
        :Instance Attributes:
            ...
            - **node** - reference to the :class:`~tmdeditor.node_node.Node` containing this `Socket`
            - **edges** - list of `Edges` connected to this `Socket`
            - **grSocket** - reference to the :class:`~tmdeditor.node_graphics_socket.QDMGraphicsSocket`
        ...
        if DEBUG: print("Socket -- creating with", self.index, self.position, "for tmdeditor", self.node)


        self.grSocket = self.__class__.getGrSocketsClass(self)
    ...
    def setSocketPosition(self):
        ...
        inside :class:`~tmdeditor.node_node.Node`."""
    ...
    def getSocketPosition(self):
        ...
        :return: Returns this `Socket` position according to the implementation stored in
            :class:`~tmdeditor.node_node.Node`
        :rtype: ``x, y`` position
        """
        if DEBUG: print("  GSP: ", self.index, self.position, "tmdeditor:", self.node)
    ...
    def hasAnyEdge(self) -> bool:
        """
        Returns ``True`` if any :class:`~tmdeditor.node_edge.Edge` is connected to this socket

        :return: ``True`` if any :class:`~tmdeditor.node_edge.Edge` is connected to this socket
        :rtype: ``bool``
        """
    ...
    def isConnected(self, edge: 'Edge') -> bool:
        """
        Returns ``True`` if :class:`~tmdeditor.node_edge.Edge` is connected to this `Socket`

        :param edge: :class:`~tmdeditor.node_edge.Edge` to check if it is connected to this `Socket`
        :type edge: :class:`~tmdeditor.func_edge.Edge`
    ...
    def addEdge(self, edge: 'Edge'):
        ...
        :param edge: :class:`~tmdeditor.node_edge.Edge` to connect to this `Socket`
        :type edge: :class:`~tmdeditor.func_edge.Edge`
        """
    ...
    def removeEdge(self, edge: 'Edge'):
        """
        Disconnect passed :class:`~tmdeditor.node_edge.Edge` from this `Socket`
        :param edge: :class:`~tmdeditor.node_edge.Edge` to disconnect
        :type edge: :class:`~tmdeditor.func_edge.Edge`
        """
