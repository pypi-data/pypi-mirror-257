...
class AllEdgeFunctions(Serializable):
    ...
    def __init__(self, scene:'Scene', start_socket:'Socket'=None, end_socket:'Socket'=None, edge_type=EDGE_TYPE_BEZIER):
        """

        :param scene: Reference to the :py:class:`~tmdeditor.node_scene.Scene`
        :type scene: :py:class:`~tmdeditor.func_scene.Scene`
        :param start_socket: Reference to the starting socket
        :type start_socket: :py:class:`~tmdeditor.func_socket.Socket`
        :param end_socket: Reference to the End socket or ``None``
        :type end_socket: :py:class:`~tmdeditor.func_socket.Socket` or ``None``
        ...
        :Instance Attributes:
            ...
            - **grEdge** - Instance of :class:`~tmdeditor.node_graphics_edge.QDMGraphicsEdge` subclass handling graphical representation in the ``QGraphicsScene``.
        """
        super().__init__()
        self.scene = scene
    ...
    def start_socket(self):
        ...
        :getter: Returns start :class:`~tmdeditor.node_socket.Socket`
        :setter: Sets start :class:`~tmdeditor.node_socket.Socket` safely
        :type: :class:`~tmdeditor.node_socket.Socket`
        """
    ...
    def end_socket(self):
        ...
        :getter: Returns end :class:`~tmdeditor.node_socket.Socket` or ``None`` if not set
        :setter: Sets end :class:`~tmdeditor.node_socket.Socket` safely
        :type: :class:`~tmdeditor.node_socket.Socket` or ``None``
        """
    ...
    def edge_type(self):
        ...
        :setter: sets new edge type. On background, creates new :class:`~tmdeditor.node_graphics_edge.QDMGraphicsEdge`
    ...
    def validateEdge(cls, start_socket: 'Socket', end_socket: 'Socket') -> bool:
        ...
        :param start_socket: Starting :class:`~tmdeditor.node_socket.Socket` of Edge to check
        :type start_socket: :class:`~tmdeditor.func_socket.Socket`
        :param end_socket: Target/End :class:`~tmdeditor.node_socket.Socket` of Edge to check
        :type end_socket: :class:`~tmdeditor.func_socket.Socket`
    ...
    def getOtherSocket(self, known_socket:'Socket'):
        ...
        :param known_socket: Provide known :class:`~tmdeditor.node_socket.Socket` to be able to determine the opposite one.
        :type known_socket: :class:`~tmdeditor.func_socket.Socket`
        :return: The oposite socket on this ``Edge`` or ``None``
        :rtype: :class:`~tmdeditor.func_socket.Socket` or ``None``
        """
    ...
    def updatePositions(self):
        """
        Updates the internal `Graphics Edge` positions according to the start and end :class:`~tmdeditor.node_socket.Socket`.
    ...
    def remove_from_sockets(self):
        """
        Helper function which sets start and end :class:`~tmdeditor.node_socket.Socket` to ``None``
        """
    ...
    def remove(self, silent_for_socket:'Socket'=None, silent=False):
        ...
        Notifies nodes previously connected :class:`~tmdeditor.node_node.Node` (s) about this event.

        Triggers Nodes':

        - :py:meth:`~tmdeditor.node_node.Node.onEdgeConnectionChanged`
        - :py:meth:`~tmdeditor.node_node.Node.onInputChanged`

        :param silent_for_socket: :class:`~tmdeditor.node_socket.Socket` of a :class:`~tmdeditor.node_node.Node` which
            won't be notified, when this ``Edge`` is going to be removed
        :type silent_for_socket: :class:`~tmdeditor.func_socket.Socket`
...
#
# from tmdeditor.node_edge_validators import *
