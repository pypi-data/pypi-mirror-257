...
class AllEdgeIntersectFunctions:
    ...
    def enterState(self, node: "Node"):
        ...
        :param node: :class:`~tmdeditor.node_node.Node` which we started to drag
    ...
    def hotZoneRect(self, node: 'Node') -> 'QRectF':
        ...
        :param node: :class:`~tmdeditor.node_node.Node` for which we want to get `QRectF` describing its position and area
        :type node: :class:`~tmdeditor.func_node.Node`
    ...
    def intersect(self, node_box: 'QRectF') -> 'AllEdgeFunctions':
        ...
        :return: :class:`~tmdeditor.node_edge.Edge` or `None` if the node is being cut by an `Edge`
        :rtype: :class:`~tmdeditor.func_edge.Edge`
        """
    ...
    def isConnected(self, node: 'Node'):
        ...
        :param node: :class:`~tmdeditor.node_node.Node` which connections to check
        :type node: :class:`~tmdeditor.func_node.Node`
        :return:
        """
