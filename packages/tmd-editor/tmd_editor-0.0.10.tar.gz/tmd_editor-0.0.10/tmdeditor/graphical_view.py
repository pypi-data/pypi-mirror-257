...
from tmdeditor.func_edge_dragging import AllEdgeDraggingFunctions
from tmdeditor.func_edge_rerouting import AllEdgeReroutingFunctions
from tmdeditor.func_edge_intersect import AllEdgeIntersectFunctions
from tmdeditor.func_edge_snapping import AllEdgeSnappingFunctions
from tmdeditor.graphical_cutline import DrawGraphicalCutLine
...
class DrawGraphicalView(QGraphicsView):
    ...
    def __init__(self, grScene: 'DrawGraphicalScene', parent: 'QWidget'=None):
        """
        :param grScene: reference to the :class:`~tmdeditor.node_graphics_scene.QDMGraphicsScene`
        :type grScene: :class:`~tmdeditor.graphical_scene.QDMGraphicsScene`
        :param parent: parent widget
        :type parent: ``QWidget``

        :Instance Attributes:

        - **grScene** - reference to the :class:`~tmdeditor.node_graphics_scene.QDMGraphicsScene`
        ...
        try:
            ...
            if self.mode == MODE_EDGES_REROUTING:
                ...
                if not EDGE_REROUTING_UE:
                    # version 2 -- more consistent with the tmdeditor?
    ...
    def cutIntersectingEdges(self):
        ...
        for ix in range(len(self.cutline.line_points) - 1):
            ...
            # we could cut 3 edges leading to a single tmdeditor this will notify it 3x
