...
from tmdeditor.home_widget import NodeEditorWidget
...
class NodeEditorWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.name_company = 'Digi Brain4 '
        self.name_product = 'Temporomandibular disorders diagnosis'
        self.createHomeWindow()

    def createHomeWindow(self):
        """Set up this ``QMainWindow``. Create :class:`~tmdeditor.node_editor_widget.NodeEditorWidget`, Actions and Menus"""
        self.createActions()
        self.createMenus()
    ...
    def createFileMenu(self):
        ...
        fileMenu.addAction(self.actCompTree)  # Add the new action here
        fileMenu.addAction(self.actCompTree2)
        fileMenu.addAction(self.actDiscoveryTree)
        ...
        fileMenu.addAction(self.actCapture_screen)
        fileMenu.addSeparator()
        # fileMenu.addSeparator()  # Add a separator after the new action
    ...
    def setTitle(self):
        ...
        title = "Node Editor - "
        title += self.getCurrentNodeEditorWidget().getUserFilenames()
    ...
    def isModified(self) -> bool:
        """Has current :class:`~tmdeditor.node_scene.Scene` been modified?

        :return: ``True`` if current :class:`~tmdeditor.node_scene.Scene` has been modified
        :rtype: ``bool``
        """
    ...
    def getCurrentNodeEditorWidget(self) -> NodeEditorWidget:
        """get current :class:`~tmdeditor.node_editor_widget`

        :return: get current :class:`~tmdeditor.node_editor_widget`
        :rtype: :class:`~nodeeditor.home_widget`
        """
    ...
    def readSettings(self):
        ...
        pos = settings.value('pos', QPoint(400, 200))
        size = settings.value('size', QSize(1200, 600))
        # self.move(pos)
        # self.resize(size)
        self.showMaximized()
