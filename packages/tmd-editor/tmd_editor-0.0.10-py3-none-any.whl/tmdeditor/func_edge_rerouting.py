...
class AllEdgeReroutingFunctions:
    ...
    def getAffectedEdges(self) -> list:
        ...
        :return: List of all edges affected by the rerouting started from this `self.start_socket` :class:`~tmdeditor.node_socket.Socket`
        :rtype: ``list``
        """
    ...
    def setAffectedEdgesVisible(self, visibility: bool=True):
        ...
        :param visibility: ``True`` if all the affected :class:`~tmdeditor.node_edge.Edge` (s) should be shown or hidden
    ...
    def clearReroutingEdges(self):
        """Remove the helping dashed edges from the :class:`~tmdeditor.node_scene.Scene`"""
    ...
    def startRerouting(self, socket: 'Socket'):
        ...
        :param socket: :class:`~tmdeditor.node_socket.Socket` where we started the re-routing
    ...
    def stopRerouting(self, target: 'Socket'=None):
        ...
        :type target: :class:`~tmdeditor.func_socket.Socket` or ``None``
        """
