# -*- coding: utf-8 -*-
"""
A module containing the Edge Snapping functions which are used in :class:`~tmdeditor.node_graphics_view.QDMGraphicsView` class.
"""
...
class AllEdgeSnappingFunctions():
    ...
    def getSnappedSocketItem(self, event: 'QMouseEvent') -> 'DrawGraphicalSocket':
        """Returns :class:`~tmdeditor.node_graphics_socket.QDMGraphicsSocket` which we should snap to"""
