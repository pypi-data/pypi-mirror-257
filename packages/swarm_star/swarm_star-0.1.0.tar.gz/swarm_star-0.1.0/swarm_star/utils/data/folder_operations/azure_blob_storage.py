...
if TYPE_CHECKING:
    from tree_swarm.swarm.types import SwarmConfig

def delete_folder(swarm: Swarm, folder_path: str) -> dict:
    try:
        blob_service_client = BlobServiceClient(
            account_url=f"https://{swarm_config.azure_blob_storage_account_name}.blob.core.windows.net/",
            credential=swarm_config.azure_blob_storage_account_key
        )
        container_client = blob_service_client.get_container_client(swarm_config.azure_blob_storage_container_name)
