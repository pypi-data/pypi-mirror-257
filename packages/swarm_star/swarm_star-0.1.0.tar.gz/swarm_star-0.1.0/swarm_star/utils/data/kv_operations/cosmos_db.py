...
def add_kv(swarm: Swarm, category: str, key: str, value: dict) -> None:
    url = swarm_config.azure_cosmos_db_url
    cosmos_key = swarm_config.azure_cosmos_db_key
    container_name = swarm_config.azure_cosmos_db_container_name
    client = CosmosClient(url, credential=cosmos_key)
    database_name = client.get_database_client(swarm_config.azure_cosmos_db_database_name)
