...
def delete_file(swarm: Swarm, file_path: str) -> None:
    storage_account_name = swarm_config.azure_blob_storage_account_name
    storage_account_key = swarm_config.azure_blob_storage_account_key
    container_name = swarm_config.azure_blob_storage_container_name
