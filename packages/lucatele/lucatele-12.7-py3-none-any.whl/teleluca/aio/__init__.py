...
class Bot(_BotBase):
    ...
    async def sendAudio(self, chat_id, audio,
        ...
        :param audio: Same as ``photo`` in :meth:`lucatele.aio.Bot.sendPhoto`
        """
    ...
    async def sendDocument(self, chat_id, document,
        ...
        :param document: Same as ``photo`` in :meth:`lucatele.aio.Bot.sendPhoto`
        """
    ...
    async def sendVideo(self, chat_id, video,
        ...
        :param video: Same as ``photo`` in :meth:`lucatele.aio.Bot.sendPhoto`
        """
    ...
    async def sendVoice(self, chat_id, voice,
        ...
        :param voice: Same as ``photo`` in :meth:`lucatele.aio.Bot.sendPhoto`
        """
    ...
    async def editMessageCaption(self, msg_identifier,
        ...
        :param msg_identifier: Same as ``msg_identifier`` in :meth:`lucatele.aio.Bot.editMessageText`
        """
        p = _strip(locals(), more=['msg_identifier'])
        p.update(_dismantle_message_identifier(msg_identifier))
    ...
    async def deleteMessage(self, msg_identifier):
        ...
        :param msg_identifier:
            Same as ``msg_identifier`` in :meth:`lucatele.aio.Bot.editMessageText`,
    ...
    async def sendSticker(self, chat_id, sticker,
        ...
        :param sticker: Same as ``photo`` in :meth:`lucatele.aio.Bot.sendPhoto`
        """
    ...
    async def message_loop(self, handler=None, relax=0.1,
        ...
        :type timeout: int
        :param timeout:
            ``timeout`` parameter supplied to :meth:`lucatele.aio.Bot.getUpdates`,
            controlling how long to poll in seconds.

        :type allowed_updates: array of string
        :param allowed_updates:
            ``allowed_updates`` parameter supplied to :meth:`lucatele.aio.Bot.getUpdates`,
