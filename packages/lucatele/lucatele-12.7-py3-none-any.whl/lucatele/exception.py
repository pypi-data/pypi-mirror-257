...
class lucateleException(Exception):
    """ Base class of following exceptions. """
    pass

class BadFlavor(lucateleException):
...
class BadHTTPResponse(lucateleException):
    """
...
class EventNotFound(lucateleException):
...
class WaitTooLong(lucateleException):
...
class StopListening(lucateleException):
    pass

class TelegramError(lucateleException):
    """
    ...
    be raised. Before raising a generic ``TelegramError``, lucatele looks for
