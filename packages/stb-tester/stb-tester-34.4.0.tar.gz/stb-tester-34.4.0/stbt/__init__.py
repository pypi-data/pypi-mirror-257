...
def navigate_1d(
    ...
    This function takes a ``page`` parameter, which is a Page Object that
    describes the current state of the device-under-test. The Page Object must
    have a property called ``focus``. This function will search the menu until
    the current focus (according to the Page Object) matches ``target``.
