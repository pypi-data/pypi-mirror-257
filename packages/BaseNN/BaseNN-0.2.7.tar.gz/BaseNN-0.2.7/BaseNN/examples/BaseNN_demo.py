...
def load_image_data_cd():
    ...
    #                          color="RGB",batch_size=2000, transform=tran,classes=classes)
    ...
    # model.train(lr=0.001, epochs=100)# 直接训练
...
def resnet_mn():
    ...
    a = model.load_img_data("/home/user/桌面/BaseNN004/dataset/cls/mnist/test_set",
