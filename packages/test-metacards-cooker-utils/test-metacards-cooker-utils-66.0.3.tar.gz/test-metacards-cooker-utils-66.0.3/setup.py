...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package test-metacards-cooker-utils. Maybe you are using the wrong pypi?")


setup(
    name='test-metacards-cooker-utils',
    version='66.0.3',
    author='Yandex',
