...
__date__      = '2024-February-19'   
__url__       = 'https://engineering.purdue.edu/kak/distYOLO/YOLOLogic-2.1.2.html'
...
NOTE:  This module was previously known as RegionProposalNetwork
...
INTRODUCTION:
    ...
    (YOLOLogic) implements elements of the Selective Search (SS)
...
USAGE:
    ...
    yolo = YOLOLogic.YoloObjectDetector( rpg = rpg )
...
#______________________________  YOLOLogic Class Definition  ________________________________
...
#______________________  Private Methods of YOLOLogic's RPN Class  ________________
...
#_________________________  End of YOLOLogic Class Definition ___________________________
