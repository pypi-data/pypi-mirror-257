...
setup(name='YOLOLogic',
      version='2.1.2',
      author='Avinash Kak',
      author_email='kak@purdue.edu',
      maintainer='Avinash Kak',
      maintainer_email='kak@purdue.edu',
      url='https://engineering.purdue.edu/kak/distYOLO/YOLOLogic-2.1.2.html',
      download_url='https://engineering.purdue.edu/kak/distYOLO/YOLOLogic-2.1.2.tar.gz',
...
::
      ...
      classifiers=['Topic :: Scientific/Engineering :: Image Recognition', 'Programming Language :: Python :: 3.10'],
      packages=['YOLOLogic']
)
