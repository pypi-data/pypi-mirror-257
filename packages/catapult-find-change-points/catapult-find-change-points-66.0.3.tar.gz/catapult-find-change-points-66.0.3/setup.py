...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package catapult-find-change-points. Maybe you are using the wrong pypi?")


setup(
    name='catapult-find-change-points',
    version='66.0.3',
    author='Yandex',
