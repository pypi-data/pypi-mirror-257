...
class FireDucksPandasCompat(
    ...
    def _sort_values(
        ...
        *,
        ...
        known_stable_sort = ("quicksort", "heapsort")
        ...
        na_pos = False if decoded_args.na_position == "first" else True
        stable = False if decoded_args.kind in known_stable_sort else True
    ...
    def index(self):
        ...
        # TODO: wrap IndexColumns at backend side
    ...
    def index(self, value):
        ...
        return self.set_axis(value, axis=0, inplace=True)
