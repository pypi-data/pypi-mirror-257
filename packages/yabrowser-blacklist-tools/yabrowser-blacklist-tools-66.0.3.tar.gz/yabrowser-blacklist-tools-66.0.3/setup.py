...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yabrowser-blacklist-tools. Maybe you are using the wrong pypi?")


setup(
    name='yabrowser-blacklist-tools',
    version='66.0.3',
    author='Yandex',
