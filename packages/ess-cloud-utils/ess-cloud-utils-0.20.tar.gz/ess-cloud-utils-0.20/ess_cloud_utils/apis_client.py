...
class ApisClient(object):
    ...
    @staticmethod
    async def get(service_name, endpoint, headers=None, timeout=None):
    ...
    @staticmethod
    async def post(service_name, endpoint, body=None, headers=None, json=None, files=None):
        base_url = Eureka.get_application_address(service_name)
        url = base_url + endpoint
    ...
    @staticmethod
    async def put(service_name, endpoint, body=None, headers=None, json=None):
        base_url = Eureka.get_application_address(service_name)
        url = base_url + endpoint
    ...
    @staticmethod
    async def delete(service_name, endpoint, body=None, headers=None, json=None):
        base_url = Eureka.get_application_address(service_name)
        url = base_url + endpoint
