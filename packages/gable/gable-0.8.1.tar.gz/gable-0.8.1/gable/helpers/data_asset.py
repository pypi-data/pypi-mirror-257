...
from gable.helpers.auth import get_npm_credentials, set_npm_config_credentials
from gable.helpers.emoji import EMOJI
from gable.helpers.npm import check_node_installed, run_sca
...
def gather_python_asset_data(
    ...
    npm_credentials = get_npm_credentials(client)
