...
class course(object):
	...
	def assign_grades(self, frame:mystring.frame, student_pid_column:str, student_id_column:str=None, proceed=True,debug=False, course_number=None, assignment_number=None):
		self.set_course(course_number)
