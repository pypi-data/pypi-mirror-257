...
class SimplisticTest(unittest.TestCase):
    def setUp(self):
        ...
        #import os,sys;sys.path.insert(1,"./");from pyvas import course;canvas_runner = course(__key, __course, __assignment)

        sys.path.insert(0, proj_path);from pyvas import course
