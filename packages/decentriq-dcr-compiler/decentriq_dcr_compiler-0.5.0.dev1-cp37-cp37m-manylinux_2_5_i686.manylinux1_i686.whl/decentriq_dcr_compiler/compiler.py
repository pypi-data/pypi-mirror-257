...
def upgrade_media_insights_dcr_to_latest(
    ...
    result = _ddc_py.upgrade_media_insights_dcr_to_latest(input.model_dump_json(by_alias=True))
...
def compile_data_science_commit(
    ...
    compile_output = _ddc_py.compile_data_science_commit(input.model_dump_json(), context)
...
def create_lookalike_media_data_room(
    ...
    response = _ddc_py.create_lookalike_media_data_room_serialized(input.model_dump_json())
...
def is_data_lab_compatible_with_lookalike_media_data_room(
    ...
    return _ddc_py.is_data_lab_compatible_with_lookalike_media_dcr_serialized(
        data_lab.model_dump_json(), lm_dcr.model_dump_json()
    )
...
def update_data_lab_enclave_specifications(
    ...
    result = _ddc_py.update_data_lab_enclave_specifications_serialized(
        data_lab.model_dump_json(), driver_spec.model_dump_json(), python_spec.model_dump_json(), root_certificate_pem
    )
...
def get_lookalike_media_data_room_features(
    ...
    return _ddc_py.get_lookalike_media_data_room_features_serialized(lm_dcr.model_dump_json())
...
def compile_media_insights_dcr(dcr: MediaInsightsDcr):
    return _ddc_py.compile_media_insights_dcr_serialized(dcr.model_dump_json(by_alias=True))
...
def get_media_insights_dcr_features(dcr: MediaInsightsDcr):
    return _ddc_py.get_media_insights_dcr_features_serialized(dcr.model_dump_json(by_alias=True))
