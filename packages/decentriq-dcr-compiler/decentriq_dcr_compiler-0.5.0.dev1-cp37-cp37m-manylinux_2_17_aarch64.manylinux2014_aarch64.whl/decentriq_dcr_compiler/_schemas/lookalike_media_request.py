...
class LookalikeMediaDcrCompute6(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class LookalikeMediaDcrCompute4(
    RootModel[
        Union[
            LookalikeMediaDcrCompute,
            LookalikeMediaDcrCompute6,
            LookalikeMediaDcrCompute7,
        ]
    ]
):
    root: Union[
        LookalikeMediaDcrCompute, LookalikeMediaDcrCompute6, LookalikeMediaDcrCompute7
    ]


class LookalikeMediaDcrComputeOrUnknown(RootModel[Optional[LookalikeMediaDcrCompute4]]):
    root: Optional[LookalikeMediaDcrCompute4]
