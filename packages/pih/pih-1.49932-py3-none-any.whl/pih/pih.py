...
class PIH:
    ...
    class ERROR:
        ...
        def create_header(details: str) -> str:
            return j((nl(), "Версия: ", PIH.VERSION.value, nl(), "Пользователь: ", PIH.SYS.get_login(), nl(), "Компьютер: ", PIH.SYS.host(), nl(), details))
        ...
        def global_except_hook(exception: BaseException) -> None:
            ...
            argument_list: list[str] = DataTool.filter(lambda item: isinstance(item, str), exception.args)
        ...
        sys.excepthook = (
            lambda exception_type, exception, traceback_value: PIH.ERROR.global_except_hook(
                exception
            )
        )
    ...
    class EVENT:
        ...
        def thread(
            ...
            *args
            ...
            thread(value, lambda: PIH.SERVICE.check_on_accessibility(ServiceRoles.EVENT), *args)
    ...
    class CARD_REGISTRY:
        ...
        def start_card_sorting_for(folder_name: str) -> None:
            event_builder_function: Callable[[], Events | tuple[Events, tuple[Any, ...]]] = (
