...
class Events(Enum):
    ...
    POLIBASE_PERSON_VISIT_NOTIFICATION_WAS_REGISTERED = (
        EventDescription(
    ...
    POLIBASE_PERSON_REVIEW_NOTIFICATION_WAS_REGISTERED = (
        EventDescription(
            None,
            LogMessageChannels.POLIBASE,
    ...
    POLIBASE_PERSON_REVIEW_NOTIFICATION_WAS_ANSWERED = (
        EventDescription(
    ...
    POLIBASE_PERSON_BARCODES_WITH_OLD_FORMAT_WERE_CREATED = (
        EventDescription(
    ...
    CARD_REGISTRY_FOLDER_WAS_SET_FOR_POLIBASE_PERSON = (
        EventDescription(
    ...
    CARD_REGISTRY_FOLDER_WAS_SET_NOT_FROM_POLIBASE_FOR_POLIBASE_PERSON = EventDescription(
