...
class PIHThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def submit(self, fn, /, *args, **kwargs):
        super().submit(PIHThreadPoolExecutor.wrapper(fn), *args, **kwargs)
...
class PIH:
    ...
    class ERROR:
        ...
        def create_error_header(details: str) -> str:
            return f"\nВерсия: {PIH.VERSION.value}\nПользователь: {PIH.SYS.get_login()}\nКомпьютер: {PIH.SYS.host()}\n{details}"
    ...
    class UPDATER:
        ...
        def packages(value: tuple[str, ...] | None, show_output: bool = True) -> bool:
            ...
            if ne(value):
                ...
                for package_name in lw(value):
                    if package_name not in installed_module_list:
        ...
        def package_operation(
            ...
            is_pih_module: bool = name.startswith(PIH.NAME)
