...
POLIBASE_SERVICE_DESCRIPTION_BASE: ServiceDescription = ServiceDescription(
...
class ServiceRoles(ServiceRoleBase):
    ...
    SERVICE_ADMIN = ServiceDescription(
        ...
        port=RPC.PORT(20),
        commands=(
            ServiceCommands.on_service_starting,
            ServiceCommands.on_service_started,
    ...
    MOBILE_HELPER = ServiceDescription(
        name="MobileHelper",
        standalone_name="mio"
    )
