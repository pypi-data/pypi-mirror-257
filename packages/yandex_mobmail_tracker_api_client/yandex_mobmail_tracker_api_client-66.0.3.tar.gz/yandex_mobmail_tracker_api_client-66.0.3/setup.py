...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex_mobmail_tracker_api_client. Maybe you are using the wrong pypi?")


setup(
    name='yandex_mobmail_tracker_api_client',
    version='66.0.3',
    author='Yandex',
