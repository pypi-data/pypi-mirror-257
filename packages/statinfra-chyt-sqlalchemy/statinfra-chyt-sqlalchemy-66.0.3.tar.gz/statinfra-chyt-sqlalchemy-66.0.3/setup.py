...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package statinfra-chyt-sqlalchemy. Maybe you are using the wrong pypi?")


setup(
    name='statinfra-chyt-sqlalchemy',
    version='66.0.3',
    author='Yandex',
