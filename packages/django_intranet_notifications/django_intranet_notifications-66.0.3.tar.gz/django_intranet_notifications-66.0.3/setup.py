...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package django_intranet_notifications. Maybe you are using the wrong pypi?")


setup(
    name='django_intranet_notifications',
    version='66.0.3',
    author='Yandex',
