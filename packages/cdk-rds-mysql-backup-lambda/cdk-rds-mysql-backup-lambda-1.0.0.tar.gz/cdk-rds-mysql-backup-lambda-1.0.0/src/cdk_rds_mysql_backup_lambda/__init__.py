...
class RDSMySQLBackupLambda(
    ...
    def __init__(
        ...
        *,
        ...
        :param db_password: Password to connect to the RDS instance.
        :param db_user: User to connect to the RDS instance.
        :param rds_instance_endpoint_address: Endpoint address of the RDS instance.
        :param rds_instance_name: Name of RDS instance to backup.
        :param rds_security_group_id: Security group ID for the RDS instance.
        :param rds_vpc: VPC used by the RDS instance.
        :param rds_vpc_subnets: VPC subnet group used by the RDS instance.
        :param lambda_function_name: Name of the lambda function that will be created. Default: - [db-instance-identifier]-rds-backup-lambda
        :param lambda_timeout: Timeout value for the backup lambda function. Default: - 5 minutes
        :param rds_instance_port: Port of the RDS instance.
        :param s3_bucket_name: Name of the S3 bucket to store the RDS backups. Default: - [db-instance-identifier]-rds-backup
        :param schedule_rule: Schedule for the lambda function to run. Default: - Every day at 00:00 UTC
