...
class VersionUtil(BaseLoggingFeature):
    def __init__(
        ...
        self.HelpMdUtil = HelpMdUtil(verbose, self.version_num, self.changelog_desc, self.target_dir)
        self.InputUtil = InputUtil(verbose, self.version_num, self.changelog_desc, self.target_dir)
