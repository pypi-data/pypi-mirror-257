...
class RefreshController(CommonFeature):
    ...
    def __init__(self, spec_path: Optional[str], verbose: bool, target_dir: str, ignore: list):
    ...
    def new_from_cli(cls, **kwargs):
        super().new_from_cli(
            **{"verbose": kwargs.get("verbose"), "target_dir": kwargs.get("target_dir"), "ignore": kwargs.get("ignore")}
        )
        return cls(
