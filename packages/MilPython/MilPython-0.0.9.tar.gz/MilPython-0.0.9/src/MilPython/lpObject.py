...
class LPObject:
    ...
    def add_time_var(self,name:str,unit:str='',lb:float=0,ub:float=np.inf,comment:str='')->LPStateVar_timedep:
        ...
        """      
        var = LPStateVar_timedep(name,unit,lb,ub,comment)
        self.stateVar_lst.append(var)
        return var
    
    def add_additional_var(self,name:str,unit:str='',lb:float=0,ub:float=np.inf,comment:str='')->LPStateVar_add:
        ...
        """        
        var = LPStateVar_add(name,unit,lb,ub,comment)
        self.stateVar_lst.append(var)
        return var
