...
class LPMain:
    ...
    def def_bounds(self):
        ...
        '''
        num_vars_timnedep = len(self.stateVars_timedep)*self.inputdata.steps
        num_vars_add = len(self.stateVars_add)
        num_vars = num_vars_timnedep + num_vars_add
        ...
        self.lb[0:num_vars_timnedep] = lb_timedep*self.inputdata.steps
        self.ub[0:num_vars_timnedep] = ub_timedep*self.inputdata.steps
        ...
        self.lb[num_vars_timnedep:] = lb_add
        self.ub[num_vars_timnedep:] = ub_add
