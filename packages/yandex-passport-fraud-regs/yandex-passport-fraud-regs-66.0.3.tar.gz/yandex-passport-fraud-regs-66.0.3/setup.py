...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-passport-fraud-regs. Maybe you are using the wrong pypi?")


setup(
    name='yandex-passport-fraud-regs',
    version='66.0.3',
    author='Yandex',
