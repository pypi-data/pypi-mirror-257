...
class TectonDataFrame(DataframeWrapper):
    ...
    def _to_pandas_from_duckdb(self, pretty_sql: bool) -> pandas.DataFrame:
        ...
        data_source_compute = QueryTreeCompute.for_dialect(
            ds_dialect or Dialect.DUCKDB, self._querytree, LocalDevSecretResolver()
        )
        ...
        qt_output_df = executor.exec_qt(self._querytree, secret_resolver=LocalDevSecretResolver()).result_df
        return qt_output_df
