...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package simple_python_nirvana_api. Maybe you are using the wrong pypi?")


setup(
    name='simple_python_nirvana_api',
    version='66.0.3',
    author='Yandex',
