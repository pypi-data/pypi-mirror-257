...
function GetOciCommandsToLongParams_vault() {
    $ociCommandsToLongParams = @{
        ...
        'vault secret create-base64' = 'compartment-id defined-tags description freeform-tags from-json help key-id max-wait-seconds metadata rotation-config secret-content-content secret-content-name secret-content-stage secret-name secret-rules vault-id wait-for-state wait-interval-seconds'
        ...
        'vault secret update' = 'current-version-number defined-tags description force freeform-tags from-json help if-match max-wait-seconds metadata rotation-config secret-content secret-id secret-rules wait-for-state wait-interval-seconds'
        'vault secret update-base64' = 'current-version-number defined-tags description force freeform-tags from-json help if-match max-wait-seconds metadata rotation-config secret-content-content secret-content-name secret-content-stage secret-id secret-rules wait-for-state wait-interval-seconds'
