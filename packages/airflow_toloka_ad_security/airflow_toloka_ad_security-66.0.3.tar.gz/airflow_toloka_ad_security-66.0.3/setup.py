...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package airflow_toloka_ad_security. Maybe you are using the wrong pypi?")


setup(
    name='airflow_toloka_ad_security',
    version='66.0.3',
    author='Yandex',
