...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-templater_processor_python. Maybe you are using the wrong pypi?")


setup(
    name='yandex-templater_processor_python',
    version='66.0.3',
    author='Yandex',
