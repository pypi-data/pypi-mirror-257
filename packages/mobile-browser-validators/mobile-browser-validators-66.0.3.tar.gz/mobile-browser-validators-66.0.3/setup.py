...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package mobile-browser-validators. Maybe you are using the wrong pypi?")


setup(
    name='mobile-browser-validators',
    version='66.0.3',
    author='Yandex',
