...
class Vin(BaseModel):
    ...
    comentarios_tercera_llamada = models.CharField(db_column='ComentariosTerceraLLamada', max_length=1000, blank=True,
                                                   null=True)
    agencia = models.CharField(db_column='Agencia', max_length=50, blank=True, null=True)
...
class Cte(BaseModel):
    ...
    fiscal_zona = models.CharField(db_column='FiscalZona', max_length=30, blank=True, null=True)
