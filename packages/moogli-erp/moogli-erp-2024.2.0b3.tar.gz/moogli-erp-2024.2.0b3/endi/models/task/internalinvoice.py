...
from endi.models.task.services.invoice import InternalCancelInvoiceProcessService
...
class InternalCancelInvoice(CancelInvoice):
    ...
    # Préfixe utilisé pour différencier les clés de configuration
    prefix = "internal"
    validation_state_manager = DEFAULT_ACTION_MANAGER["internalcancelinvoice"]
    _endi_service = InternalInvoiceService
