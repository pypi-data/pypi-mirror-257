...
from endi.views.export.utils import find_task_status_date
from endi.views import (
    AsyncJobMixin,
    BaseListView,
    submit_btn,
)
from endi.views.company.routes import COMPANY_INVOICE_ADD_ROUTE, COMPANY_INVOICES_ROUTE
...
class InvoicePdfView(InvoiceListTools, BaseListView):
    ...
    votre administrateur si le problème persiste.",
        ...
        gotolist_btn = ViewLink(
            "Liste des factures", "admin_invoices", path=INVOICE_COLLECTION_ROUTE
        )
