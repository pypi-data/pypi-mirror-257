...
from endi.views.supply.base_views import SupplierDocListTools

from endi.views.task.utils import get_task_url, get_task_view_type
from endi.views.supply.utils import get_supplier_doc_url
...
def includeme(config):
    ...
    config.add_view(
        SupplierPaymentView,
        route_name=f"{ITEM_ROUTE}/add_supplier_payment",
    ...
    config.add_view(
        UserPaymentView,
        route_name=f"{ITEM_ROUTE}/add_user_payment",
        permission="add_payment.supplier_invoice",
        renderer="base/formpage.mako",
    )
