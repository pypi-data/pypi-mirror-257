...
package_version = "2024.1.0b3"
package_name = "endi"


def collect_envvars_as_settings(settings, prefixes: Tuple[str] = ("ENDI_",)):
    """
    ...
    ENDI_MY_OPTION will match endi.my_option

    Ex :

        export SQLALCHEMY_URL=mariadb+mariadbconnector://endi:endi@localhost/endi?charset=utf8mb4
        export ENDI_OTHER_VAR=test
        pserve development.ini
        # will use sqlalchemy.url and endi.other_var from environment
