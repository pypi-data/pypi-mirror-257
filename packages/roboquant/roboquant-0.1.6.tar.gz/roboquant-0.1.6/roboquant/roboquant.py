...
class Roboquant:
    ...
    def __init__(
        ...
        - trader: the trader that you want to use. If None is specified, the `FlexTrader` will be used with its default settings
        - broker: the broker that you want to use. If None is specified, the `SimBroker` will be used with its default settings
        """
    ...
    def run(
        ...
        - timeframe: optionally limit the run to events within this timeframe. The default is None, resulting in all events in the feed being delivered.
        - capacity: the buffer capacity of the event channel before it starts blocking new events. Default is 10 events.
        - heartbeat_timeout: optionally, a heartbeat will be generated if no other events are received within the specified timeout in seconds. The default is None.
        """
