...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package afisha-sentry-telegram-plugin. Maybe you are using the wrong pypi?")


setup(
    name='afisha-sentry-telegram-plugin',
    version='66.0.3',
    author='Yandex',
