...
def summarize_1nc_by_2group(df=None, column="", cutoff=None, group_col0="", group_col1="", to_cat=True):
    ...
    if to_cat:
        ...
        summary_df = pd.DataFrame({'Total': df.groupby([group_col0, group_col1])[column].size()})
        summary_df['Count'] = df.groupby([group_col0, group_col1])['Ind'].sum()
