...
class Script:
    ...
    def __init__(self, language: str, cbor: str | None = None, json: dict | None = None):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if era == Era.byron.value:
            ...
            self.active_slots_coefficient = kwargs.get("active_slots_coefficient")
            self.security_parameter = kwargs.get("security_parameter")
            ...
            self.slot_length = kwargs.get("slot_length")
            ...
            self.era = era
            self.updatable_parameters = AlonzoUpdatableParameters(**kwargs.get("updatableParameters"))
            ...
            self.updatable_parameters = ConwayUpdatableParameters(**kwargs.get("updatableParameters"))
...
class BootstrapProtocolParameters:
    ...
    def _to_ada(self, value: int | dict | Ada) -> Ada:
        match value:
            case Ada():
                return value
            case dict():
            ...
            #     return Ada(value)
            case _:
                raise InvalidOgmiosParameter(
                    f"Invalid type for value {value}: {type(value)}"
                )
