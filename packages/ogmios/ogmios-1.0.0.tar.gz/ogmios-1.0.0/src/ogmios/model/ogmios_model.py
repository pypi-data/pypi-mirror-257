...
#   timestamp: 2024-02-17T20:04:32+00:00
...
class RewardAccountSummary(BaseModel):
    ...
    delegate: Optional[Delegate2] = None
    rewards: Optional[ValueAdaOnly] = None
...
class AlreadyRetiredMembers(BaseModel):
    class Config:
        extra = Extra.forbid
...
class Data60(BaseModel):
    ...
    alreadyRetiredMembers: AlreadyRetiredMembers
...
class Data61(BaseModel):
    ...
    expectedWithdrawal: Optional[ValueAdaOnly] = None
...
class Constitution(BaseModel):
    ...
    hash: Optional[DigestBlake2b224] = None
    anchor: Anchor
...
class ConstitutionalCommittee1(BaseModel):
    ...
    members: Optional[List[ConstitutionalCommitteeMember]]  # Edited
    quorum: Ratio
...
class Members(BaseModel):
    ...
    added: List[ConstitutionalCommitteeMember]
...
class ProposedProtocolParameters(BaseModel):
    ...
    constitutionalCommitteeMinSize: Optional[UInt64] = None
...
class ScriptPurpose(BaseModel):
    __root__: Union[ScriptPurpose1, ScriptPurpose2, ScriptPurpose3, ScriptPurpose4] = Field(
        ..., title='ScriptPurpose'
    )
