...
def detect_id_card(client, image_data, id_text, image_format, part=None, country=None):
    ...
    if id_text:
        ...
        id_card_path = os.path.join(save_directory, f"cropped_img_original.{image_format}")
        ...
        # Read the temporary image with OpenCV for further processing if needed
        if id_card_path:
...
#         issuing_authority = ''
    ...
    cropped_id_card, third_part, third_part_text, tampered_result_back = detect_id_card(client, image_data, back_id_text, image_format, part='third')
