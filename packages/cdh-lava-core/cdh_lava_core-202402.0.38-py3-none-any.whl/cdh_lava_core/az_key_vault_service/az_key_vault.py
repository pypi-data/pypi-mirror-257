            ...
            try:
                ...
                try:
                    ...
                    if self.client is None:
                        logger.info(f"first attempt to retrieve secret for key: {secret_name} from device client")
                        secret_client = self.client_device
                    else:
                        logger.info(f"first attempt to retrieve secret for key: {secret_name} from spn client")
