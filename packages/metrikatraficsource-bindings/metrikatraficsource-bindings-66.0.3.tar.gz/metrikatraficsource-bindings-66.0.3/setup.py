...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package metrikatraficsource-bindings. Maybe you are using the wrong pypi?")


setup(
    name='metrikatraficsource-bindings',
    version='66.0.3',
    author='Yandex',
