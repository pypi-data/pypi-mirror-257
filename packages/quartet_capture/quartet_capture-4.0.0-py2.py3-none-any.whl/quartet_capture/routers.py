...
router.register(
    r"rule-parameters", viewsets.RuleParameterViewSet, basename="rule-parameters"
)
router.register(r"steps", viewsets.StepViewSet, basename="steps")
router.register(
    r"step-parameters", viewsets.StepParameterViewSet, basename="step-parameters"
)
router.register(r"tasks", viewsets.TaskViewset, basename="tasks")
router.register(r"task-history", viewsets.TaskHistoryViewSet, basename="task-history")
router.register(r"filters", viewsets.FilterViewSet, basename="filters")
router.register(r"rule-filters", viewsets.RuleFilterViewSet, basename="rule-filters")
