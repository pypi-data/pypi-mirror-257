...
class ViewTest(APITestCase):
    ...
    def test_task_parameters(self):
        ...
        name = response.data
        db_task = models.Task.objects.get(name=name)
        self.assertEqual(1, db_task.taskparameter_set.count())
        task_param = db_task.taskparameter_set.get(name="param", value="abcdef")
    ...
    def test_execute_view(self):
        ...
        response = self.client.get("{0}?run-immediately=true".format(url))
    ...
    def test_execute_view_with_filter_1_true(self):
        ...
        self.assertIn("epcis", rules, msg="Rule epcis_1 should have been " "selected.")
    ...
    def test_execute_view_with_filter_2_true(self):
        ...
        rules = get_rules_by_filter(filter_name="utf", message=data)
        self.assertIn(
            "epcis_2", rules, msg="Rule epcis_1 should have been " "selected."
        )
    ...
    def test_execute_view_with_default(self):
        ...
        rules = get_rules_by_filter(filter_name="utf", message=data)
        self.assertIn(
            "epcis_3", rules, msg="Rule epcis_1 should have been " "selected."
        )
    ...
    def test_no_rule_capture(self):
        ...
        data = ""
        self.client.post(
            "{0}?run-immediately=true".format(url), {"file": data}, format="multipart"
        )
    ...
    def _create_filter(self, rule=None):
        ...
        filter = models.Filter.objects.create(name="utf", description="unit testing")
