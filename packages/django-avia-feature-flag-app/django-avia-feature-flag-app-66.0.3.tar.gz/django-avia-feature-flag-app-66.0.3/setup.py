...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package django-avia-feature-flag-app. Maybe you are using the wrong pypi?")


setup(
    name='django-avia-feature-flag-app',
    version='66.0.3',
    author='Yandex',
