...
class AiFormatVersion:
    ...
    @classmethod
    @property
    def PS_ADOBE20(cls) -> AiFormatVersion:
        '''The PS-Adobe-2.0 Header'''
        ...
    
    @classmethod
    @property
    def PS_ADOBE30(cls) -> AiFormatVersion:
        '''The PS-Adobe-3.0 Header'''
        ...
    
    @classmethod
    @property
    def PDF14(cls) -> AiFormatVersion:
        '''The PDF-1.4 Header'''
        ...
    
    @classmethod
    @property
    def PDF15(cls) -> AiFormatVersion:
        '''The PDF-1.5 Header'''
        ...
    
    @classmethod
    @property
    def PDF16(cls) -> AiFormatVersion:
        '''The PDF-1.6 Header'''
        ...
    
    @classmethod
    @property
    def PDF17(cls) -> AiFormatVersion:
        '''The PDF-1.7 Header'''
        ...
