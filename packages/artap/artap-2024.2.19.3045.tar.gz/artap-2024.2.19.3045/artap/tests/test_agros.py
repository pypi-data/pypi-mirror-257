...
try:
    ...
    print("NLopt is not present test skipped")
    __nlopt__ = False
...
class AgrosProblem(Problem):
    ...
    def evaluate(self, individual: Individual):
        ...
        # materials
        magnetic.add_material("Coil 1", {"magnetic_current_density_external_real": "J1", "magnetic_permeability": 1})
        magnetic.add_material("Coil 2", {"magnetic_current_density_external_real": "J2", "magnetic_permeability": 1})
