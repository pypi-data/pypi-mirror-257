...
Issues can be filed at https://github.com/The-QSig-Commission/q1ss/issues. You can file an issue to:
...
Additionally, you should format your code with [black](https://github.com/psf/black):
