...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package pytest-check-requirements. Maybe you are using the wrong pypi?")


setup(
    name='pytest-check-requirements',
    version='66.0.3',
    author='Yandex',
