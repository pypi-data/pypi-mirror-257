...
#         url="https://www.saffre-rumma.net/")
...
def person(city, first_name, last_name, **kwargs):
    ...
    if city is None:
        return
    kwargs.update(country=city.country,
                  city=city,
...
def objects():
    ...
    ausdemwald = company('Bäckerei Ausdemwald', '4700', eupen,
    ...
    mergelsberg = company('Garage Mergelsberg', '4730', raeren, 'Hauptstraße',
                          '13')
    yield mergelsberg
    ...
    yield company('Hans Flott & Co', '22453', 'Hamburg', 'Niendorfer Weg',
                  '532')
    yield company('Bernd Brechts Bücherladen', '80333', aachen,
                  'Brienner Straße', '18')
    ...
    yield person(eupen,
                 ...
                 phone="+32 87123456",
                 email="andreas@arens.com")
    annette = person(eupen,
                     'Annette',
                     'Arens',
                     gender=dd.Genders.female,
                     phone="+32 87123457",
                     email="annette@arens.com")
    yield annette
    ...
    yield person(amsterdam, 'Mark', 'Martelaer', gender=dd.Genders.male)
    yield person(amsterdam, 'Rik', 'Radermecker', gender=dd.Genders.male)
    yield person(amsterdam,
                 'Marie-Louise',
                 'Vandenmeulenbos',
                 gender=dd.Genders.female)
