...
exec(open('src/jaxbook/version.py').read())
...
setup(
    ...
    url='https://github.com/shailesh1729/jaxbook',
    download_url=f"https://github.com/shailesh1729/jaxbook/archive/v{__version__}.tar.gz",
    ...
    packages=find_packages('src', include=['jaxbook']),
    package_dir={'': 'src'},
