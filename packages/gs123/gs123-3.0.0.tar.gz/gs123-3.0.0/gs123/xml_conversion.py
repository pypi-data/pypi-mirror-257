...
def convert_xml_string(
    data: str, company_prefix_length: int = 6, serial_number_length: int = 12
):
    """
    ...
    with StringIO("") as output_file:
        _parse_xml(company_prefix_length, elements, serial_number_length)
...
def _parse_xml(
    ...
    converter_type=BarcodeConverter,
):
