...
class HealthCheck:
    ...
    def setBasicConfig(): # minimum config to work with standalone scripts built with AutoGen
        basicConfigs = (
            ...
            ("wrapWords", True),
            ("pygments_style", ""),
            ("systemMessage_chatgpt", 'You are a helpful assistant.'),
            ("systemMessage_geminipro", 'You are a helpful assistant.'),
            ("systemMessage_palm2", 'You are a helpful assistant.'),
            ("systemMessage_codey", 'You are an expert on coding.'),
            ...
            ("isVlcPlayerInstalled", VlcUtil.isVlcPlayerInstalled()),
            # key bindings
