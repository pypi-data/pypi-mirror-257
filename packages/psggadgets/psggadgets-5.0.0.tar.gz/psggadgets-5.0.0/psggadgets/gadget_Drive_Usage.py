...
def main():
    ...
    # ----------------  Create Window  ----------------
    window = sg.Window('Drive status', layout, keep_on_top=True, grab_anywhere=True, no_titlebar=True, alpha_channel=ALPHA, use_default_focus=False, finalize=True, auto_save_location=True, right_click_menu=sg.MENU_RIGHT_CLICK_EDITME_VER_EXIT)
