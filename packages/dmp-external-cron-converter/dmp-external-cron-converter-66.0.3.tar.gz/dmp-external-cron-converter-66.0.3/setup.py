...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package dmp-external-cron-converter. Maybe you are using the wrong pypi?")


setup(
    name='dmp-external-cron-converter',
    version='66.0.3',
    author='Yandex',
