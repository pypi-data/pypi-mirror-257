...
class V1ObservationInstruction(BaseModel):
    ...
    __properties = ["id", "imageSetId", "targetId", "trackingType", "exposureDuration", "binning", "gain", "gainMode", "ra", "dec", "captureStart", "captureEnd", "preCaptureWait", "startSlewAt", "cameraMode", "tleLine1", "tleLine2", "tleOffsetDec", "tleOffsetRa"]
