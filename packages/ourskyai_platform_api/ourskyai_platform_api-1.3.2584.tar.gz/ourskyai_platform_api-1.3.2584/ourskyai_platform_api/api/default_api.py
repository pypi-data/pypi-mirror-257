...
from ourskyai_platform_api.models.v1_create_observation_instruction_request import V1CreateObservationInstructionRequest
...
class DefaultApi:
    ...
    @validate_arguments
    def v1_create_observation_instruction(self, v1_create_observation_instruction_request : V1CreateObservationInstructionRequest, **kwargs) -> SuccessfulCreate:  # noqa: E501
        """v1_create_observation_instruction  # noqa: E501

        Create an observation instruction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_create_observation_instruction(v1_create_observation_instruction_request, async_req=True)
        >>> result = thread.get()

        :param v1_create_observation_instruction_request: (required)
        :type v1_create_observation_instruction_request: V1CreateObservationInstructionRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the v1_create_observation_instruction_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.v1_create_observation_instruction_with_http_info(v1_create_observation_instruction_request, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_create_observation_instruction_with_http_info(self, v1_create_observation_instruction_request : V1CreateObservationInstructionRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_create_observation_instruction  # noqa: E501
        ...
        >>> thread = api.v1_create_observation_instruction_with_http_info(v1_create_observation_instruction_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'v1_create_observation_instruction_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_create_observation_instruction" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['v1_create_observation_instruction_request'] is not None:
            _body_params = _params['v1_create_observation_instruction_request']
        ...
        return self.api_client.call_api(
            '/v1/observation-instruction', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
