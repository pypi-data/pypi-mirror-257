...
.. moduleauthor:: Ashish Patel <ashishpatel0720@gmail.com>
"""
...
setup(
    name='sparkplusplus-cli',
    description="Awesome Cli for Developers",
    ...
    url= 'https://github.com/sparkplusplus/sparkplusplus-cli',
    download_url=(
        f'https://github.com/pateash/'
        f'spp/archive/{version}.tar.gz'
    ),
    keywords=[
