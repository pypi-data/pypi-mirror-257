...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package openstack-intranet-client. Maybe you are using the wrong pypi?")


setup(
    name='openstack-intranet-client',
    version='66.0.3',
    author='Yandex',
