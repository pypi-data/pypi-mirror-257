...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-capacity-planning-data-app. Maybe you are using the wrong pypi?")


setup(
    name='yandex-capacity-planning-data-app',
    version='66.0.3',
    author='Yandex',
