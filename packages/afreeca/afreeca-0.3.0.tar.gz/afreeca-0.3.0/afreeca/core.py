...
from .credential import Credential, UserCredential
...
class AfreecaTV:
    ...
    async def get_clip_m3u8(self, broad_no: int) -> str:
        return await self.fetch_clip_m3u8(self.credential, broad_no)

    @staticmethod
    async def fetch_clip_m3u8(credential: Credential, broad_no: int) -> str:
