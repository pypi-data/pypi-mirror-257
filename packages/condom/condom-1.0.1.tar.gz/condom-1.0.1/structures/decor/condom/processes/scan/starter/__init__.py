...
'''
	import condom.processes.scan.starter as scan
	[ status ] = scan.start (		
		path = "",
		module_paths = [],
		relative_path = "",
...
import condom.processes.scan.starter.path as scan_process_path
import condom.processes.scan.starter.keg as keg_starter
import condom.processes.scan.starter.ask as ask
