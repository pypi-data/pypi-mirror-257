...
class HANAScheduler(object):
    ...
    def display_schedule_status(self):
        ...
        """
        return self.connection_context.sql("SELECT * FROM M_SCHEDULER_JOBS").collect()

    def set_schedule(self, job_name, cron=None, procedure_name=None, job_start_time=None, job_end_time=None, status='active', procedure_params=None, force=False):
        r"""
    ...
    def delete_schedule(self, job_name):
        ...
        job_name : str
            Specifies the name of the scheduled job.
        """
        self.set_schedule(job_name=job_name, status='inactive')
        try:
