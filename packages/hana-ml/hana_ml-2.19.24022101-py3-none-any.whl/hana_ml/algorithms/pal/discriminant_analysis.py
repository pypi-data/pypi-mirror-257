...
class LinearDiscriminantAnalysis(PALBase):
    ...
    >>> lda = LinearDiscriminantAnalysis(regularization_type='mixing',
                                         projection=True)
    >>> lda.fit(data=df,
    ...
    Input DataFrame df_pred to predict the class labels:
    ...
    Input DataFrame df_proj to project:
    ...
    Perform project() and check the result:
