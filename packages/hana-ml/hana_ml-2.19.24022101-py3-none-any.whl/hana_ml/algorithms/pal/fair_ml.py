...
from .trees import HybridGradientBoostingClassifier
from .trees import HybridGradientBoostingRegressor
...
class FairMLClassification(_FairMLBase):
    ...
    **kwargs: keyword arguments
    ...
    Attributes
    ----------
    model_ : DataFrame, structured as follows
...
class FairMLRegression(_FairMLBase):
    """
    FairMLRegression aims at mitigating unfairness of prediction model due to some possible "bias" within data set regarding features such as sex, race, age etc. It is a framework that can utilize other machine learning models or technologies which makes it quite flexible.
    ...
    **kwargs: keyword arguments
    ...
    def fit(self,
            ...
            thread_ratio=None):
        r"""
        The fit function of FairMLRegression.
