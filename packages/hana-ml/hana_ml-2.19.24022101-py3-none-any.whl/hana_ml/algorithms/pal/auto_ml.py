...
#            self.progress_indicator_id = "AutoML-" + str(self.gen_id)
    ...
    def _predict(self, data, key=None, features=None, model=None,
        ...
        if show_explainer and not isinstance(self, AutomaticTimeSeries):
    ...
    def _score(self,
        ...
        if model is None:
            if getattr(self, 'model_', None) is None:
                msg = ('Pipeline model not initialized. Perform a fit first.')
                logger.error(msg)
                raise FitIncompleteError(msg)
...
class AutomaticClassification(_AutoMLBase):
    ...
    population_size : int, optional
        ...
        If there are too few individuals, GA has a few possibilities to perform crossover and only a small part of search space is explored. On the other hand, if there are too many individuals, GA slows down.
    ...
    def predict(self, data, key=None, features=None, model=None,
        ...
        """
        return self._predict(data, key, features, model,
                             show_explainer,
                             top_k_attributions,
                             random_state,
                             sample_size,
...
class AutomaticRegression(_AutoMLBase):
    ...
    def score(self, data, key=None, features=None, label=None,
        ...
        return self._score(data, key, features, label, random_state,
                           model, top_k_attributions, sample_size, None)
...
class AutomaticTimeSeries(_AutoMLBase):
    ...
    def predict(self, data,#pylint:disable=arguments-differ, arguments-renamed
        ...
        """
        predict_result = self._predict(data, key, exog, model, show_explainer)
