...
def stationarity_test(data, key=None, endog=None, method=None,
    ...
    data : DataFrame
        Input data which contains at least two columns. One is ID column, while the other is raw data.
    ...
    >>> stats = stationarity_test(data=df, endog='SERIES', key='TIME_STAMP',
