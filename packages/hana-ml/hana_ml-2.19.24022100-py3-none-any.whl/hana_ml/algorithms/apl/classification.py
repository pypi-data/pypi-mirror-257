...
"""
Deprecated, use :ref:`apl-GB-classification-label` instead.
...
class AutoClassifier(RobustRegressionBase):
    """
    Deprecated, use :class:`GradientBoostingBinaryClassifier` instead.
    ...
    def predict(self, data):
        ...
        # APPLY_CONFIG
        # default config
        apply_config_data = [('APL/ApplyExtraMode', 'Advanced Apply Settings', None),
