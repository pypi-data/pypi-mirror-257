...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package browser-autotest-mitmproxy. Maybe you are using the wrong pypi?")


setup(
    name='browser-autotest-mitmproxy',
    version='66.0.3',
    author='Yandex',
