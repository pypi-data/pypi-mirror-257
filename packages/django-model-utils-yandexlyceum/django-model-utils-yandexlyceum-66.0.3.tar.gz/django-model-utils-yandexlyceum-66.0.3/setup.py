...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package django-model-utils-yandexlyceum. Maybe you are using the wrong pypi?")


setup(
    name='django-model-utils-yandexlyceum',
    version='66.0.3',
    author='Yandex',
