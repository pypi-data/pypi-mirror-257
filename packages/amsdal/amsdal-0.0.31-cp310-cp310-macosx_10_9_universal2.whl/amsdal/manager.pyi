...
from amsdal.authentication.deploy_service import DeployService as DeployService, ListDeployResponseModel as ListDeployResponseModel, ListSecretsResponse as ListSecretsResponse, UpdateDeployResponseModel as UpdateDeployResponseModel
...
class AmsdalManager(BuildMixin, ClassVersionsMixin, metaclass=Singleton):
    ...
    def add_secret(self, secret_name: str, secret_value: str, application_uuid: str | None = None, application_name: str | None = None) -> None: ...
    def list_secrets(self, application_uuid: str | None = None, application_name: str | None = None, *, with_values: bool = False) -> ListSecretsResponse | None: ...
    def delete_secret(self, secret_name: str, application_uuid: str | None = None, application_name: str | None = None) -> None: ...
