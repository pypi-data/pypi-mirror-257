...
class IO(Config):
    ...
    def describe( self,gcp_key='freshly_credentials.json'):
        """
    ...
    def download_bigquery_table(self, project_id=None, tenant_id=None, table_name=None,  gcp_key='freshly_credentials.json', sqlQuery=None):
        """
