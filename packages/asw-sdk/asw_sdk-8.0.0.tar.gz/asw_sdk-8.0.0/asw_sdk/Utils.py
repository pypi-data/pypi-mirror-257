...
class Utils:
    ...
    def print(self, message, level=LogLevel.INFO):
        ...
        filter_id = self._config_manager.get_filter_id() or "null"
        job_id = self._config_manager.get_currently_executing_job_id() or "null"
        ...
        # print('Template string with resolved variables', filter_log_request_body_as_string)
        ...
        # print('Template string (parsed as json) with resolved variables', filter_log_request_body_as_json)
