...
class ConfigurationManager:
    ...
    FILTER_PROGRESS_LOG_TEMPLATE = "filterProgressLogTemplate"
    ...
    def __init__(self, step_code, override_config=None):
        ...
        self._filter_progress_log_template = self._json_config.get("%s" % self.FILTER_PROGRESS_LOG_TEMPLATE, {})
        ...
        self._currently_executing_job_id = str(self._json_config[self.QUERY_PARAM_CURRENTLY_EXECUTING_JOB_ID]) if self.QUERY_PARAM_CURRENTLY_EXECUTING_JOB_ID in self._json_config else None
    ...
    def get_filter_progress_log_template(self):
        return self._filter_progress_log_template
