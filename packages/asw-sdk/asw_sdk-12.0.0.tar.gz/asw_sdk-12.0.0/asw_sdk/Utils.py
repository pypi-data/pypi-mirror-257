...
class Utils:
    ...
    def generate_log_request_body(self):
        properties = {
            ...
            "job_id": str(self._config_manager.get_currently_executing_job_id()) if self._config_manager.get_currently_executing_job_id() is not None else "null",
