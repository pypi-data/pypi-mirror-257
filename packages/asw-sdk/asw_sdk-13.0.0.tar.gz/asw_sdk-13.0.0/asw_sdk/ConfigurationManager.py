...
class ConfigurationManager:
    ...
    def __init__(self, step_code, override_config=None):
        ...
        self._currently_executing_job_id = str(self._json_config[self.CURRENTLY_EXECUTING_JOB_ID]) if self.CURRENTLY_EXECUTING_JOB_ID in self._json_config else None
