...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-yt-yson-bindings-skynet. Maybe you are using the wrong pypi?")


setup(
    name='yandex-yt-yson-bindings-skynet',
    version='66.0.3',
    author='Yandex',
