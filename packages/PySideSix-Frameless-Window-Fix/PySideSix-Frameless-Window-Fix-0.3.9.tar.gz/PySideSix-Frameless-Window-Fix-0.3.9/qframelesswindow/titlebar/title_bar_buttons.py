...
class TitleBarButton(QAbstractButton):
    ...
    def mousePressEvent(self, e):
        if e.button() != QtEnum.Qt.MouseButton.LeftButton:
            return
...
class SvgTitleBarButton(TitleBarButton):
    ...
    def paintEvent(self, e):
        ...
        painter.setRenderHints(QtEnum.QPainter.RenderHint.Antialiasing | QtEnum.QPainter.RenderHint.SmoothPixmapTransform)
...
class MinimizeButton(TitleBarButton):
    ...
    def paintEvent(self, e):
        ...
        # draw background
        painter.setBrush(bgColor)
        painter.setPen(QtEnum.Qt.PenStyle.NoPen)
        painter.drawRect(self.rect())

        # draw icon
        painter.setBrush(QtEnum.Qt.BrushStyle.NoBrush)
        pen = QPen(color, 1)
