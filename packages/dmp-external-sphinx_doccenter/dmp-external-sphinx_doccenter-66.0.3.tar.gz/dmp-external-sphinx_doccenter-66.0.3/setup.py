...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package dmp-external-sphinx_doccenter. Maybe you are using the wrong pypi?")


setup(
    name='dmp-external-sphinx_doccenter',
    version='66.0.3',
    author='Yandex',
