...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-python-stat-django-utils. Maybe you are using the wrong pypi?")


setup(
    name='yandex-python-stat-django-utils',
    version='66.0.3',
    author='Yandex',
