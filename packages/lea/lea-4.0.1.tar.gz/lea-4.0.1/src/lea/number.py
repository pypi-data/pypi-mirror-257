...
class Number(object):
    ...
    use_overloaded_str_method = True
    ...
    def __format__(self, format_spec):
        """ returns a string representation of self
            ...
            any Number instance occurring in a f-string, i.e. f"... {self:format_spec} ...";
            if format_spec is empty, then str(self) is returned,
            otherwise, super().__format__(format_spec) is returned
        """
        if format_spec:
