...
from .alea import event, vals, interval
...
def die(nb_faces=6, prob_type=None):
    ...
    """
    return interval(1, nb_faces, prob_type=prob_type)
...
def dice_seq(nb_dice, nb_faces=6, sorted=True, prob_type=None):
    ...
    ## gives same results but is inefficient as nb_dice and nb_faces grows
