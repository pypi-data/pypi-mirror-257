...
class ChineseNonwords:
    def __init__(
        ...
        with pkg_resources.open_text("chinese_nonwords.data", "subset.csv") as f:
            self.subset = pd.read_csv(f)
        with pkg_resources.open_text("chinese_nonwords.data", "word.csv") as f:
            self.word = pd.read_csv(f)
