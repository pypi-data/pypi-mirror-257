...
def encrypt_dataset(dataset: Dataset | DatasetDict | IterableDatasetDict | IterableDataset, key:bytes):
    f= Fernet(key)
...
def decrypt_dataset(dataset: Dataset | DatasetDict | IterableDatasetDict | IterableDataset, key:bytes):
    f= Fernet(key)
