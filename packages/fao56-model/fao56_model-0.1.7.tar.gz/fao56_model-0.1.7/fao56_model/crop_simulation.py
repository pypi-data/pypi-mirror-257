...
class CropSimulation:
    def __init__(
        self, calendar: CropCalendar, soil: Soil, climate_data: ClimateData
    ):
        ...
        self.calendar.set_corrected_crop_coeffients(climate_data)
    ...
    def run(self) -> None:
        ...
        for i, state in enumerate(self.states[1:]):
            ...
            if planted_crop:
                ...
                state.ET_c = state.K_c_correct * state.etref_mm
                ...
                state.ET_rel = state.ET_a / state.ET_c
    ...
    def df(self) -> pd.DataFrame:
        """
        Return the simulation states as a DataFrame
        """
