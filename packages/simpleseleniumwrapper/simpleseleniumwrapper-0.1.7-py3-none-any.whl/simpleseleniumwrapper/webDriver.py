...
class WebDriver (ElementLocation):
    ...
    def execute_async_script(self,script: str, *args):
        theseWebElems=[]
        for arg in args:
            theseWebElems.append(arg.webElement.element)
        
        return self.driver.execute_async_script(script,theseWebElems)
    ...
    def execute_script(self,script, *args):
        ...
        for arg in args:
            theseWebElems.append(arg.webElement.element)
        print(theseWebElems)
        return self.driver.execute_script(script,theseWebElems)
