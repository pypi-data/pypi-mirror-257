...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yc_marketplace_solomon_plugins. Maybe you are using the wrong pypi?")


setup(
    name='yc_marketplace_solomon_plugins',
    version='66.0.3',
    author='Yandex',
