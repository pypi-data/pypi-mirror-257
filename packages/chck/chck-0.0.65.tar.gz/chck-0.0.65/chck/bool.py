...
# %% auto 0
__all__ = ['is01', 'isbooly', 'isbooltype', 'isbtype', 'isboolcall', 'isbcall']
...
def isbooly(x) -> TypeGuard[bool01]:
    ...
    return isbool(x) or is01(x) or isinstance(x, bool01)
...
def isboolcall(x) -> TypeGuard[Union[bool01, Callable]]:
    ...
    '''
    return isbool(x) or iscall(x) or is01(x) or isinstance(x, bool01)
