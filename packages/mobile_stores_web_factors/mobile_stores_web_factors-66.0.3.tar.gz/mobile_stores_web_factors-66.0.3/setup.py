...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package mobile_stores_web_factors. Maybe you are using the wrong pypi?")


setup(
    name='mobile_stores_web_factors',
    version='66.0.3',
    author='Yandex',
