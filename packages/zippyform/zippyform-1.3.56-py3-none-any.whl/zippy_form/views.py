...
def update_form_recaptcha_details(req, form_id):
    ...
    if form_recaptcha:
        ...
        form_recaptcha.recaptcha_enabled = recaptcha_enabled
        form_recaptcha.site_key = site_key
        form_recaptcha.secret_key = secret_key
        form_recaptcha.save()
    else:
        # Create Form ReCaptcha Details
        FormReCaptcha.objects.create(form=form, recaptcha_enabled=recaptcha_enabled, site_key=site_key,
