...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package flask-restplus-with-webargs. Maybe you are using the wrong pypi?")


setup(
    name='flask-restplus-with-webargs',
    version='66.0.3',
    author='Yandex',
