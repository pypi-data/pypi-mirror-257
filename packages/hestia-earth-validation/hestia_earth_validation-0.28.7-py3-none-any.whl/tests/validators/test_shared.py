...
from hestia_earth.validation.validators.shared import (
    ...
    validate_properties_same_length, validate_list_duplicate_values, validate_nodes_duplicates, validate_boundary_area,
...
def test_validate_duplicated_term_units_valid():
    ...
    with open(f"{fixtures_path}/shared/duplicated-term-units/valid.json") as f:
        data = json.load(f)
...
def test_validate_duplicated_term_units_invalid():
    with open(f"{fixtures_path}/shared/duplicated-term-units/invalid-organicFertiliser.json") as f:
        data = json.load(f)
    ...
    with open(f"{fixtures_path}/shared/duplicated-term-units/invalid-animalProduct.json") as f:
        data = json.load(f)
