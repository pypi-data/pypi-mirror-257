...
class LadderList200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LadderList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LadderList200Response:
        """Create an instance of LadderList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LadderList200Response.parse_obj(obj)

        _obj = LadderList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [Ladder.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
