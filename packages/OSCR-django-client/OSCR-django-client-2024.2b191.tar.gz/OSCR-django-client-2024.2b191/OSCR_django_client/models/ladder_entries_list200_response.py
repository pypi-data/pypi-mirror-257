...
class LadderEntriesList200Response(BaseModel):
    ...
    results: conlist(LadderEntry) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LadderEntriesList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LadderEntriesList200Response:
        """Create an instance of LadderEntriesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LadderEntriesList200Response.parse_obj(obj)

        _obj = LadderEntriesList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [LadderEntry.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
