...
class CombatlogList200Response(BaseModel):
    ...
    results: conlist(CombatLog) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CombatlogList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CombatlogList200Response:
        """Create an instance of CombatlogList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CombatlogList200Response.parse_obj(obj)

        _obj = CombatlogList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CombatLog.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
