...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package dmp-external-pytest-parallel. Maybe you are using the wrong pypi?")


setup(
    name='dmp-external-pytest-parallel',
    version='66.0.3',
    author='Yandex',
