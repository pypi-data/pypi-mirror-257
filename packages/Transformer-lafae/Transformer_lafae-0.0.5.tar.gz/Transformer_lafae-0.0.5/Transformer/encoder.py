...
class Encoder(tf.keras.layers.Layer):
    ...
    """
    def __init__(self, num_layers: int, d_model: int, num_heads: int, dff: int, output_dim: int, dropout_rate: float=0.1):
        """
        ...
        Args:
            ...
            output_dim (int): Vector output dimension.
        ...
        self.pos_embedding = PositionalEmbedding(input_dim=output_dim, d_model=d_model,max_sequence_length=20)
