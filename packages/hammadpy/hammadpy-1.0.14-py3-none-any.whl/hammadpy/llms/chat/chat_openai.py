...
from core.interactions import Status
...
class ChatOpenAI:
    ...
    def chat(self, query: str = None, model : str = None, ):
        """"
        ...
        if self.query == None:
            ...
            self.status.__exit__()
            return completion
        
    def ask(self, query: str = None, model : str = None):
        """"
    ...
    def vocabulary(self, query: str = None, model : str = None, ):
        """"
    ...
    def plan(self, query: str = None, model : str = None):
        """"
