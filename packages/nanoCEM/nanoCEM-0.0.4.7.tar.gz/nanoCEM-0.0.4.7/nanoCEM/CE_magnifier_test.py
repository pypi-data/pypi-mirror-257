...
def init_parser():
    ...
    # parser.set_defaults(function='move_table', chrom="NR_103073.1", pos=2524, len=10, strand='+', cpu=8,norm=True,
    ...
    # parser.set_defaults(function='f5c', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=8,norm=True,base_shift=True,pore='r9',
