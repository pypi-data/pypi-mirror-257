...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-passport-meltingpot-celery. Maybe you are using the wrong pypi?")


setup(
    name='yandex-passport-meltingpot-celery',
    version='66.0.3',
    author='Yandex',
