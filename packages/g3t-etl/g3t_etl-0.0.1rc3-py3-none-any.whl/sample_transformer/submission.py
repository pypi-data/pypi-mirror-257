...
#   timestamp: 2024-02-13T22:49:34+00:00
...
class Submission(BaseModel):
    id: Optional[str] = Field(
        ...
        json_schema_extra={'fhir_resource_type': 'Patient, Specimen, Condition'},
    )
