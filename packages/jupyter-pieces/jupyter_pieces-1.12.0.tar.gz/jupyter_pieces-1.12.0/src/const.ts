...
export default class Constants {
  ...
  public static readonly SNIPPET_DELETE_FAILURE =
    'Failed to delete snippet. Please ensure that Pieces OS is up-to-date, installed and running. If the problem persists please reach out to support at support.';
  ...
  public static readonly LINK_GEN_FAIL =
    'Failed to generate link. Please ensure that Pieces OS is up-to-date, installed and running. If the problem persists please reach out to support.';
