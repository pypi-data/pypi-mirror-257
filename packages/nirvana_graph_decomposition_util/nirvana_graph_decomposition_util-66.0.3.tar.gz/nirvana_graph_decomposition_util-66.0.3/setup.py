...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package nirvana_graph_decomposition_util. Maybe you are using the wrong pypi?")


setup(
    name='nirvana_graph_decomposition_util',
    version='66.0.3',
    author='Yandex',
