...
```cli
errant_parallel -orig ./data/origs.txt -cor ./data/hyps.txt -out ./data/out_hyp_m2
errant_parallel -orig ./data/origs.txt -cor ./data/refs.txt -out ./data/out_ref_m2
```
...
```cli
errant_compare -hyp ./data/out_hyp_m2 -ref ./data/out_ref_m2 -ds -cat 3
```
