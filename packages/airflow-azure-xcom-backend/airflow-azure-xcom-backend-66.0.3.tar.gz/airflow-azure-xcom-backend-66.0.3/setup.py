...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package airflow-azure-xcom-backend. Maybe you are using the wrong pypi?")


setup(
    name='airflow-azure-xcom-backend',
    version='66.0.3',
    author='Yandex',
