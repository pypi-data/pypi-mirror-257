            ...
            if method == 'socket':
                ...
                def websocket_thread():
                    asyncio.run(ClientWebSocket.table_subscribe_thread(
                        self, host, port, lookbacklines, lookbackdate, snapshot))
