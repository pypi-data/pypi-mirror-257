...
Defined at qepy_mod.fpp lines 5-955
...
def qepy_get_rho(rhor, gather=None):
    ...
    Defined at qepy_mod.fpp lines 140-159
    ...
    """
    libqepy_pw.f90wrap_qepy_get_rho(rhor=rhor, gather=gather)
...
def qepy_set_rho(rhor, gather=None):
    ...
    Defined at qepy_mod.fpp lines 161-182
    ...
    """
    libqepy_pw.f90wrap_qepy_set_rho(rhor=rhor, gather=gather)
...
def qepy_get_rho_core(rhoc, gather=None):
    ...
    Defined at qepy_mod.fpp lines 184-198
    ...
    """
    libqepy_pw.f90wrap_qepy_get_rho_core(rhoc=rhoc, gather=gather)
...
def qepy_set_rho_core(rhoc, gather=None):
    ...
    Defined at qepy_mod.fpp lines 200-214
    ...
    """
    libqepy_pw.f90wrap_qepy_set_rho_core(rhoc=rhoc, gather=gather)
...
def qepy_set_extpot(vin, gather=None):
    ...
    Defined at qepy_mod.fpp lines 216-243
    ...
    """
    libqepy_pw.f90wrap_qepy_set_extpot(vin=vin, gather=gather)
...
def qepy_get_grid(nr=None, gather=None):
    ...
    Defined at qepy_mod.fpp lines 245-261
    ...
    """
    nrw = libqepy_pw.f90wrap_qepy_get_grid(nr=nr, gather=gather)
    return nrw
...
def qepy_get_grid_shape(self, gather=None):
    ...
    Defined at qepy_mod.fpp lines 263-282
    ...
    """
    nrw = libqepy_pw.f90wrap_qepy_get_grid_shape(dfft=self._handle, gather=gather)
    return nrw
...
def qepy_get_grid_smooth(nr=None, gather=None):
    ...
    Defined at qepy_mod.fpp lines 284-300
    ...
    """
    nrw = libqepy_pw.f90wrap_qepy_get_grid_smooth(nr=nr, gather=gather)
    return nrw
...
def qepy_set_stdout(fname=None, uni=None, append=None):
    ...
    Defined at qepy_mod.fpp lines 302-328
    ...
    """
    libqepy_pw.f90wrap_qepy_set_stdout(fname=fname, uni=uni, append=append)
...
def qepy_write_stdout(fstr):
    ...
    Defined at qepy_mod.fpp lines 330-336
    ...
    """
    libqepy_pw.f90wrap_qepy_write_stdout(fstr=fstr)
...
def qepy_close_stdout(fname):
    ...
    Defined at qepy_mod.fpp lines 338-344
    ...
    """
    libqepy_pw.f90wrap_qepy_close_stdout(fname=fname)
...
def qepy_get_evc(ik, wfc=None):
    ...
    Defined at qepy_mod.fpp lines 346-360
    ...
    """
    libqepy_pw.f90wrap_qepy_get_evc(ik=ik, wfc=wfc)
...
def qepy_get_wf(ik, ibnd, wf, gather=None):
    ...
    Defined at qepy_mod.fpp lines 362-411
    ...
    """
    libqepy_pw.f90wrap_qepy_get_wf(ik=ik, ibnd=ibnd, wf=wf, gather=gather)
...
def qepy_get_vkb(ik, vk, gather=None):
    ...
    Defined at qepy_mod.fpp lines 413-466
    ...
    """
    libqepy_pw.f90wrap_qepy_get_vkb(ik=ik, vk=vk, gather=gather)
...
def qepy_set_extforces(forces):
    ...
    Defined at qepy_mod.fpp lines 468-477
    ...
    """
    libqepy_pw.f90wrap_qepy_set_extforces(forces=forces)
...
def qepy_calc_effective_potential(potential=None, gather=None):
    ...
    Defined at qepy_mod.fpp lines 479-507
    ...
    """
    libqepy_pw.f90wrap_qepy_calc_effective_potential(potential=potential, \
        gather=gather)
...
def qepy_set_effective_potential(potential, gather=None):
    ...
    Defined at qepy_mod.fpp lines 509-527
    ...
    """
    libqepy_pw.f90wrap_qepy_set_effective_potential(potential=potential, \
        gather=gather)
...
def qepy_calc_density(rhor=None, gather=None):
    ...
    Defined at qepy_mod.fpp lines 529-547
    ...
    """
    libqepy_pw.f90wrap_qepy_calc_density(rhor=rhor, gather=gather)
...
def qepy_diagonalize(iter=None, threshold=None):
    ...
    Defined at qepy_mod.fpp lines 549-567
    ...
    """
    libqepy_pw.f90wrap_qepy_diagonalize(iter=iter, threshold=threshold)
...
def qepy_update_ions(pos, ikind=None, lattice=None):
    ...
    Defined at qepy_mod.fpp lines 569-659
    ...
    ***********************************************************************
    -----------------------------------------------------------------------
    """
    libqepy_pw.f90wrap_qepy_update_ions(pos=pos, ikind=ikind, lattice=lattice)
...
def qepy_restart_from_xml():
    ...
    Defined at qepy_mod.fpp lines 661-677
    
    
    """
    libqepy_pw.f90wrap_qepy_restart_from_xml()
...
def qepy_sum_band(occupations=None):
    ...
    Defined at qepy_mod.fpp lines 679-703
    ...
    """
    libqepy_pw.f90wrap_qepy_sum_band(occupations=occupations)
...
def qepy_get_tau(tau, gather=None):
    ...
    Defined at qepy_mod.fpp lines 705-732
    ...
    """
    libqepy_pw.f90wrap_qepy_get_tau(tau=tau, gather=gather)
...
def qepy_open_files(io_level=None):
    ...
    Defined at qepy_mod.fpp lines 734-754
    ...
    """
    libqepy_pw.f90wrap_qepy_open_files(io_level=io_level)
...
def qepy_set_dft(dft=None):
    ...
    Defined at qepy_mod.fpp lines 756-796
    ...
    """
    libqepy_pw.f90wrap_qepy_set_dft(dft=dft)
...
def qepy_calc_kinetic_density(tau):
    ...
    Defined at qepy_mod.fpp lines 798-876
    ...
    """
    libqepy_pw.f90wrap_qepy_calc_kinetic_density(tau=tau)
...
def qepy_calc_kinetic_density_normal(tau):
    ...
    Defined at qepy_mod.fpp lines 878-955
    ...
    """
    libqepy_pw.f90wrap_qepy_calc_kinetic_density_normal(tau=tau)
...
def _mp_gather_real(fin, fout):
    ...
    """
    libqepy_pw.f90wrap_mp_gather_real(fin=fin, fout=fout)
...
def _mp_gather_complex(fin, fout):
    ...
    """
    libqepy_pw.f90wrap_mp_gather_complex(fin=fin, fout=fout)
...
def _mp_scatter_real(fin, fout):
    ...
    """
    libqepy_pw.f90wrap_mp_scatter_real(fin=fin, fout=fout)
...
def _mp_scatter_complex(fin, fout):
    ...
    """
    libqepy_pw.f90wrap_mp_scatter_complex(fin=fin, fout=fout)
...
def _qepy_get_value_real_1(fin, fout, gather=None, scatter=None):
    ...
    Defined at qepy_mod.fpp lines 83-113
    ...
    """
    libqepy_pw.f90wrap_qepy_get_value_real_1(fin=fin, fout=fout, gather=gather, \
        scatter=scatter)
...
def _qepy_get_value_real_2(fin, fout, gather=None, scatter=None):
    ...
    Defined at qepy_mod.fpp lines 115-138
    ...
    """
    libqepy_pw.f90wrap_qepy_get_value_real_2(fin=fin, fout=fout, gather=gather, \
        scatter=scatter)
