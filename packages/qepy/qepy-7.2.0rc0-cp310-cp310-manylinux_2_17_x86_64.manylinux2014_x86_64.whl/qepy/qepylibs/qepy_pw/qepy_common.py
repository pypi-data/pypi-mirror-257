...
class input_base(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = libqepy_pw.f90wrap_input_base_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            libqepy_pw.f90wrap_input_base_finalise(this=self._handle)
...
class tddft_base(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = libqepy_pw.f90wrap_tddft_base_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            libqepy_pw.f90wrap_tddft_base_finalise(this=self._handle)
...
class energies_base(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = libqepy_pw.f90wrap_energies_base_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            libqepy_pw.f90wrap_energies_base_finalise(this=self._handle)
...
class embed_base(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = libqepy_pw.f90wrap_embed_base_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            libqepy_pw.f90wrap_embed_base_finalise(this=self._handle)
...
def set_embed(self):
    ...
    """
    libqepy_pw.f90wrap_set_embed(obj=self._handle)
