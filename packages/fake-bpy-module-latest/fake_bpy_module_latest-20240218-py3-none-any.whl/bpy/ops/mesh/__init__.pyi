...
def blend_from_shape(
    ...
    undo=None,
    *,
    shape: typing.Optional[typing.Union[int, str, typing.Any]] = "",
    ...
    :type shape: typing.Optional[typing.Union[int, str, typing.Any]]
...
def colors_reverse(override_context=None, execution_context=None, undo=None):
...
def customdata_mask_clear(override_context=None, execution_context=None, undo=None):
...
def customdata_skin_add(override_context=None, execution_context=None, undo=None):
...
def customdata_skin_clear(override_context=None, execution_context=None, undo=None):
...
def edge_collapse(override_context=None, execution_context=None, undo=None):
...
def edge_face_add(override_context=None, execution_context=None, undo=None):
...
def face_split_by_edges(override_context=None, execution_context=None, undo=None):
...
def faces_shade_flat(override_context=None, execution_context=None, undo=None):
    """Display faces flat
...
def faces_shade_smooth(override_context=None, execution_context=None, undo=None):
...
def flip_quad_tessellation(override_context=None, execution_context=None, undo=None):
...
def loopcut(
    ...
    *,
    ...
    mesh_select_mode_init: typing.Optional[
        typing.Union[typing.Any, typing.List[bool]]
    ] = (False, False, False),
):
    ...
    :type mesh_select_mode_init: typing.Optional[typing.Union[typing.Any, typing.List[bool]]]
    """
...
def merge_normals(override_context=None, execution_context=None, undo=None):
...
def region_to_loop(override_context=None, execution_context=None, undo=None):
...
def select_by_attribute(override_context=None, execution_context=None, undo=None):
...
def select_interior_faces(override_context=None, execution_context=None, undo=None):
...
def select_next_item(override_context=None, execution_context=None, undo=None):
...
def select_prev_item(override_context=None, execution_context=None, undo=None):
...
def select_similar_region(override_context=None, execution_context=None, undo=None):
...
def shape_propagate_to_all(override_context=None, execution_context=None, undo=None):
...
def split_normals(override_context=None, execution_context=None, undo=None):
...
def uv_texture_add(override_context=None, execution_context=None, undo=None):
    """Add UV map
...
def uv_texture_remove(override_context=None, execution_context=None, undo=None):
    """Remove UV map
...
def uvs_reverse(override_context=None, execution_context=None, undo=None):
...
def vert_connect(override_context=None, execution_context=None, undo=None):
...
def vert_connect_concave(override_context=None, execution_context=None, undo=None):
...
def vert_connect_path(override_context=None, execution_context=None, undo=None):
