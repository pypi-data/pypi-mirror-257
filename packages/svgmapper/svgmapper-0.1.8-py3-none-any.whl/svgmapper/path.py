...
class Path:
    ...
    def write(self):
        ...
        # Handle interior coordinates (holes)
        for interior in self.geometry.interiors:
            interior_coordinates = interior.coords
            interior_data = [self.translate(x, y) for x, y in interior_coordinates]
            path_data += " M " + " ".join(interior_data) + " Z"
