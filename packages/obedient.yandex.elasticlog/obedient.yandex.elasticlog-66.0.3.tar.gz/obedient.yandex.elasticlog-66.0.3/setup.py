...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package obedient.yandex.elasticlog. Maybe you are using the wrong pypi?")


setup(
    name='obedient.yandex.elasticlog',
    version='66.0.3',
    author='Yandex',
