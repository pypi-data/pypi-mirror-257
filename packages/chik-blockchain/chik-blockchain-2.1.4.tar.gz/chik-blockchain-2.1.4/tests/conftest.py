...
from chik.simulator.setup_services import setup_crawler, setup_daemon, setup_introducer, setup_seeder, setup_timelord
...
async def two_wallet_nodes_custom_spam_filtering(
    ...
    async with setup_simulators_and_wallets(1, 2, blockchain_constants, spam_filter_after_n_txs, xck_spam_amount) as _:
        yield _
