...
class TestCATTrades:
    ...
    async def test_trade_cancellation(self, wallets_prefarm):
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(cat_for_chik, DEFAULT_TX_CONFIG)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(chik_for_cat, DEFAULT_TX_CONFIG)
        assert error is None
        assert success is True
        assert trade_make is not None
    ...
    async def test_aggregated_trade_state(self, wallets_prefarm):
        ...
        success, trade_make_1, error = await trade_manager_maker.create_offer_for_ids(chik_for_cat, DEFAULT_TX_CONFIG)
        ...
        success, trade_make_2, error = await trade_manager_maker.create_offer_for_ids(cat_for_chik, DEFAULT_TX_CONFIG)
