...
def get_spend_p2_singleton_puzzle(
    treasury_id: bytes32, xck_conditions: Optional[List], asset_conditions: Optional[List[Tuple]]  # type: ignore
) -> Program:
...
async def generate_mint_proposal_innerpuz(
    ...
    puzzle = get_spend_p2_singleton_puzzle(treasury_id, Program.to(xck_conditions), [])
    return puzzle
