...
class Year:
    # Object "Year" class for software "Project"
    
    properties = ['application', 'calendar', 'count', 'index', 'months', 'name', 'parent', 'shift1', 'shift2', 'shift3', 'shift4', 'shift5', 'working']
    ...
    @property         
    def months(self) -> "Any":
        return (self.native_obj.Months)
        
    @months.setter     
    def _set_months(self, value):
        self.native_obj.Months = value
