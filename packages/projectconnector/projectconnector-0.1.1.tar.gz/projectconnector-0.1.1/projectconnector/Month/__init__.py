...
class Month:
    # Object "Month" class for software "Project"
    
    properties = ['application', 'calendar', 'count', 'days', 'index', 'name', 'parent', 'shift1', 'shift2', 'shift3', 'shift4', 'shift5', 'working']
    ...
    @property         
    def days(self) -> "Any":
        return (self.native_obj.Days)
        
    @days.setter     
    def _set_days(self, value):
        self.native_obj.Days = value
