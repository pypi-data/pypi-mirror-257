...
class GroupCriterion:
    # Object "GroupCriterion" class for software "Project"
    
    properties = ['application', 'ascending', 'assignment', 'cellColor', 'fieldName', 'fontBold', 'fontColor', 'fontItalic', 'fontName', 'fontSize', 'fontUnderLine', 'groupInterval', 'groupOn', 'index', 'parent', 'pattern', 'startAt']
