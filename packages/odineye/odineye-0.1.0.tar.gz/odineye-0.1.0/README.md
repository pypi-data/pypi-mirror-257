...
This is a package for downloading satellite maps. Odin sees everything.
...
Location is specified by _**latitude**_ and _**longitude**_:
...
downloader = GoogleMapsDownloader(download_threads=16)
