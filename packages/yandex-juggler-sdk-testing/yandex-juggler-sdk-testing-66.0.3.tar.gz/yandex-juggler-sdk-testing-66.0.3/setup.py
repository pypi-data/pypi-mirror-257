...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-juggler-sdk-testing. Maybe you are using the wrong pypi?")


setup(
    name='yandex-juggler-sdk-testing',
    version='66.0.3',
    author='Yandex',
