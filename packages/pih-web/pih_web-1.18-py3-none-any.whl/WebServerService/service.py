    ...
    if A.U.for_service(SD, as_standalone=as_standalone):
        ...
        def read_root() -> HTMLResponse:
            ...
            ct_day_image_content: str = j(
                (
                    ...
                    A.D_CO.file_to_base64(A.PTH_STAT.get_file_path(A.CT_STAT.Types.CT_DAY)),
        ...
        async def on_action(action_name: str):
            ...
            for action in A.CT_ACT:
                ...
                if ne(action_description.alias) and action_name in action_description.alias:
        ...
        async def on_execute(file_name: str, request: Request):
            ...
            for item in request.query_params:
                if isinstance(item, tuple):
                    ...
                    index += 1
            result: list[str] | None = A.R_F.execute(file_name, {"parameters": parameters})
            if n(result):
