...
will be built for the same architecture (x86/ARM, 32/64 bit) as the
Python used. You can run the following commands:
...
bundle/pyinstaller.py accepts any arguments that can be passed to
...
Important: Running pyinstaller directly without using
bundle/pyinstaller.py is not officially supported. This may or may not
work correctly.
