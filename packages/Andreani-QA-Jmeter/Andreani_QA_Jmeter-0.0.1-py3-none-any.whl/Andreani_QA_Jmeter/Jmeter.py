...
class Jmeter(Functions, Parameters):
    ...
    def execute_jmx(self, mode_headless=True):
        ...
        escenario_jmx = Functions.get_path_escenario_jmx(self)
        # Obtiene la ruta en donde se encuentra el .jmx a utilizar
        result_jtl = Functions.create_and_get_path_report(self)
    ...
    @staticmethod
    def get_list_data_csv(file_csv):
    ...
    @staticmethod
    def generate_html_table_description(file_csv):
        ...
        list_data_csv = Functions.get_list_data_csv(file_csv)
    ...
    def attach_file_csv_with_description(self, file_csv, description):
        ...
        allure.attach(body=Functions.generate_html_table_description(file_csv), name="Descripcion tabla",
                      attachment_type=allure.attachment_type.HTML)

    @staticmethod
    def attach_file_png(file_png, description):
        ...
        list_data_csv = Functions.get_list_data_csv(Parameters.path_aggregate_report_csv_out)
    ...
    def attach_file_csv(self, description):
        ...
        file = Functions.get_path_data_csv(self)
    ...
    def attach_file_jmx(self, description):
        ...
        file = Functions.get_path_escenario_jmx(self)
    ...
    def validate_percentage_errors(self, porcentaje_tolerado):
        ...
        file_report = f"{Functions.get_path_downloads(self)}\\AggregateReport.csv"
    ...
    def create_and_get_path_report(self, name_file='report', extension_file='jtl'):
        ...
        file_report = f"{Functions.get_path_downloads(self)}\\{name_file}.{extension_file}"
