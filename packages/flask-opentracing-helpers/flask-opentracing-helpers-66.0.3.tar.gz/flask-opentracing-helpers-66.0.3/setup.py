...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package flask-opentracing-helpers. Maybe you are using the wrong pypi?")


setup(
    name='flask-opentracing-helpers',
    version='66.0.3',
    author='Yandex',
