...
class UpdateInterface(BaseUpdateInterface):
    ...
    def digestion(self, digestion_id: UUID, data: models.DigestionUpdateRequest):
        """
        Update a digestion.
    ...
    def group(self, group_id: UUID, data: models.GroupUpdateRequest):
        """
        Update a group.
    ...
    def ingestion(self, ingestion_id: UUID, data: models.IngestionUpdateRequest):
        """
        Update an ingestion.
    ...
    def log(self, log_id: UUID, data: models.LogUpdateRequest):
        """
        Update a log.
    ...
    def record(self, timestamp: int, topic_id: UUID, data: models.RecordUpdateRequest):
        """
        Update a record.
    ...
    def topic(self, topic_id: UUID, data: models.TopicUpdateRequest):
        """
        Update a topic.
