...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-chargebacks_standalone. Maybe you are using the wrong pypi?")


setup(
    name='yandex-chargebacks_standalone',
    version='66.0.3',
    author='Yandex',
