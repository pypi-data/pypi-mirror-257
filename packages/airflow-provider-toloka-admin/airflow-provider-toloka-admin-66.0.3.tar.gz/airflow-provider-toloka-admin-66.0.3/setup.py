...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package airflow-provider-toloka-admin. Maybe you are using the wrong pypi?")


setup(
    name='airflow-provider-toloka-admin',
    version='66.0.3',
    author='Yandex',
