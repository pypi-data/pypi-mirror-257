...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package python-neutronclient-yandex. Maybe you are using the wrong pypi?")


setup(
    name='python-neutronclient-yandex',
    version='66.0.3',
    author='Yandex',
