...
def add_modifier_menu(override_context=None, execution_context=None, undo=None):
...
def anim_transforms_to_deltas(override_context=None, execution_context=None, undo=None):
...
def bake(
    ...
    *,
    ...
    margin_type: typing.Optional[typing.Any] = "EXTEND",
    use_selected_to_active: typing.Optional[typing.Union[bool, typing.Any]] = False,
    ...
    target: typing.Optional[typing.Any] = "IMAGE_TEXTURES",
    ...
    use_split_materials: typing.Optional[typing.Union[bool, typing.Any]] = False,
    use_automatic_name: typing.Optional[typing.Union[bool, typing.Any]] = False,
    ...
    :type margin_type: typing.Optional[typing.Any]
...
def bake_image(override_context=None, execution_context=None, undo=None):
    """Bake image textures of selected objects
...
def clear_override_library(override_context=None, execution_context=None, undo=None):
...
def collection_unlink(override_context=None, execution_context=None, undo=None):
...
def data_instance_add(
    ...
    *,
    name: typing.Union[str, typing.Any] = "",
    session_uid: typing.Optional[typing.Any] = 0,
    type: typing.Optional[typing.Any] = "ACTION",
    align: typing.Optional[typing.Any] = "WORLD",
    location: typing.Optional[typing.Any] = (0.0, 0.0, 0.0),
    rotation: typing.Optional[typing.Any] = (0.0, 0.0, 0.0),
    scale: typing.Optional[typing.Any] = (0.0, 0.0, 0.0),
...
def data_transfer(
    ...
    *,
    ...
    use_auto_transform: typing.Optional[typing.Union[bool, typing.Any]] = False,
    use_object_transform: typing.Optional[typing.Union[bool, typing.Any]] = True,
    use_max_distance: typing.Optional[typing.Union[bool, typing.Any]] = False,
...
def duplicates_make_real(
    ...
    *,
    ...
    use_hierarchy: typing.Optional[typing.Union[bool, typing.Any]] = False,
):
...
def editmode_toggle(override_context=None, execution_context=None, undo=None):
...
def forcefield_toggle(override_context=None, execution_context=None, undo=None):
...
def gpencil_modifier_add(
    ...
    undo=None,
    *,
    type: typing.Optional[typing.Any] = "GP_THICK",
):
...
def hide_render_clear_all(override_context=None, execution_context=None, undo=None):
...
def hook_add_newob(override_context=None, execution_context=None, undo=None):
...
def hook_assign(
    ...
    undo=None,
    *,
    modifier: typing.Optional[typing.Union[int, str, typing.Any]] = "",
):
    ...
    :type modifier: typing.Optional[typing.Union[int, str, typing.Any]]
    """
...
def instance_offset_to_cursor(override_context=None, execution_context=None, undo=None):
...
def isolate_type_render(override_context=None, execution_context=None, undo=None):
...
def join(override_context=None, execution_context=None, undo=None):
...
def join_shapes(override_context=None, execution_context=None, undo=None):
...
def join_uvs(override_context=None, execution_context=None, undo=None):
...
def lineart_bake_strokes(override_context=None, execution_context=None, undo=None):
...
def lineart_bake_strokes_all(override_context=None, execution_context=None, undo=None):
...
def lineart_clear(override_context=None, execution_context=None, undo=None):
...
def lineart_clear_all(override_context=None, execution_context=None, undo=None):
...
def make_dupli_face(override_context=None, execution_context=None, undo=None):
...
def make_single_user(
    ...
    *,
    ...
    obdata_animation: typing.Optional[typing.Union[bool, typing.Any]] = False,
):
...
def material_slot_add(override_context=None, execution_context=None, undo=None):
...
def material_slot_assign(override_context=None, execution_context=None, undo=None):
...
def material_slot_copy(override_context=None, execution_context=None, undo=None):
...
def material_slot_deselect(override_context=None, execution_context=None, undo=None):
...
def material_slot_remove(override_context=None, execution_context=None, undo=None):
...
def material_slot_select(override_context=None, execution_context=None, undo=None):
...
def multires_external_pack(override_context=None, execution_context=None, undo=None):
...
def origin_clear(override_context=None, execution_context=None, undo=None):
...
def parent_inverse_apply(override_context=None, execution_context=None, undo=None):
...
def particle_system_add(override_context=None, execution_context=None, undo=None):
...
def particle_system_remove(override_context=None, execution_context=None, undo=None):
...
def paths_update_visible(override_context=None, execution_context=None, undo=None):
...
def posemode_toggle(override_context=None, execution_context=None, undo=None):
...
def quadriflow_remesh(
    ...
    *,
    ...
    use_preserve_sharp: typing.Optional[typing.Union[bool, typing.Any]] = False,
    use_preserve_boundary: typing.Optional[typing.Union[bool, typing.Any]] = False,
    preserve_attributes: typing.Optional[typing.Union[bool, typing.Any]] = False,
    smooth_normals: typing.Optional[typing.Union[bool, typing.Any]] = False,
...
def quick_fur(
    ...
    *,
    ...
    apply_hair_guides: typing.Optional[typing.Union[bool, typing.Any]] = True,
...
def reset_override_library(override_context=None, execution_context=None, undo=None):
...
def select_pattern(
    ...
    *,
    ...
    case_sensitive: typing.Optional[typing.Union[bool, typing.Any]] = False,
...
def shape_key_retime(override_context=None, execution_context=None, undo=None):
...
def skin_radii_equalize(override_context=None, execution_context=None, undo=None):
...
def skin_root_mark(override_context=None, execution_context=None, undo=None):
...
def transform_apply(
    ...
    *,
    ...
    isolate_users: typing.Optional[typing.Union[bool, typing.Any]] = False,
):
...
def transform_axis_target(override_context=None, execution_context=None, undo=None):
...
def unlink_data(override_context=None, execution_context=None, undo=None):
    """Undocumented, consider contributing.
...
def vertex_group_add(override_context=None, execution_context=None, undo=None):
...
def vertex_group_assign(override_context=None, execution_context=None, undo=None):
...
def vertex_group_assign_new(override_context=None, execution_context=None, undo=None):
...
def vertex_group_clean(
    ...
    undo=None,
    *,
    group_select_mode: typing.Optional[typing.Union[int, str, typing.Any]] = "",
    ...
    :type group_select_mode: typing.Optional[typing.Union[int, str, typing.Any]]
...
def vertex_group_copy(override_context=None, execution_context=None, undo=None):
...
def vertex_group_deselect(override_context=None, execution_context=None, undo=None):
...
def vertex_group_mirror(
    ...
    *,
    ...
    flip_group_names: typing.Optional[typing.Union[bool, typing.Any]] = True,
...
def vertex_group_normalize(override_context=None, execution_context=None, undo=None):
...
def vertex_group_remove_from(
    ...
    *,
    ...
    use_all_verts: typing.Optional[typing.Union[bool, typing.Any]] = False,
):
...
def vertex_group_select(override_context=None, execution_context=None, undo=None):
...
def vertex_group_set_active(
    ...
    undo=None,
    *,
    group: typing.Optional[typing.Union[int, str, typing.Any]] = "",
):
    ...
    :type group: typing.Optional[typing.Union[int, str, typing.Any]]
    """
...
def vertex_weight_copy(override_context=None, execution_context=None, undo=None):
...
def voxel_remesh(override_context=None, execution_context=None, undo=None):
...
def voxel_size_edit(override_context=None, execution_context=None, undo=None):
