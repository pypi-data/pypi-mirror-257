...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package tornado-opentracing-helpers. Maybe you are using the wrong pypi?")


setup(
    name='tornado-opentracing-helpers',
    version='66.0.3',
    author='Yandex',
