...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package statinfra-clickhouse-sqlalchemy. Maybe you are using the wrong pypi?")


setup(
    name='statinfra-clickhouse-sqlalchemy',
    version='66.0.3',
    author='Yandex',
