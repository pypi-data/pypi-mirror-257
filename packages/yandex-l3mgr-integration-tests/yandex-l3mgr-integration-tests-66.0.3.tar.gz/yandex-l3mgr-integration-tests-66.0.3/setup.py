...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-l3mgr-integration-tests. Maybe you are using the wrong pypi?")


setup(
    name='yandex-l3mgr-integration-tests',
    version='66.0.3',
    author='Yandex',
