...
class ParrotAPI:
    ...
    def __init__(self, api_endpoint: str = "http://api.joinparrot.ai/v1") -> None:
    ...
    def create_config(self, rotation: str = "square", steps: int = 20, negative_prompt: str = "") -> Dict[str, Any]:
    ...
    def create_sd_task(self, prompt: str, rotation: str = "square", steps: int = 20, negative_prompt: str = "") -> Dict[str, Any]:
