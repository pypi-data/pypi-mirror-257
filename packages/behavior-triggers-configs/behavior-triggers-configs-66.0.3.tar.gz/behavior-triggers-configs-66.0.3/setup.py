...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package behavior-triggers-configs. Maybe you are using the wrong pypi?")


setup(
    name='behavior-triggers-configs',
    version='66.0.3',
    author='Yandex',
