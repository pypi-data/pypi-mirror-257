...
class Client(Session, Wss):
    ...
    def send_verify_code(self: typing_extensions.Self, email: str, resetPassword: bool = False, key: typing.Optional[str] = None) -> Json:
    ...
    def verify_account(self, email: str, key: str) -> Json:
    ...
    def activate_account(self: typing_extensions.Self, email: str, code: str) -> Json:
