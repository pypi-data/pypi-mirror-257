...
class AsyncClient(AsyncSession, AsyncWss):
    ...
    async def send_verify_code(self: typing_extensions.Self, email: str, resetPassword: bool = False, key: typing.Optional[str] = None) -> Json:
    ...
    async def verify_account(self, email: str, key: str) -> Json:
    ...
    async def activate_account(self: typing_extensions.Self, email: str, code: str) -> Json:
