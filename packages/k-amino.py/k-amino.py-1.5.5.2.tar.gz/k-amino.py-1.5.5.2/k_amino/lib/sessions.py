...
class Session(Headers):
    ...
    def getRequest(self: typing_extensions.Self, url: str, params: typing.Optional[typing.Dict[str, typing.Any]] = None) -> typing.Union[typing.Dict[str, typing.Any], typing.NoReturn]:
        ...
        with httpx.Client(proxies=self.proxies, timeout=self.timeout) as session:
            req = session.get(url=url, params=params, headers=headers)
            if self.debug:
