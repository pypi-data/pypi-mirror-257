...
system = "rcee"       # Directory name of the project
...
authors = [
    ...
    {name = "Bert Van Acker", email = "bert.vanacker@uantwerpen.be"},
]
readme = "README.md"
...
dependencies = [
{%- for dependency in requirements.rcee %}
    "{{ dependency }}",
{%- endfor %}
]
