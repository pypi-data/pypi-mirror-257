...
class Orden(BaseModel):
    ...
    def parse_xml(
        ...
        orden_element,
        categoria: types.CategoriaOrdenPago,
        origin_institution: types.ClaveOrdenanteOrdenPago = None,
    ):
        orden_data = {
        ...
        if 'op_ins_clave_ord' not in orden_data:
            orden_data['op_ins_clave_ord'] = origin_institution
