...
class OstreeOstreeRefResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, artifact=None, relative_path=None, commit=None, checksum=None, name=None, local_vars_configuration=None):  # noqa: E501
