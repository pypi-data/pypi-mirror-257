...
def db_download(environment):
    ...
    username = f"{config.exonet_project_name}_{environment}"
...
def db_copy(from_environment, to_environment):
    ...
    from_username = f"{from_config.exonet_project_name}_{from_environment}"
    to_username = f"{to_config.exonet_project_name}_{to_environment}"
