...
def list_all_file_paths(directory=env.relative_path('codebase'), extensions=env.NONTRVIVIAL_FILES, exclude_dirs=env.EXCLUDE_FOLDERS):
    """
...
def find_closest_file_path(target_filepath, directory=env.relative_path('codebase'), extensions=env.NONTRVIVIAL_FILES, exclude_dirs=env.EXCLUDE_FOLDERS):
    """
