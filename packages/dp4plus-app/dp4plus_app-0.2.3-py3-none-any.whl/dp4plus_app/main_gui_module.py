...
def gui_input():
    ...
    title.grid(row=0,column=0,columnspan=2,rowspan=2,sticky='W', padx=(13,0))
    ...
    button_userguide = tk.Button(root, text='User Guide', 
                               command=user_guide)
    button_userguide.grid(row=0,column=4,sticky='', padx=10)
    #-----------------------------------------------------------------
    button_example = tk.Button(root, text='Create Example', 
                               command=example)
    button_example.grid(row=1,column=4,sticky='', padx=10)
    #-----------------------------------------------------------------    
    def out():
        global the_lev
        the_lev = None 
    ...
    button_end = tk.Button(root, text='Exit', 
                           command=out)
    button_end.grid(row=7,column=4,sticky='')
    #-----------------------------------------------------------------
    global button_run
    button_run = tk.Button(root, text='Run',
                                ...
                                state='disabled')
    button_run.grid(row=7,column=0,sticky='W', padx=(13,2))   
    #-----------------------------------------------------------------
    ...
    mode_ddl.grid(row=2,column=0,sticky='', padx=(5,2))
    #-----------------------------------------------------------------
    ...
    func_ddl.grid(row=2,column=1,sticky='', padx=2)
    #-----------------------------------------------------------------
    ...
    base_ddl.grid(row=2,column=2,sticky='', padx=2)
    #-----------------------------------------------------------------
    ...
    solv_ddl.grid(row=2,column=3,sticky='', padx=2)
    #-----------------------------------------------------------------
    ...
    solvent_ddl.grid(row=2,column=4,sticky='', padx=2)
    #-----------------------------------------------------------------
    ...
    button_xlsx = tk.Button(root, text='Select Excel',
                           ...
                           state='disabled')
    button_xlsx.grid(row=6,column=0,sticky='W', padx=(13,2))
    #-----------------------------------------------------------------
    button_dir = tk.Button(root, text='Select Directory',
                           font=("Helvetica", 10),
                           command=lambda: select_dir (),
                           state='disabled')
    button_dir.grid(row=3,column=0,sticky='W', padx=(13,2))
    
    [tk.Label(root, text=' ').grid(row=i,column=1,sticky='',columnspan=4) for i in [3,4,5]]
    [root.rowconfigure(i, pad = 5) for i in range (2,8)]
...
def select_dir():
    ...
    tk.Label(root, text=' ', 
             height = 5, width= 60 ).grid(row=3,column=1,sticky='W',
                                        rowspan=3,columnspan=4)
    
    singboard = tk.Label(root, text='')
    singboard.grid(row=3,column=1,sticky='W',columnspan=4)
    ...
    tk.Label(root, text=f'Isomeric Candidates:  {isomer_list}').grid(row=4,
                                                                     column=1,
                                                                     sticky='W',
                                                                     columnspan=4)
...
def select_xlsx():
    ...
    '''
    global xlsx
    xlsx = filedialog.askopenfilename(title='Select Excel',
                                   filetypes=[('Excel files',['*.xlsx','*.xls','*.xlsm','*.xlsb']),
                                              ('OpenOffice files',['*.ods','*.odt','*.odf']),
                                              ('All files','*')])
    
    singboard = tk.Label(root,text = '',  width=60, anchor = 'w')
    singboard.grid(row=6,column=1,sticky='W',columnspan=4)
    
    if xlsx == '':
        singboard ['text'] = '<- Select exp. data file'
        button_run['state'] = 'disable'
        return
    elif 'shifts' not in pd.ExcelFile(xlsx).sheet_names: 
...
def run_calc():
    ...
    if button_run['text'] == 'Run':
        ...
        tk.Label(root,text='Processing . . .').grid(row=7,column=1,sticky='W',columnspan=2)
        ...
        tk.Label(root,text='Redirecting . . .').grid(row=7,column=1,sticky='W',columnspan=2)
                ...
                if 'GAS' in solv_list.get():
                    ...
                    if 'PCM' in solv_list.get(): 
                        if 'smd' in G09command.casefold(): 
                            warn.append('PCM does not match selection')
                    else: 
                        if 'smd' not in G09command.casefold():
                            warn.append('SMD does not match selection')
