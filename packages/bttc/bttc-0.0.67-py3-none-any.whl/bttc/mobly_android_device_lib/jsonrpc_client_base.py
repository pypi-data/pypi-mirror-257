...
from mobly.controllers.android_device_lib import callback_handler_v2 as callback_handler  # noqa
...
class JsonRpcClientBase(abc.ABC):
  ...
  def _rpc(self, method, *args):
    ...
    if result.get('callback') is not None:
      ...
      return callback_handler.CallbackHandlerV2(callback_id=result['callback'],
