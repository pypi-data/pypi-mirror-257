...
class SIndLinear(nn.Module):
    # Linear model
    def __init__(self, input_dim):
        super(SIndLinear, self).__init__()
...
class SIndMLP(nn.Module):

    def __init__(self, input_dim):
        super(SIndMLP, self).__init__()
