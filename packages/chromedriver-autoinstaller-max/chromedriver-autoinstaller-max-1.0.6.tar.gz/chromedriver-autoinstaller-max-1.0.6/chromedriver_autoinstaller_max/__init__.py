...
def install(cwd: bool = False, path: Optional[AnyStr] = None, no_ssl: bool = False, make_version_dir: bool = True, detect_installed_version: bool = True):
    """
    ...
    if cwd:
        path = os.getcwd()
    chromedriver_filepath = utils.download_chromedriver(path, no_ssl, make_version_dir, detect_installed_version)
