    ...
    for data in cls.__annotations__.items():
        ...
        if not name.startswith("__") and not name.startswith("_"):
            ...
            if "c_char" in rest.__name__ and "Array" in rest.__name__:
                ...
                setattr(cls, name, property(str_getter))
                name = under_name
                ...
                setattr(cls, name, property(uuid_getter))
                name = under_name
                ...
                def enum_getter(self, under_name=under_name):
                    return enum_type(getattr(self, under_name))

                setattr(cls, name, property(enum_getter))
                name = under_name
                ...
                setattr(cls, name, property(int_getter))
                name = under_name
                ...
                setattr(cls, name, property(float_getter))
                name = under_name
                ...
                setattr(cls, name, property(bool_getter))
                name = under_name
