...
#
# from tools.cui_qiu_client import CuiQiuClient
# from tools.discord import QDiscord
# from tools.geetest4_fullpage.geetest_v4 import GeetestV4
# from tools.qg_geetest4.qgeetest_v4 import QGeetestV4
# from tools.qg_util import QGUtil
# from tools.qg_eth import QGEth
# from tools.random_util import RandomGenerator
# from tools.twitter import QTwitter
#
#
# class Galxe(QGEth):
...
#         self.gt = GeetestV4("244bcb8b9846215df5af4c624a750db4")
...
#         solution = self.gt.solve_captcha()
...
#                 elif "TWITTER_FOLLOW" in x["credSource"]:
#                     # 关注 推特
...
#                     self.add_typed_credential_items(x)
#                 elif "TWITTER_RT" in x["credSource"]:
#                     # 转推
...
#                         self.q_twitter.retweet(tweet_id)
#                         self.add_typed_credential_items(x)
#                 elif "TWITTER_LIKE" in x["credSource"]:
#                     # 喜欢 推特
#                     query_params = parse_qs(urlparse(x["referenceLink"]).query)
#                     tweet_id = query_params.get('tweet_id', [None])[0]
...
#         if self.userinfo.get("hasTwitter"):
#             return
#         # 生成发推链接，然后去发推
...
#         # 发推成功后，再验证
#         tweet_url = f"https://twitter.com/qgx_dev/status/{rest_id}"
#         json_data = {
...
#         response = self.galxe_session.post('https://graphigo.prd.galaxy.eco/query', json=json_data)
#         if response.status_code == 200:
#             print(f"【{self.index}】【{self.address}】发送短信成功！")
#             # 获取邮箱验证码并验证
...
#         total_point = sum([z["rewardCount"] for x in detail["credentialGroups"] for z in x["rewards"] if
#                            z["rewardType"] == "LOYALTYPOINTS"])
#         total_point2 = sum([z["rewardCount"] for x in detail["credentialGroups"] for z in x["rewards"] if
#                            z["rewardType"] == "LOYALTYPOINTSMYSTERYBOX"])
#         if detail['claimedLoyaltyPoints'] >= total_point and total_point:
#             print(f'【{self.index}】【{self.address}】【{campaign_id}】【{credential_group_id}】此组任务已领取奖励')
#             return "skip"
#         if not total_point2 and not total_point:
#             print(f'【{self.index}】【{self.address}】【{campaign_id}】【{credential_group_id}】此组任务已领取奖励')
#             return "skip"
#         # solution = self.get_captcha_by_2captcha()
#         solution = self.get_captcha_by_qg()
...
#             # QGUtil.save_to_file("无实名.txt",log)
...
#         #     "data": {
#         #         "preparePassport": {
#         #             "data": "{\"body\":\"{\\\"owner\\\":\\\"0x4CC6E09Dab3980782B7c11F5272531AE011f258B\\\",\\\"plain\\\":\\\"\\\",\\\"salt\\\":\\\"evoHceV8j5C7NIzqf8KBpSI99q5pGu-l\\\"}\",\"signature\":\"9zKsYI7x2QskgGtKxhFggpUhDilACG7PCRTITAIzph08LY0KCrTPuda6pN7+idSNydFAnLzJfmh//HcA4ACC0gE=\"}",
#         #             "__typename": "SignedCred"
#         #         }
#         #     }
#         # }
#         response = self.galxe_session.post('https://graphigo.prd.galaxy.eco/query', json=json_data)
...
#             log = f'{self.index}----{self.address}'
#             QGUtil.save_to_file("已mint2.txt", log)
#         else:
...
#         QGUtil.save_to_file(f"{self.space}-1-100-3.txt", log)
#
#
# def qg_task(index, address, private_key, mnemonic, email, twitter_info, dis_info):
#     # 项目编码
#     # space = "mantanetwork"
#     # space = "OmniNetwork"
#     # space = 'TrekkiNFT'
...
#     # space = "bnbchain"
#     # space = "burnt"
#     galxe = Galxe(index=index, address=address, private_key=private_key, mnemonic=mnemonic, space=space,
#                   twitter_info=twitter_info, dis_info=dis_info, ref_code="")
#     # galxe.init_chains("bsc")
#     # if galxe.bsc_balance <= 0.0251:
#     #     print(f"{address}，余额不足{galxe.bsc_balance}")
#     #     return
#     galxe.galaxy_login()
#     galxe.get_userinfo()
#
#     # 获取KYC链接
#     # galxe.get_passport_url()
#     # mint pass
#     # galxe.mint_pass_step_1()
#     # galxe.mint_pass_step_2()
#     # # 绑定邮箱
#     # galxe.bind_email(email1)
#     # 取消绑定dis
#     # galxe.remove_dis()
#     # 取消绑定推特
#     # galxe.remove_twitter()
#     # # 绑定dis
#     galxe.bind_dis(dis_info.get("token"))
#     # 绑定推特
#     galxe.bind_twitter()
#     # 初始化推特（必要）
#     galxe.init_twitter()
#     # 获取整个空间下所有任务，分组自动展开并全统计
#     tasks = galxe.get_space_campaigns()
#     # 做整个任务
#     galxe.do_task_item(tasks)
#     # tasks = galxe.get_space_campaigns()
#     # 验证所有分组任务(按分组进行验证)
#     galxe.verify_group_task(tasks)
#     # 获取某个项目的总得分
#     galxe.get_space_total_score()
#
#
# if __name__ == '__main__':
#     file_path = 'galxe_qg.yaml'
#     # file_path = 'all.yaml'
#     accounts = QGUtil.read_yaml(file_path)['accounts']
#     # accounts = QGUtil.csv_to_array("Taki100.csv")
#     # accounts = QGUtil.txt_to_array("../wallets/accounts-汇总.txt")
#     executor = concurrent.futures.ThreadPoolExecutor(max_workers=1)
#     for i, account in enumerate(accounts, start=1):
#         addr1 = account.get('address')
#         pk1 = account.get('private_key')
#         mn1 = ""
#         dis_tk = account.get('discord').get('token')
#         email1 = account.get('email')
#         twitter_info1 = account.get('twitter')
#         dis_info1 = account.get('discord')
#
#         # addr1 = account[0]
#         # pk1 = account[1]
#         # # addr1 = account.get('addr')
#         # # pk1 = account.get('pk')
#         # mn1 = ""
#         # email1 = ""
#         # twitter_info1 = ""
#         # dis_info1 = ""
#         if 2 <= i <= 2:
#             executor.submit(qg_task, i, addr1, pk1, mn1, email1, twitter_info1, dis_info1)
