...
class ETFHoldings:
    def __init__(self, r):
        ...
        self.changeRatio = [round(float(i.get('changeRatio', None))*100,2) for i in datalists]
        self.shareNumber = [i.get('shareNumber', None) for i in datalists]
        self.ratio = [round(float(i.get('ratio', None))*100,2) for i in datalists]
