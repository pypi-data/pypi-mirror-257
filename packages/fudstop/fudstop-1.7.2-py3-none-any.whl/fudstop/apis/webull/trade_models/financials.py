...
class FinancialStatement:
    def __init__(self, r):
        ...
        self.total_revenue = [float(i.get("totalRevenue")) if i.get("totalRevenue") is not None else None for i in data]
        self.revenue = [float(i.get("revenue")) if i.get("revenue") is not None else None for i in data]
        self.cost_of_revenue_total = [float(i.get("costofRevenueTotal")) if i.get("costofRevenueTotal") is not None else None for i in data]
        self.gross_profit = [float(i.get("grossProfit")) if i.get("grossProfit") is not None else None for i in data]
        self.operating_expense = [float(i.get("operatingExpense")) if i.get("operatingExpense") is not None else None for i in data]
        self.sell_gen_admin_expenses = [float(i.get("sellGenAdminExpenses")) if i.get("sellGenAdminExpenses") is not None else None for i in data]
        self.depreciation_and_amortization = [float(i.get("depreciationAndAmortization")) if i.get("depreciationAndAmortization") is not None else None for i in data]
        self.inter_expse_inc_net_oper = [float(i.get("interExpseIncNetOper")) if i.get("interExpseIncNetOper") is not None else None for i in data]
        self.unusual_expense_income = [float(i.get("unusualExpenseIncome")) if i.get("unusualExpenseIncome") is not None else None for i in data]
        self.operating_income = [float(i.get("operatingIncome")) if i.get("operatingIncome") is not None else None for i in data]
        self.inter_inc_expse_net_non_oper = [float(i.get("interIncExpseNetNonOper")) if i.get("interIncExpseNetNonOper") is not None else None for i in data]
        self.net_income_before_tax = [float(i.get("netIncomeBeforeTax")) if i.get("netIncomeBeforeTax") is not None else None for i in data]
        self.income_tax = [float(i.get("incomeTax")) if i.get("incomeTax") is not None else None for i in data]
        self.net_income_after_tax = [float(i.get("netIncomeAfterTax")) if i.get("netIncomeAfterTax") is not None else None for i in data]
        self.net_income_before_extra = [float(i.get("netIncomeBeforeExtra")) if i.get("netIncomeBeforeExtra") is not None else None for i in data]
        self.total_extraordinary_items = [float(i.get("totalExtraordinaryItems")) if i.get("totalExtraordinaryItems") is not None else None for i in data]
        self.net_income = [float(i.get("netIncome")) if i.get("netIncome") is not None else None for i in data]
        self.income_avaito_com_excl_extra_ord = [float(i.get("incomeAvaitoComExclExtraOrd")) if i.get("incomeAvaitoComExclExtraOrd") is not None else None for i in data]
        self.income_avaito_com_incl_extra_ord = [float(i.get("incomeAvaitoComInclExtraOrd")) if i.get("incomeAvaitoComInclExtraOrd") is not None else None for i in data]
        self.diluted_net_income = [float(i.get("dilutedNetIncome")) if i.get("dilutedNetIncome") is not None else None for i in data]
        self.diluted_weighted_average_shares = [float(i.get("dilutedWeightedAverageShares")) if i.get("dilutedWeightedAverageShares") is not None else None for i in data]
        self.diluted_eps_excl_extra_items = [float(i.get("dilutedEPSExclExtraItems")) if i.get("dilutedEPSExclExtraItems") is not None else None for i in data]
        self.diluted_eps_incl_extra_items = [float(i.get("dilutedEPSInclExtraItems")) if i.get("dilutedEPSInclExtraItems") is not None else None for i in data]
        self.diluted_normalized_eps = [float(i.get("dilutedNormalizedEPS")) if i.get("dilutedNormalizedEPS") is not None else None for i in data]
        self.operating_profit = [float(i.get("operatingProfit")) if i.get("operatingProfit") is not None else None for i in data]
        self.earning_after_tax = [float(i.get("earningAfterTax")) if i.get("earningAfterTax") is not None else None for i in data]
        self.earning_before_tax = [float(i.get("earningBeforeTax")) if i.get("earningBeforeTax") is not None else None for i in data]
...
class CashFlow:
    def __init__(self, r):
        ...
        self.fiscal_year = [i.get('fiscalYear') if i.get('fiscalYear') is not None else None for i in data]
        self.fiscal_period = [i.get('fiscalPeriod') if i.get('fiscalPeriod') is not None else None for i in data]
        self.end_date = [i.get('endDate') if i.get('endDate') is not None else None for i in data]
        self.currency_id = [float(i.get('currencyId')) if i.get('currencyId') is not None else None for i in data]
        self.publish_date = [i.get('publishDate') if i.get('publishDate') is not None else None for i in data]
        self.cash_from_operating_activities = [float(i.get('cashfromOperatingActivities')) if i.get('cashfromOperatingActivities') is not None else None for i in data]
        self.net_income = [float(i.get('netIncome')) if i.get('netIncome') is not None else None for i in data]
        self.depreciation_and_amortization = [float(i.get('depreciationAndAmortization')) if i.get('depreciationAndAmortization') is not None else None for i in data]
        self.deferred_taxes = [float(i.get('deferredTaxes')) if i.get('deferredTaxes') is not None else None for i in data]
        self.non_cash_items = [float(i.get('nonCashItems')) if i.get('nonCashItems') is not None else None for i in data]
        self.changes_in_working_capital = [float(i.get('changesinWorkingCapital')) if i.get('changesinWorkingCapital') is not None else None for i in data]
        self.cash_from_investing_activities = [float(i.get('cashfromInvestingActivities')) if i.get('cashfromInvestingActivities') is not None else None for i in data]
        self.capital_expenditures = [float(i.get('capitalExpenditures')) if i.get('capitalExpenditures') is not None else None for i in data]
        self.other_investing_cashflow_items_total = [float(i.get('otherInvestingCashFlowItemsTotal')) if i.get('otherInvestingCashFlowItemsTotal') is not None else None for i in data]
        self.cash_from_financing_activities = [float(i.get('cashfromFinancingActivities')) if i.get('cashfromFinancingActivities') is not None else None for i in data]
        self.financing_cashflow_items = [float(i.get('financingCashFlowItems')) if i.get('financingCashFlowItems') is not None else None for i in data]
        self.total_cash_dividends_paid = [float(i.get('totalCashDividendsPaid')) if i.get('totalCashDividendsPaid') is not None else None for i in data]
        ...
        self.issuance_retirement_of_debt_net = [float(i.get('issuanceRetirementofDebtNet')) if i.get('issuanceRetirementofDebtNet') is not None else None for i in data]
        self.foreign_exchange_effects = [float(i.get('foreignExchangeEffects')) if i.get('foreignExchangeEffects') is not None else None for i in data]
        self.net_change_in_cash = [float(i.get('netChangeinCash')) if i.get('netChangeinCash') is not None else None for i in data]
...
class BalanceSheet:
    def __init__(self, r):
        ...
        self.prepaidExpenses = [float(i.get('prepaidExpenses')) if i.get('prepaidExpenses') is not None else None for i in data]
