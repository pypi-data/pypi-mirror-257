...
def format_large_number(number):
    ...
    if abs_number < 1000:
        ...
        return f"{'-' if number < 0 else ''}{abs_number/1000:.1f}K"
    elif 1000000 <= abs_number < 1000000000:
        return f"{'-' if number < 0 else ''}{abs_number/1000000:.1f}M"
    elif 1000000000 <= abs_number:
        return f"{'-' if number < 0 else ''}{abs_number/1000000000:.1f}B"
    else:
        return str(number)
