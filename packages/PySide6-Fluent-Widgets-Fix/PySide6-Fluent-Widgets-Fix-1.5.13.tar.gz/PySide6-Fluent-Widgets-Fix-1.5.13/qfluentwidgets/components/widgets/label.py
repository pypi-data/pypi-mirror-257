...
class ImageLabel(QLabel):
    ...
    * ImageLabel(`image`: str | QImage | QPixmap, `parent`: QWidget = None)
    ...
    def __init__(self, parent: QWidget = None):
        ...
        self._postInit()
        self.QPainterAntialiasing = QPainter.Antialiasing
        self.IgnoreAspectRatio = Qt.IgnoreAspectRatio
        self.SmoothTransformation = Qt.SmoothTransformation
        self.NoPen = Qt.NoPen
    ...
    def paintEvent(self, e):
        ...
        painter = QPainter(self)
        painter.setRenderHints(self.QPainterAntialiasing)
        ...
        image = self.image.scaled(
            self.size()*self.devicePixelRatioF(), self.IgnoreAspectRatio, self.SmoothTransformation)
