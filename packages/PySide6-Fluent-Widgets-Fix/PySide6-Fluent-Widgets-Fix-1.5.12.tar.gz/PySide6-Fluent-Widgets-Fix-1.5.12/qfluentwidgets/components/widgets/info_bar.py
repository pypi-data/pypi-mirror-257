...
class InfoIconWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        painter.setRenderHints(QtEnum.QPainter.Antialiasing |
                               QtEnum.QPainter.SmoothPixmapTransform)
...
class InfoBarManager(QObject):
    ...
    def eventFilter(self, obj, e: QEvent):
        ...
        if e.type() in [QtEnum.QEvent.Resize, QtEnum.QEvent.WindowStateChange]:
            size = e.size() if e.type() == QtEnum.QEvent.Resize else None
