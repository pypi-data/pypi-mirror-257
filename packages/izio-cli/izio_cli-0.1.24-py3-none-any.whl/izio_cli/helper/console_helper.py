...
def updateGradle(root, bundleId, appName):
    ...
    if os.path.exists(f"{root}/loyalty2_0/android/app/src/prod/res/values/strings.xml"):
        os.remove(f"{root}/loyalty2_0/android/app/src/prod/res/values/strings.xml")
        
    with open(f"{root}/loyalty2_0/android/app/build.gradle", "r") as file:
        data = file.read()
        ...
        with open(f"{root}/loyalty2_0/android/app/build.gradle", "w") as file:
            file.write(data)
