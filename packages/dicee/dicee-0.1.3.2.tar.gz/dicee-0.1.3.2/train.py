...
max_iters = 10  # 600000  # total number of training iterations
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
# data_dir = "out-shakespeare-char"
with open("KGs/Countries-S1/train.txt", "r") as r:
    train_data = "\n\n".join((i.strip() for i in r.readlines()))
train_data = np.array(tiktoken.get_encoding("gpt2").encode(train_data))
...
while True:
    ...
    if True:  # iter_num % eval_interval == 0 and master_process:
