...
temperature = 0.01  # 0.8 # 1.0 = no change, < 1.0 = less random, > 1.0 = more random, in predictions
top_k = 10  # 200  # retain only the top_k most likely tokens, clamp others to have 0 probability
seed = 1337
