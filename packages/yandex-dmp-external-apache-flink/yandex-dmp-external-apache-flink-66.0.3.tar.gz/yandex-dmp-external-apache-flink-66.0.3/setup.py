...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-dmp-external-apache-flink. Maybe you are using the wrong pypi?")


setup(
    name='yandex-dmp-external-apache-flink',
    version='66.0.3',
    author='Yandex',
