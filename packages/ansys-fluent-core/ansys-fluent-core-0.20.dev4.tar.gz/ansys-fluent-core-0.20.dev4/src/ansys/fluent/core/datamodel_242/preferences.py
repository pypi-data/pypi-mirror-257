...
class Root(PyMenu):
    ...
    class MeshingWorkflow(PyMenu):
        ...
        """
        def __init__(self, service, rules, path):
            self.CADOptions = self.__class__.CADOptions(service, rules, path + [("CADOptions", "")])
        ...
        class CADOptions(PyMenu):
            """
            Singleton CADOptions.
            """
            def __init__(self, service, rules, path):
                self.Refaceter = self.__class__.Refaceter(service, rules, path + [("Refaceter", "")])
                super().__init__(service, rules, path)

            class Refaceter(PyTextual):
                """
                Parameter Refaceter of value type str.
                """
                pass
