...
class report:
    ...
    def forces(self, option: str, domain: str, all_wall_zones: bool, wall_zones: List[str], direction_vector: List[Union[float, str]], momentum_center: List[Union[float, str]], momentum_axis: List[Union[float, str]], pressure_coordinate: str, coordinate_value: Union[float, str], write_to_file: bool, file_name_1: str, append_data: bool):
        """
        'forces' command.
    ...
    def summary(self, write_to_file: bool, file_name_1: str):
        """
    ...
    def vbm(self, output_quantity: str, rotor_name: str, scale_output: bool, write_to_file: bool, file_name_1: str, append: bool):
        """
        'vbm' command.
