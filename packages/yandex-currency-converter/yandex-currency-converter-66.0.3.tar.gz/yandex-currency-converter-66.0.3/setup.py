...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-currency-converter. Maybe you are using the wrong pypi?")


setup(
    name='yandex-currency-converter',
    version='66.0.3',
    author='Yandex',
