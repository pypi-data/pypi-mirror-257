...
from ImScript.FrontEnd.Lexer import Lexer
from ImScript.FrontEnd.Parser import Parser
from ImScript.BackEnd.Core import Core
from ImScript.FrontEnd.funcsForCommands import *
    ...
    match argv[1:]:
        ...
        case ['info']:
            rprint(
                ...
                '[blue]*[/] Company: [green]Immeptor[/]\n'
                '[blue]*[/] Link: [green]https://immeptor.ru/[/]\n'
