...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package items-cooker-test-matched-text. Maybe you are using the wrong pypi?")


setup(
    name='items-cooker-test-matched-text',
    version='66.0.3',
    author='Yandex',
