    ...
    if illusts:
        for illust in illusts:
            if illust["meta_pages"]:
                img_ori = illust["meta_pages"][0]["image_urls"]["large"]
            else:
            ...
            images = {
                ...
                "img_original": illust["image_urls"]["large"] # tambahan
        ...
        if 'meta_pages' in illusts and illusts['meta_pages']:
            for illust in illusts['meta_pages']:
                images = {
                    "img_thumb": illust["image_urls"]["medium"],
                    "img_sample": illust["image_urls"]["medium"],
                    "img_original": illust["image_urls"]["large"]
                }
                media_post = {
                    'id': str(illusts["id"]),
                    'title': illusts["title"],
            ...
            images = {
                ...
                "img_original": illusts["image_urls"]["large"] # tambahan
