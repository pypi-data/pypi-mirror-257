...
def get_databricks_log_properties(dbutils) -> Dict:  # type: ignore
    ...
    run_id = context.get("currentRunId") or context["tags"]["notebookId"] + '(Notebook execution)'
    job_start_time = context["tags"].get("jobTriggerTime")
    databricks_properties = {
        "job_id": f"{cluster_id}.{job_id}.{run_id}",
        "cluster_id": cluster_id,
        "job_start_time": job_start_time or 'Notebook execution',
    }
