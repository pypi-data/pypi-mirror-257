...
class RecordingMediumDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isrc", "spotifyId", "tags", "genrePredictions", "musicalFeatures", "recordingPartyEntities", "genres", "languageOfPerformance", "releaseDate", "titles", "tracks"]
