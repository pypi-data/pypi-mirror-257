...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-browser-test-framework. Maybe you are using the wrong pypi?")


setup(
    name='yandex-browser-test-framework',
    version='66.0.3',
    author='Yandex',
