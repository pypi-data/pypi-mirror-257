...
from src.core.params import PROJECT_ROOT_PATH
from src.core.params import pyproject_toml_params
from src.util.error import error_exit
from src.util.file_folder_util import handle_read_only_error
...
def get_templates() -> dict:
    # 模板名称和仓库映射文件路径
    template_repositories_path = PROJECT_ROOT_PATH.joinpath("templates").joinpath("create").joinpath("create.yaml")
    # 解析文件成字典
    try:
