...
def generate_kirby_conf(table_raw_name=None, table_master_name=None, kirby_type=None):
    ...
    if kirby_type == "raw":
        ...
        table_dict_conf[table_raw_name]["kirby"]["input"] = dict(options=dict())
        ...
        table_dict_conf[table_raw_name]["kirby"]["output"] = dict(mode="", force="", options=dict(), path="", schema=dict(), type="", dropLeftoverFields="")
