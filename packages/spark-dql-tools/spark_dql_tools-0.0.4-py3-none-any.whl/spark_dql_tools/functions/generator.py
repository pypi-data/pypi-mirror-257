...
def dq_generated_dataframe_json(hamu_type=None,
    ...
    repo_path_per = "${repository.endpoint.vdc}/${repository.repo.schemas.dq}/data-quality-configs/${repository.env.dq}/pe"
    ...
    if hamu_type == "raw":
        ...
        table_dict["kind"] = "processing"
        table_dict["params"] = dict()
        repo_config = os.path.join(repo_path_per, uuaa_master, "raw", uuaa_tag_table_master, repo_version, f"{uuaa_tag_table_master}-01.conf")
        table_dict["params"]["configUrl"] = repo_config
        table_dict["params"]["sparkHistoryEnabled"] = "true"
        table_dict["runtime"] = "hammurabi-lts"
        table_dict["size"] = "M"
    ...
    if hamu_type == "master":
        ...
        table_dict["kind"] = "processing"
        table_dict["params"] = dict()
        repo_config = os.path.join(repo_path_per, uuaa_master, "master", uuaa_tag_table_master, repo_version, f"{uuaa_tag_table_master}-01.conf")
        table_dict["params"]["configUrl"] = repo_config
        table_dict["params"]["sparkHistoryEnabled"] = "true"
        table_dict["runtime"] = "hammurabi-lts"
        table_dict["size"] = "M"
