...
def generate_kirby_conf(table_raw_name=None, table_master_name=None, kirby_type=None):
    ...
    if kirby_type == "raw":
        ...
        dir_hocons_kirby_filename_json = f"{table_master_name}.json"
        dir_hocons_kirby_filename_conf = f"{table_master_name}.conf"
        pj_dq_dir_name = os.path.join(pj_dir_workspace, pj_dq_dir_name)
        pj_dq_dir_table_raw_json = os.path.join(pj_dir_workspace, pj_dq_dir_name, "data_kirby", "raw", f"{dir_hocons_kirby_filename_json}")
        pj_dq_dir_table_raw_conf = os.path.join(pj_dir_workspace, pj_dq_dir_name, "data_kirby", "raw", f"{dir_hocons_kirby_filename_conf}")
        ...
        table_dict_conf[table_raw_name] = dict(kirby=dict())
        table_dict_conf[table_raw_name]["kirby"]["input"] = dict()
        ...
        table_dict_conf[table_raw_name]["kirby"]["input"]["schema"] = dict()
        ...
        table_dict_conf[table_raw_name]["kirby"]["output"]["schema"] = dict()
    ...
    if kirby_type == "master":
        ...
        table_dict["kind"] = "processing"
        table_dict["params"] = dict()
        repo_config = f"{repository_initial_path}/{uuaa_master}/master/{table_raw_name}/{repository_version_path}/{table_raw_name}.conf",
        table_dict["params"]["configUrl"] = repo_config
        table_dict["params"]["sparkHistoryEnabled"] = "false"
        table_dict["runtime"] = "kirby3-lts"
        table_dict["size"] = "M"
        ...
        dir_hocons_kirby_filename_json = f"{table_master_name}.json"
        pj_dq_dir_name = os.path.join(pj_dir_workspace, pj_dq_dir_name)
        pj_dq_dir_table_master_json = os.path.join(pj_dir_workspace, pj_dq_dir_name, "data_kirby", "master", f"{dir_hocons_kirby_filename_json}")
