...
def generate_kirby_conf(table_raw_name=None, table_master_name=None, kirby_type=None):
    ...
    if kirby_type == "raw":
        ...
        trim_dict = dict()
        trim_dict["type"] = "trim"
        trim_dict["field"] = "XXXXX|XXXXX-SPANISH"
        trim_dict["regex"] = True
        trim_dict["trimType"] = "both"

        renamecol_dict = dict()
        renamecol_dict["type"] = "renamecolumns"
        renamecol_dict["columnsToRename"] = {"xxxx": "XXXX"}

        formatterdec_dict = dict()
        formatterdec_dict["type"] = "formatter"
        formatterdec_dict["field"] = "XXXXX|XXXXX-SPANISH"
        formatterdec_dict["regex"] = True
        formatterdec_dict["typeToCast"] = "decimal(23,10)"
        ...
        selectcolumns_dict["columnsToSelect"] = []
        ...
        table_dict_conf[table_master_name]["kirby"]["transformations"].append(formatterdec_dict)
