...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-meteo-flow-scheduler. Maybe you are using the wrong pypi?")


setup(
    name='yandex-meteo-flow-scheduler',
    version='66.0.3',
    author='Yandex',
