...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package nirvana_processors_sdk_build_utils. Maybe you are using the wrong pypi?")


setup(
    name='nirvana_processors_sdk_build_utils',
    version='66.0.3',
    author='Yandex',
