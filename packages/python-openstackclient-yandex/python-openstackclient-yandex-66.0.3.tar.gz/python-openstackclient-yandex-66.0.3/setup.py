...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package python-openstackclient-yandex. Maybe you are using the wrong pypi?")


setup(
    name='python-openstackclient-yandex',
    version='66.0.3',
    author='Yandex',
