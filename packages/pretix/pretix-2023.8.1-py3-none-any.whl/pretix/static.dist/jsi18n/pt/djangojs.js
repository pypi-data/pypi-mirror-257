...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Please enter a quantity for one of the ticket types.": "Por favor insira a quantidade para um tipo de bilhetes.",
    ...
    "Your color has bad contrast for text on white background, please choose a darker shade.": "A sua cor tem um mau contraste para texto no fundo branco, por favor escolha uma tonalidade mais escura.",
    "Your color has decent contrast and is probably good-enough to read!": "Sua cor tem contraste decente e \u00e9 provavelmente bom o suficiente para ler!",
    "Your color has great contrast and is very easy to read!": "A sua cor tem um grande contraste e \u00e9 muito f\u00e1cil de ler!",
    ...
    "widget\u0004See variations": "Ver alternativas",
