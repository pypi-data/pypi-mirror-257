...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Please enter a quantity for one of the ticket types.": "Masukkan jumlah untuk salah satu jenis tiket.",
    ...
    "Your color has bad contrast for text on white background, please choose a darker shade.": "Warna Anda memiliki kontras yang buruk untuk teks dengan latar belakang putih, harap pilih warna yang lebih gelap.",
    "Your color has decent contrast and is probably good-enough to read!": "Warna Anda memiliki kontras yang layak dan mungkin cukup bagus untuk dibaca!",
    "Your color has great contrast and is very easy to read!": "Warna Anda sangat kontras dan sangat mudah dibaca!",
    ...
    "widget\u0004See variations": "Lihat variasi",
