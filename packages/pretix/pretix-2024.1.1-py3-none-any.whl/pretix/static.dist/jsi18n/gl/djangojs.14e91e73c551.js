...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Please enter a quantity for one of the ticket types.": "Por favor, introduza un valor para cada tipo de entrada.",
    ...
    "Your color has bad contrast for text on white background, please choose a darker shade.": "A t\u00faa cor ten mal contraste para un texto con fondo branco. Por favor, escolle un ton m\u00e1is escuro.",
    "Your color has decent contrast and is probably good-enough to read!": "A t\u00faa cor ten un contraste axeitado e probablemente sexa suficientemente lexible!",
    "Your color has great contrast and is very easy to read!": "A t\u00faa cor ten moito contraste e \u00e9 moi doada de ler!",
    ...
    "widget\u0004See variations": "Ver variaci\u00f3ns",
