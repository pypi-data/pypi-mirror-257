...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package items-cooker-test-matching. Maybe you are using the wrong pypi?")


setup(
    name='items-cooker-test-matching',
    version='66.0.3',
    author='Yandex',
