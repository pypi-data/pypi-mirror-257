    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if is_ps4_level_backup:
            ...
            if save_key.is_lbp3_revision:
                slots_coords, slot_template = _LBP3_SLOT_COORDINATES,json.loads(_LBP3_SLOT_TEMPLATE)
            else:
