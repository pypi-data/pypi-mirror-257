...
class FOMM(CollectionModel):
    ...
    def __init__(self, detector_model: nn.Module, generator_model: nn.Module) -> None:
        super().__init__()
...
class FOMMDetector(BaseModel):
    ...
    def from_pretrained(cls):
        return FOMM.from_pretrained().detector_model
...
class FOMMGenerator(BaseModel):
    ...
    @classmethod
    def from_pretrained(cls):
        return FOMM.from_pretrained().generator_model
