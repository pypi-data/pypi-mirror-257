...
class MediaPipePyTorchAsRoot(SourceAsRoot):
    """
    ContextManager for running code with MediaPipePyTorch in python path
    and the root directory of MediaPipePyTorch set as cwd
    """

    MEDIAPIPE_SOURCE_REPOSITORY = "https://github.com/zmurez/MediaPipePyTorch"
    MEDIAPIPE_SOURCE_REPO_COMMIT = "65f2549ba35cd61dfd29f402f6c21882a32fabb1"
    MEDIAPIPE_REPO_NAME = "mediapipe_pytorch"
    MEDIAPIPE_REPO_VERSION = 1

    def __init__(self) -> None:
        super().__init__(
            MediaPipePyTorchAsRoot.MEDIAPIPE_SOURCE_REPOSITORY,
            MediaPipePyTorchAsRoot.MEDIAPIPE_SOURCE_REPO_COMMIT,
            MediaPipePyTorchAsRoot.MEDIAPIPE_REPO_NAME,
            MediaPipePyTorchAsRoot.MEDIAPIPE_REPO_VERSION,
        )
