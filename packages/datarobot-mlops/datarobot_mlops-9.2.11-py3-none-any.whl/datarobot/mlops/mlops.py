...
from datarobot.mlops.common.sampling import get_sampling_pct
from datarobot.mlops.common.sampling import sample_dataframe
from datarobot.mlops.common.sampling import validate_sampling_percentage
from datarobot.mlops.constants import Constants
from datarobot.mlops.metric import AggregationHelper
...
class MLOps:
    ...
    def report_deployment_stats(
        ...
        self._model.report_deployment_stats(
            _deployment_id, _model_id, num_predictions, execution_time_ms, batch_id
        )
