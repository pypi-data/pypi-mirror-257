...
class MLOps:
    ...
    def agent(
        ...
        self._agent = Agent(
            mlops_service_url, mlops_api_token, agent_jar_path, path_prefix, verify_ssl
        )
    ...
    def set_feature_types(self, feature_types):
        ...
        self._feature_types = convert_dict_to_feature_types(feature_types)
        return self
    ...
    def report_deployment_stats(
        self, num_predictions, execution_time_ms, deployment_id=None, model_id=None, batch_name=None
    ):
        """
        ...
        self._model.report_deployment_stats(
            _deployment_id, _model_id, num_predictions, execution_time_ms, batch_name
        )
