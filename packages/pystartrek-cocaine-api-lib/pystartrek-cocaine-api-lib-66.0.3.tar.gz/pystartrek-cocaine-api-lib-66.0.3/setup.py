...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package pystartrek-cocaine-api-lib. Maybe you are using the wrong pypi?")


setup(
    name='pystartrek-cocaine-api-lib',
    version='66.0.3',
    author='Yandex',
