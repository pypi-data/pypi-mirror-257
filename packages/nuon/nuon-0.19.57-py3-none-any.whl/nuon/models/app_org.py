...
"""
    ...
    The version of the OpenAPI document: 0.19.57
...
class AppOrg(BaseModel):
    ...
    AppOrg
    """ # noqa: E501
    awsecrimage_configs: Optional[List[AppAWSECRImageConfig]] = Field(default=None, alias="awsecrimageConfigs")
    connected_github_vcs_configs: Optional[List[AppConnectedGithubVCSConfig]] = Field(default=None, alias="connectedGithubVCSConfigs")
    ...
    public_git_vcs_configs: Optional[List[AppPublicGitVCSConfig]] = Field(default=None, description="NOTE(jm): with GORM, these cascades are not getting created properly. For now, we just add them here, but eventually we should be able to remove these and add them directly.", alias="publicGitVCSConfigs")
    ...
    __properties: ClassVar[List[str]] = ["awsecrimageConfigs", "connectedGithubVCSConfigs", "created_at", "created_by", "created_by_id", "custom_cert", "health_checks", "id", "latest_health_check", "name", "publicGitVCSConfigs", "sandbox_mode", "status", "status_description", "updated_at", "users", "vcs_connections"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in awsecrimage_configs (list)
        _items = []
        if self.awsecrimage_configs:
            for _item in self.awsecrimage_configs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['awsecrimageConfigs'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in connected_github_vcs_configs (list)
        _items = []
        if self.connected_github_vcs_configs:
            for _item in self.connected_github_vcs_configs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['connectedGithubVCSConfigs'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in public_git_vcs_configs (list)
        _items = []
        if self.public_git_vcs_configs:
            for _item in self.public_git_vcs_configs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['publicGitVCSConfigs'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "awsecrimageConfigs": [AppAWSECRImageConfig.from_dict(_item) for _item in obj.get("awsecrimageConfigs")] if obj.get("awsecrimageConfigs") is not None else None,
            "connectedGithubVCSConfigs": [AppConnectedGithubVCSConfig.from_dict(_item) for _item in obj.get("connectedGithubVCSConfigs")] if obj.get("connectedGithubVCSConfigs") is not None else None,
            ...
            "name": obj.get("name"),
            "publicGitVCSConfigs": [AppPublicGitVCSConfig.from_dict(_item) for _item in obj.get("publicGitVCSConfigs")] if obj.get("publicGitVCSConfigs") is not None else None,
