...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package jenkins-job-builder-debuilder. Maybe you are using the wrong pypi?")


setup(
    name='jenkins-job-builder-debuilder',
    version='66.0.3',
    author='Yandex',
