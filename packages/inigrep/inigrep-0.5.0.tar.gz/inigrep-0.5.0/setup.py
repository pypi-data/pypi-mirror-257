...
for a full-blown configuration system but rather a quick __VDK_PYLIB_DESCRIPTION__ dirty
"swiss axe" for quick __VDK_PYLIB_DESCRIPTION__ dirty scripts.
"""
...
# setup.py built with MKit 0.0.60 and vdk-pylib-0.0.34+t20240205001613.pytest.g83e25ed
