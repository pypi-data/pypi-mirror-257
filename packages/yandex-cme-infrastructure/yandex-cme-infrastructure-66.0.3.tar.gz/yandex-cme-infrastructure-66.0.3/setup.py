...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-cme-infrastructure. Maybe you are using the wrong pypi?")


setup(
    name='yandex-cme-infrastructure',
    version='66.0.3',
    author='Yandex',
