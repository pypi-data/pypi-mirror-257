...
"""
    ...
    def add_dynamic_dependencies(self, *deps: str):
        for item in deps:
            assert isinstance(item, str), f"item should be string, but got {item}"
        return InjectedWithDynamicDependencies(self, set(deps))
