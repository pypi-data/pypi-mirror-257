...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yatank-internal-tankapi-cmd. Maybe you are using the wrong pypi?")


setup(
    name='yatank-internal-tankapi-cmd',
    version='66.0.3',
    author='Yandex',
