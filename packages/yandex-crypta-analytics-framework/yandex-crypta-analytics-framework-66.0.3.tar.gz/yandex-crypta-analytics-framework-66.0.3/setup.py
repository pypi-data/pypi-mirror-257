...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-crypta-analytics-framework. Maybe you are using the wrong pypi?")


setup(
    name='yandex-crypta-analytics-framework',
    version='66.0.3',
    author='Yandex',
