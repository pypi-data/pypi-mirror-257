...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-nikitxskv-test-package. Maybe you are using the wrong pypi?")


setup(
    name='yandex-nikitxskv-test-package',
    version='66.0.3',
    author='Yandex',
